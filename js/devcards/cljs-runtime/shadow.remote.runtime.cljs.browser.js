...
shadow.remote.runtime.cljs.browser.abort_BANG_ = (function shadow$remote$runtime$cljs$browser$abort_BANG_(p__61453,action,ex){
...
var callback = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61454__$1,new cljs.core.Keyword(null,"callback","callback",-705136228));
var G__61456 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(state,new cljs.core.Keyword(null,"failed","failed",-1397425762),true,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"completed","completed",-486056503),false,new cljs.core.Keyword(null,"ex","ex",-1413771341),ex,new cljs.core.Keyword(null,"ex-action","ex-action",672251553),action], 0));
return (callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(G__61456) : callback.call(null,G__61456));
});
shadow.remote.runtime.cljs.browser.interpret_action = (function shadow$remote$runtime$cljs$browser$interpret_action(p__61457,p__61458){
...
var runtime = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61459__$1,new cljs.core.Keyword(null,"runtime","runtime",-1331573996));
var map__61460 = p__61458;
...
var js = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61464__$1,new cljs.core.Keyword(null,"js","js",1768080579));
try{var res = runtime.eval_js(js);
var G__61467 = cljs.core.update.cljs$core$IFn$_invoke$arity$4(state,new cljs.core.Keyword(null,"eval-results","eval-results",553789722),cljs.core.conj,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"value","value",305978217),res,new cljs.core.Keyword(null,"action","action",-811238024),action], null));
return (shadow.remote.runtime.cljs.browser.interpret_actions.cljs$core$IFn$_invoke$arity$1 ? shadow.remote.runtime.cljs.browser.interpret_actions.cljs$core$IFn$_invoke$arity$1(G__61467) : shadow.remote.runtime.cljs.browser.interpret_actions.call(null,G__61467));
}catch (e61466){var ex = e61466;
return shadow.remote.runtime.cljs.browser.abort_BANG_(state,action,ex);
}
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__61463__$1)].join('')));

}
});
shadow.remote.runtime.cljs.browser.interpret_actions = (function shadow$remote$runtime$cljs$browser$interpret_actions(p__61468){
...
var state = map__61469__$1;
var actions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61469__$1,new cljs.core.Keyword(null,"actions","actions",-812656882));
if(cljs.core.empty_QMARK_(actions)){
var fexpr__61471 = new cljs.core.Keyword(null,"callback","callback",-705136228).cljs$core$IFn$_invoke$arity$1(state);
return (fexpr__61471.cljs$core$IFn$_invoke$arity$1 ? fexpr__61471.cljs$core$IFn$_invoke$arity$1(state) : fexpr__61471.call(null,state));
} else {
var map__61472 = cljs.core.first(actions);
...
var self__ = this;
var this$ = this;
var G__61479 = [shadow.cljs.devtools.client.env.get_url_base(),"/worker/compile/",shadow.cljs.devtools.client.env.build_id,"/",shadow.cljs.devtools.client.env.proc_id,"/browser"].join('');
var G__61480 = (function (res){
var req = this;
var map__61484 = shadow.remote.runtime.cljs.browser.transit_read(req.getResponseText());
...
var result = map__61484__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61484__$1,new cljs.core.Keyword(null,"type","type",1174270348));
if((!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("repl","actions","repl/actions",-809718877),type)))){
var G__61486 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"failed","failed",-1397425762),true,new cljs.core.Keyword(null,"result","result",1415092211),result], null);
return (callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(G__61486) : callback.call(null,G__61486));
} else {
...
var G__61481 = "POST";
var G__61482 = shadow.remote.runtime.cljs.browser.transit_str(msg);
var G__61483 = ({"content-type": "application/transit+json; charset=utf-8"});
return goog.net.XhrIo.send(G__61479,G__61480,G__61481,G__61482,G__61483);
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k61475,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k61475,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__61488){
var vec__61489 = p__61488;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61489,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61489,(1),null);
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__61474){
var self__ = this;
var G__61474__$1 = this;
return (new cljs.core.RecordIter((0),G__61474__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ws","ws",86841443),new cljs.core.Keyword(null,"state-ref","state-ref",2127874952)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var h__4297__auto____$1 = (function (){var fexpr__61492 = (function (coll__4436__auto__){
return (725844968 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__61492(this__4435__auto____$1);
})();
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this61476,other61477){
var self__ = this;
var this61476__$1 = this;
return (((!((other61477 == null)))) && ((this61476__$1.constructor === other61477.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this61476__$1.ws,other61477.ws)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this61476__$1.state_ref,other61477.state_ref)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this61476__$1.__extmap,other61477.__extmap)));
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__61474){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__61493 = cljs.core.keyword_identical_QMARK_;
var expr__61494 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__61496 = new cljs.core.Keyword(null,"ws","ws",86841443);
var G__61497 = expr__61494;
return (pred__61493.cljs$core$IFn$_invoke$arity$2 ? pred__61493.cljs$core$IFn$_invoke$arity$2(G__61496,G__61497) : pred__61493.call(null,G__61496,G__61497));
})())){
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(G__61474,self__.state_ref,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__61498 = new cljs.core.Keyword(null,"state-ref","state-ref",2127874952);
var G__61499 = expr__61494;
return (pred__61493.cljs$core$IFn$_invoke$arity$2 ? pred__61493.cljs$core$IFn$_invoke$arity$2(G__61498,G__61499) : pred__61493.call(null,G__61498,G__61499));
})())){
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,G__61474,self__.__meta,self__.__extmap,null));
} else {
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,self__.state_ref,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__61474),null));
}
}
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__61474){
var self__ = this;
var this__4438__auto____$1 = this;
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,self__.state_ref,G__61474,self__.__extmap,self__.__hash));
}));
 ...
 */
shadow.remote.runtime.cljs.browser.map__GT_BrowserRuntime = (function shadow$remote$runtime$cljs$browser$map__GT_BrowserRuntime(G__61478){
var extmap__4478__auto__ = (function (){var G__61500 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__61478,new cljs.core.Keyword(null,"ws","ws",86841443),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"state-ref","state-ref",2127874952)], 0));
...
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(new cljs.core.Keyword(null,"ws","ws",86841443).cljs$core$IFn$_invoke$arity$1(G__61478),new cljs.core.Keyword(null,"state-ref","state-ref",2127874952).cljs$core$IFn$_invoke$arity$1(G__61478),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var runtime = (function (){var G__61501 = (new shadow.remote.runtime.cljs.browser.BrowserRuntime(socket,state_ref,null,null,null));
shadow.remote.runtime.shared.add_defaults(G__61501);
...
var map__61502 = temp__5737__auto__;
...
var stop = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61502__$1,new cljs.core.Keyword(null,"stop","stop",-2140911342));
