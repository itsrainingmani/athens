...
shadow.remote.runtime.cljs.browser.abort_BANG_ = (function shadow$remote$runtime$cljs$browser$abort_BANG_(p__61471,action,ex){
...
var callback = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61472__$1,new cljs.core.Keyword(null,"callback","callback",-705136228));
var G__61474 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(state,new cljs.core.Keyword(null,"failed","failed",-1397425762),true,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"completed","completed",-486056503),false,new cljs.core.Keyword(null,"ex","ex",-1413771341),ex,new cljs.core.Keyword(null,"ex-action","ex-action",672251553),action], 0));
...
shadow.remote.runtime.cljs.browser.interpret_action = (function shadow$remote$runtime$cljs$browser$interpret_action(p__61475,p__61476){
...
var state = map__61477__$1;
var runtime = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61477__$1,new cljs.core.Keyword(null,"runtime","runtime",-1331573996));
...
var action = map__61478__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61478__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var G__61481 = type;
var G__61481__$1 = (((G__61481 instanceof cljs.core.Keyword))?G__61481.fqn:null);
switch (G__61481__$1) {
case "repl/invoke":
var map__61482 = action;
...
var js = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61482__$1,new cljs.core.Keyword(null,"js","js",1768080579));
try{var res = runtime.eval_js(js);
var G__61485 = cljs.core.update.cljs$core$IFn$_invoke$arity$4(state,new cljs.core.Keyword(null,"eval-results","eval-results",553789722),cljs.core.conj,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"value","value",305978217),res,new cljs.core.Keyword(null,"action","action",-811238024),action], null));
return (shadow.remote.runtime.cljs.browser.interpret_actions.cljs$core$IFn$_invoke$arity$1 ? shadow.remote.runtime.cljs.browser.interpret_actions.cljs$core$IFn$_invoke$arity$1(G__61485) : shadow.remote.runtime.cljs.browser.interpret_actions.call(null,G__61485));
}catch (e61484){var ex = e61484;
return shadow.remote.runtime.cljs.browser.abort_BANG_(state,action,ex);
}
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__61481__$1)].join('')));

}
});
shadow.remote.runtime.cljs.browser.interpret_actions = (function shadow$remote$runtime$cljs$browser$interpret_actions(p__61486){
...
var state = map__61487__$1;
var actions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61487__$1,new cljs.core.Keyword(null,"actions","actions",-812656882));
if(cljs.core.empty_QMARK_(actions)){
var fexpr__61489 = new cljs.core.Keyword(null,"callback","callback",-705136228).cljs$core$IFn$_invoke$arity$1(state);
return (fexpr__61489.cljs$core$IFn$_invoke$arity$1 ? fexpr__61489.cljs$core$IFn$_invoke$arity$1(state) : fexpr__61489.call(null,state));
} else {
var map__61490 = cljs.core.first(actions);
...
var action = map__61490__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61490__$1,new cljs.core.Keyword(null,"type","type",1174270348));
...
var self__ = this;
var this$ = this;
var G__61497 = [shadow.cljs.devtools.client.env.get_url_base(),"/worker/compile/",shadow.cljs.devtools.client.env.build_id,"/",shadow.cljs.devtools.client.env.proc_id,"/browser"].join('');
var G__61498 = (function (res){
var req = this;
var map__61502 = shadow.remote.runtime.cljs.browser.transit_read(req.getResponseText());
...
var result = map__61502__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61502__$1,new cljs.core.Keyword(null,"type","type",1174270348));
if((!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("repl","actions","repl/actions",-809718877),type)))){
var G__61504 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"failed","failed",-1397425762),true,new cljs.core.Keyword(null,"result","result",1415092211),result], null);
return (callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(G__61504) : callback.call(null,G__61504));
} else {
...
var G__61499 = "POST";
var G__61500 = shadow.remote.runtime.cljs.browser.transit_str(msg);
var G__61501 = ({"content-type": "application/transit+json; charset=utf-8"});
return goog.net.XhrIo.send(G__61497,G__61498,G__61499,G__61500,G__61501);
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k61493,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k61493,else__4442__auto__);
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__61492){
var self__ = this;
var G__61492__$1 = this;
return (new cljs.core.RecordIter((0),G__61492__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ws","ws",86841443),new cljs.core.Keyword(null,"state-ref","state-ref",2127874952)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var h__4297__auto____$1 = (function (){var fexpr__61510 = (function (coll__4436__auto__){
return (725844968 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__61510(this__4435__auto____$1);
})();
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this61494,other61495){
var self__ = this;
var this61494__$1 = this;
return (((!((other61495 == null)))) && ((this61494__$1.constructor === other61495.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this61494__$1.ws,other61495.ws)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this61494__$1.state_ref,other61495.state_ref)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this61494__$1.__extmap,other61495.__extmap)));
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__61492){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__61511 = cljs.core.keyword_identical_QMARK_;
var expr__61512 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__61514 = new cljs.core.Keyword(null,"ws","ws",86841443);
var G__61515 = expr__61512;
return (pred__61511.cljs$core$IFn$_invoke$arity$2 ? pred__61511.cljs$core$IFn$_invoke$arity$2(G__61514,G__61515) : pred__61511.call(null,G__61514,G__61515));
})())){
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(G__61492,self__.state_ref,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__61516 = new cljs.core.Keyword(null,"state-ref","state-ref",2127874952);
var G__61517 = expr__61512;
return (pred__61511.cljs$core$IFn$_invoke$arity$2 ? pred__61511.cljs$core$IFn$_invoke$arity$2(G__61516,G__61517) : pred__61511.call(null,G__61516,G__61517));
})())){
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,G__61492,self__.__meta,self__.__extmap,null));
} else {
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,self__.state_ref,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__61492),null));
}
}
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__61492){
var self__ = this;
var this__4438__auto____$1 = this;
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,self__.state_ref,G__61492,self__.__extmap,self__.__hash));
}));
 ...
 */
shadow.remote.runtime.cljs.browser.map__GT_BrowserRuntime = (function shadow$remote$runtime$cljs$browser$map__GT_BrowserRuntime(G__61496){
var extmap__4478__auto__ = (function (){var G__61518 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__61496,new cljs.core.Keyword(null,"ws","ws",86841443),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"state-ref","state-ref",2127874952)], 0));
if(cljs.core.record_QMARK_(G__61496)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__61518);
} else {
return G__61518;
}
})();
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(new cljs.core.Keyword(null,"ws","ws",86841443).cljs$core$IFn$_invoke$arity$1(G__61496),new cljs.core.Keyword(null,"state-ref","state-ref",2127874952).cljs$core$IFn$_invoke$arity$1(G__61496),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var runtime = (function (){var G__61519 = (new shadow.remote.runtime.cljs.browser.BrowserRuntime(socket,state_ref,null,null,null));
shadow.remote.runtime.shared.add_defaults(G__61519);
...
var map__61520 = temp__5737__auto__;
...
var stop = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61520__$1,new cljs.core.Keyword(null,"stop","stop",-2140911342));
