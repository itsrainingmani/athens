...
shadow.remote.runtime.cljs.browser.abort_BANG_ = (function shadow$remote$runtime$cljs$browser$abort_BANG_(p__61427,action,ex){
...
var state = map__61428__$1;
var callback = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61428__$1,new cljs.core.Keyword(null,"callback","callback",-705136228));
var G__61430 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(state,new cljs.core.Keyword(null,"failed","failed",-1397425762),true,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"completed","completed",-486056503),false,new cljs.core.Keyword(null,"ex","ex",-1413771341),ex,new cljs.core.Keyword(null,"ex-action","ex-action",672251553),action], 0));
return (callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(G__61430) : callback.call(null,G__61430));
});
shadow.remote.runtime.cljs.browser.interpret_action = (function shadow$remote$runtime$cljs$browser$interpret_action(p__61431,p__61432){
...
var state = map__61433__$1;
var runtime = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61433__$1,new cljs.core.Keyword(null,"runtime","runtime",-1331573996));
...
var action = map__61434__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61434__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var G__61437 = type;
var G__61437__$1 = (((G__61437 instanceof cljs.core.Keyword))?G__61437.fqn:null);
switch (G__61437__$1) {
case "repl/invoke":
var map__61438 = action;
...
var js = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61438__$1,new cljs.core.Keyword(null,"js","js",1768080579));
try{var res = runtime.eval_js(js);
var G__61441 = cljs.core.update.cljs$core$IFn$_invoke$arity$4(state,new cljs.core.Keyword(null,"eval-results","eval-results",553789722),cljs.core.conj,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"value","value",305978217),res,new cljs.core.Keyword(null,"action","action",-811238024),action], null));
return (shadow.remote.runtime.cljs.browser.interpret_actions.cljs$core$IFn$_invoke$arity$1 ? shadow.remote.runtime.cljs.browser.interpret_actions.cljs$core$IFn$_invoke$arity$1(G__61441) : shadow.remote.runtime.cljs.browser.interpret_actions.call(null,G__61441));
}catch (e61440){var ex = e61440;
return shadow.remote.runtime.cljs.browser.abort_BANG_(state,action,ex);
}
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__61437__$1)].join('')));

}
});
shadow.remote.runtime.cljs.browser.interpret_actions = (function shadow$remote$runtime$cljs$browser$interpret_actions(p__61442){
...
var actions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61443__$1,new cljs.core.Keyword(null,"actions","actions",-812656882));
if(cljs.core.empty_QMARK_(actions)){
var fexpr__61445 = new cljs.core.Keyword(null,"callback","callback",-705136228).cljs$core$IFn$_invoke$arity$1(state);
return (fexpr__61445.cljs$core$IFn$_invoke$arity$1 ? fexpr__61445.cljs$core$IFn$_invoke$arity$1(state) : fexpr__61445.call(null,state));
} else {
var map__61446 = cljs.core.first(actions);
...
var self__ = this;
var this$ = this;
var G__61453 = [shadow.cljs.devtools.client.env.get_url_base(),"/worker/compile/",shadow.cljs.devtools.client.env.build_id,"/",shadow.cljs.devtools.client.env.proc_id,"/browser"].join('');
var G__61454 = (function (res){
var req = this;
var map__61458 = shadow.remote.runtime.cljs.browser.transit_read(req.getResponseText());
...
var G__61460 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"failed","failed",-1397425762),true,new cljs.core.Keyword(null,"result","result",1415092211),result], null);
return (callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(G__61460) : callback.call(null,G__61460));
} else {
...
var G__61455 = "POST";
var G__61456 = shadow.remote.runtime.cljs.browser.transit_str(msg);
var G__61457 = ({"content-type": "application/transit+json; charset=utf-8"});
return goog.net.XhrIo.send(G__61453,G__61454,G__61455,G__61456,G__61457);
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k61449,else__4442__auto__){
var self__ = this;
var this__4441__auto____$1 = this;
var G__61461 = k61449;
var G__61461__$1 = (((G__61461 instanceof cljs.core.Keyword))?G__61461.fqn:null);
switch (G__61461__$1) {
case "ws":
return self__.ws;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k61449,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__61462){
var vec__61463 = p__61462;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61463,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61463,(1),null);
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__61448){
var self__ = this;
var G__61448__$1 = this;
return (new cljs.core.RecordIter((0),G__61448__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ws","ws",86841443),new cljs.core.Keyword(null,"state-ref","state-ref",2127874952)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var h__4297__auto____$1 = (function (){var fexpr__61466 = (function (coll__4436__auto__){
return (725844968 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__61466(this__4435__auto____$1);
})();
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this61450,other61451){
var self__ = this;
var this61450__$1 = this;
return (((!((other61451 == null)))) && ((this61450__$1.constructor === other61451.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this61450__$1.ws,other61451.ws)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this61450__$1.state_ref,other61451.state_ref)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this61450__$1.__extmap,other61451.__extmap)));
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__61448){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__61467 = cljs.core.keyword_identical_QMARK_;
var expr__61468 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__61470 = new cljs.core.Keyword(null,"ws","ws",86841443);
var G__61471 = expr__61468;
return (pred__61467.cljs$core$IFn$_invoke$arity$2 ? pred__61467.cljs$core$IFn$_invoke$arity$2(G__61470,G__61471) : pred__61467.call(null,G__61470,G__61471));
})())){
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(G__61448,self__.state_ref,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__61472 = new cljs.core.Keyword(null,"state-ref","state-ref",2127874952);
var G__61473 = expr__61468;
return (pred__61467.cljs$core$IFn$_invoke$arity$2 ? pred__61467.cljs$core$IFn$_invoke$arity$2(G__61472,G__61473) : pred__61467.call(null,G__61472,G__61473));
})())){
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,G__61448,self__.__meta,self__.__extmap,null));
} else {
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,self__.state_ref,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__61448),null));
}
}
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__61448){
var self__ = this;
var this__4438__auto____$1 = this;
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,self__.state_ref,G__61448,self__.__extmap,self__.__hash));
}));
 ...
 */
shadow.remote.runtime.cljs.browser.map__GT_BrowserRuntime = (function shadow$remote$runtime$cljs$browser$map__GT_BrowserRuntime(G__61452){
var extmap__4478__auto__ = (function (){var G__61474 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__61452,new cljs.core.Keyword(null,"ws","ws",86841443),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"state-ref","state-ref",2127874952)], 0));
if(cljs.core.record_QMARK_(G__61452)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__61474);
} else {
return G__61474;
}
})();
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(new cljs.core.Keyword(null,"ws","ws",86841443).cljs$core$IFn$_invoke$arity$1(G__61452),new cljs.core.Keyword(null,"state-ref","state-ref",2127874952).cljs$core$IFn$_invoke$arity$1(G__61452),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var runtime = (function (){var G__61475 = (new shadow.remote.runtime.cljs.browser.BrowserRuntime(socket,state_ref,null,null,null));
shadow.remote.runtime.shared.add_defaults(G__61475);
...
var map__61476 = temp__5737__auto__;
...
var stop = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61476__$1,new cljs.core.Keyword(null,"stop","stop",-2140911342));
