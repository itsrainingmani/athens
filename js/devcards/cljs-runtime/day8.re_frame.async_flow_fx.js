 ...
 */
day8.re_frame.async_flow_fx.dissoc_in = (function day8$re_frame$async_flow_fx$dissoc_in(m,p__83046){
var vec__83047 = p__83046;
var seq__83048 = cljs.core.seq(vec__83047);
var first__83049 = cljs.core.first(seq__83048);
var seq__83048__$1 = cljs.core.next(seq__83048);
var k = first__83049;
var ks = seq__83048__$1;
var keys = vec__83047;
if(ks){
...
var G__83051 = new cljs.core.Keyword(null,"events","events",1792552201).cljs$core$IFn$_invoke$arity$1(task);
var G__83052 = now_seen_events;
var fexpr__83050 = new cljs.core.Keyword(null,"when","when",-576417306).cljs$core$IFn$_invoke$arity$1(task);
return (fexpr__83050.cljs$core$IFn$_invoke$arity$2 ? fexpr__83050.cljs$core$IFn$_invoke$arity$2(G__83051,G__83052) : fexpr__83050.call(null,G__83051,G__83052));
...
var G__83053 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__83054 = "async-flow: got bad value for :when - ";
var G__83055 = when_kw;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__83053,G__83054,G__83055) : re_frame.core.console.call(null,G__83053,G__83054,G__83055));
}
});
/**
...
return cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (index,p__83056){
var map__83057 = p__83056;
var map__83057__$1 = (((((!((map__83057 == null))))?(((((map__83057.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__83057.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__83057):map__83057);
var rule = map__83057__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83057__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var when = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83057__$1,new cljs.core.Keyword(null,"when","when",-576417306));
var events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83057__$1,new cljs.core.Keyword(null,"events","events",1792552201));
var dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83057__$1,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83057__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83057__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var halt_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83057__$1,new cljs.core.Keyword(null,"halt?","halt?",-1110658247));
...
var G__83059 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__83060 = "async-flow: rule can only specify one of :dispatch, :dispatch-n and :dispatch-fn. Got more than one: ";
var G__83061 = rule;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__83059,G__83060,G__83061) : re_frame.core.console.call(null,G__83059,G__83060,G__83061));
} else {
var G__83062 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),(function (){var or__4185__auto__ = id;
...
var G__83062__$1 = (cljs.core.truth_(dispatch_fn)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__83062,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614),dispatch_fn):G__83062);
if(cljs.core.not(dispatch_fn)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__83062__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236),(cljs.core.truth_(dispatch_n)?dispatch_n:(cljs.core.truth_(dispatch)?(new cljs.core.List(null,dispatch,null,(1),null)):cljs.core.List.EMPTY
)));
} else {
return G__83062__$1;
}
...
var map__83063 = rule;
var map__83063__$1 = (((((!((map__83063 == null))))?(((((map__83063.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__83063.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__83063):map__83063);
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83063__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83063__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
...
var G__83065 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__83066 = "async-flow: dispatch-fn must return a seq of events ";
var G__83067 = rule;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__83065,G__83066,G__83067) : re_frame.core.console.call(null,G__83065,G__83066,G__83067));
}
} else {
 ...
 */
day8.re_frame.async_flow_fx.make_flow_event_handler = (function day8$re_frame$async_flow_fx$make_flow_event_handler(p__83068){
var map__83069 = p__83068;
var map__83069__$1 = (((((!((map__83069 == null))))?(((((map__83069.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__83069.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__83069):map__83069);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83069__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var db_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83069__$1,new cljs.core.Keyword(null,"db-path","db-path",-68094099));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83069__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var first_dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83069__$1,new cljs.core.Keyword(null,"first-dispatch","first-dispatch",128561923));
...
return (function day8$re_frame$async_flow_fx$make_flow_event_handler_$_async_flow_event_handler(p__83071,p__83072){
var map__83073 = p__83071;
var map__83073__$1 = (((((!((map__83073 == null))))?(((((map__83073.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__83073.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__83073):map__83073);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83073__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__83074 = p__83072;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__83074,(0),null);
var event_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__83074,(1),null);
var event_v = vec__83074;
var pred__83078 = cljs.core._EQ_;
var expr__83079 = event_type;
if(cljs.core.truth_((function (){var G__83081 = new cljs.core.Keyword(null,"setup","setup",1987730512);
var G__83082 = expr__83079;
return (pred__83078.cljs$core$IFn$_invoke$arity$2 ? pred__83078.cljs$core$IFn$_invoke$arity$2(G__83081,G__83082) : pred__83078.call(null,G__83081,G__83082));
})())){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"db","db",993250759),(function (){var G__83083 = db;
var G__83084 = cljs.core.PersistentHashSet.EMPTY;
var G__83085 = cljs.core.PersistentHashSet.EMPTY;
return (set_state.cljs$core$IFn$_invoke$arity$3 ? set_state.cljs$core$IFn$_invoke$arity$3(G__83083,G__83084,G__83085) : set_state.call(null,G__83083,G__83084,G__83085));
...
var vec__83086 = event_v;
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__83086,(0),null);
var forwarded_event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__83086,(1),null);
var map__83089 = (get_state.cljs$core$IFn$_invoke$arity$1 ? get_state.cljs$core$IFn$_invoke$arity$1(db) : get_state.call(null,db));
var map__83089__$1 = (((((!((map__83089 == null))))?(((((map__83089.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__83089.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__83089):map__83089);
var seen_events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83089__$1,new cljs.core.Keyword(null,"seen-events","seen-events",1607648392));
var rules_fired = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83089__$1,new cljs.core.Keyword(null,"rules-fired","rules-fired",-1669838140));
...
var vec__83091 = day8.re_frame.async_flow_fx.ensure_has_id(flow);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__83091,(0),null);
var flow_SINGLEQUOTE_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__83091,(1),null);
...
var G__83094 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [id,new cljs.core.Keyword(null,"setup","setup",1987730512)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__83094) : re_frame.core.dispatch.call(null,G__83094));
});
var G__83095_83097 = new cljs.core.Keyword(null,"async-flow","async-flow",1464712702);
var G__83096_83098 = day8.re_frame.async_flow_fx.flow__GT_handler;
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__83095_83097,G__83096_83098) : re_frame.core.reg_fx.call(null,G__83095_83097,G__83096_83098));
