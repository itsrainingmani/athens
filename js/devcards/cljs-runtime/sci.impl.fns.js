...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__59324,fn_name,macro_QMARK_,with_meta_QMARK_){
...
var _m = map__59325__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59325__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59325__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59325__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59325__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__59342 = cljs.core.next(args__$1);
var G__59343 = cljs.core.next(params__$1);
var G__59344 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__59342;
params__$1 = G__59343;
ret = G__59344;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__59327 = ctx__$1;
var G__59328 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__59327,G__59328) : interpret.call(null,G__59327,G__59328));
...
var vec__59329 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59329,(0),null);
var vec__59332 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59329,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59332,(0),null);
var G__59345 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__59345;
continue;
} else {
var G__59346 = recur_val;
args = G__59346;
continue;
}
} else {
...
var G__59347__i = 0, G__59347__a = new Array(arguments.length -  0);
while (G__59347__i < G__59347__a.length) {G__59347__a[G__59347__i] = arguments[G__59347__i + 0]; ++G__59347__i;}
  args = new cljs.core.IndexedSeq(G__59347__a,0,null);
} 
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__59348){
var args = cljs.core.seq(arglist__59348);
...
var map__59335 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59335__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59335__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__59339){
...
var f = map__59340__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59340__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59340__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var G__59349__delegate = function (args){
...
while (G__59350__i < G__59350__a.length) {G__59350__a[G__59350__i] = arguments[G__59350__i + 0]; ++G__59350__i;}
  args = new cljs.core.IndexedSeq(G__59350__a,0,null);
} 
return G__59349__delegate.call(this,args);};
G__59349.cljs$lang$maxFixedArity = 0;
G__59349.cljs$lang$applyTo = (function (arglist__59351){
var args = cljs.core.seq(arglist__59351);
return G__59349__delegate(args);
});
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__59337_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__59337_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__59352__delegate = function (args){
...
var G__59352 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__59353__i = 0, G__59353__a = new Array(arguments.length -  0);
while (G__59353__i < G__59353__a.length) {G__59353__a[G__59353__i] = arguments[G__59353__i + 0]; ++G__59353__i;}
  args = new cljs.core.IndexedSeq(G__59353__a,0,null);
} 
return G__59352__delegate.call(this,args);};
G__59352.cljs$lang$maxFixedArity = 0;
G__59352.cljs$lang$applyTo = (function (arglist__59354){
var args = cljs.core.seq(arglist__59354);
return G__59352__delegate(args);
});
...
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__59338_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__59338_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
