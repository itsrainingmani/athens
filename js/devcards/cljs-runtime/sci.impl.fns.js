...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__58693,fn_name,macro_QMARK_,with_meta_QMARK_){
var map__58695 = p__58693;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__58699 = ctx__$1;
var G__58700 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__58699,G__58700) : interpret.call(null,G__58699,G__58700));
...
var vec__58702 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58702,(0),null);
var vec__58705 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58702,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58705,(0),null);
var G__58737 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__58737;
continue;
} else {
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__58716){
...
var f = map__58717__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58717__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58717__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
G__58743.cljs$lang$applyTo = (function (arglist__58747){
...
while (G__58755__i < G__58755__a.length) {G__58755__a[G__58755__i] = arguments[G__58755__i + 0]; ++G__58755__i;}
  args = new cljs.core.IndexedSeq(G__58755__a,0,null);
} 
return G__58753__delegate.call(this,args);};
G__58753.cljs$lang$maxFixedArity = 0;
G__58753.cljs$lang$applyTo = (function (arglist__58756){
...
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__58713_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58713_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
