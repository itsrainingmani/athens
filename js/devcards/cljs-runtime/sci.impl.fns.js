...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__59057,fn_name,macro_QMARK_,with_meta_QMARK_){
...
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59058__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59058__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59058__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__59105 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__59105;
continue;
} else {
var G__59106 = recur_val;
args = G__59106;
continue;
}
} else {
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__59109){
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__59078_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__59078_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__59127__delegate = function (args){
...
var G__59127 = function (var_args){
var args = null;
if (arguments.length > 0) {
...
while (G__59132__i < G__59132__a.length) {G__59132__a[G__59132__i] = arguments[G__59132__i + 0]; ++G__59132__i;}
  args = new cljs.core.IndexedSeq(G__59132__a,0,null);
} 
return G__59127__delegate.call(this,args);};
G__59127.cljs$lang$maxFixedArity = 0;
G__59127.cljs$lang$applyTo = (function (arglist__59135){
var args = cljs.core.seq(arglist__59135);
return G__59127__delegate(args);
});
G__59127.cljs$core$IFn$_invoke$arity$variadic = G__59127__delegate;
return G__59127;
})()
;
})());
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__59079_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__59079_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
