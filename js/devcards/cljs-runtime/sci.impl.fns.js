...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__59264,fn_name,macro_QMARK_,with_meta_QMARK_){
...
var _m = map__59265__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59265__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59265__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59265__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59265__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__59282 = cljs.core.next(args__$1);
var G__59283 = cljs.core.next(params__$1);
var G__59284 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__59282;
params__$1 = G__59283;
ret = G__59284;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__59267 = ctx__$1;
var G__59268 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__59267,G__59268) : interpret.call(null,G__59267,G__59268));
...
var vec__59269 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59269,(0),null);
var vec__59272 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59269,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59272,(0),null);
var G__59286 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__59286;
continue;
} else {
var G__59287 = recur_val;
args = G__59287;
continue;
}
} else {
...
var G__59288__i = 0, G__59288__a = new Array(arguments.length -  0);
while (G__59288__i < G__59288__a.length) {G__59288__a[G__59288__i] = arguments[G__59288__i + 0]; ++G__59288__i;}
  args = new cljs.core.IndexedSeq(G__59288__a,0,null);
} 
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__59289){
var args = cljs.core.seq(arglist__59289);
...
var map__59275 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59275__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59275__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__59279){
...
var f = map__59280__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59280__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59280__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var G__59296__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(self_ref),args);
};
var G__59296 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__59297__i = 0, G__59297__a = new Array(arguments.length -  0);
while (G__59297__i < G__59297__a.length) {G__59297__a[G__59297__i] = arguments[G__59297__i + 0]; ++G__59297__i;}
  args = new cljs.core.IndexedSeq(G__59297__a,0,null);
} 
return G__59296__delegate.call(this,args);};
G__59296.cljs$lang$maxFixedArity = 0;
G__59296.cljs$lang$applyTo = (function (arglist__59298){
var args = cljs.core.seq(arglist__59298);
return G__59296__delegate(args);
});
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__59277_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__59277_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__59299__delegate = function (args){
...
var G__59299 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__59300__i = 0, G__59300__a = new Array(arguments.length -  0);
while (G__59300__i < G__59300__a.length) {G__59300__a[G__59300__i] = arguments[G__59300__i + 0]; ++G__59300__i;}
  args = new cljs.core.IndexedSeq(G__59300__a,0,null);
} 
return G__59299__delegate.call(this,args);};
G__59299.cljs$lang$maxFixedArity = 0;
G__59299.cljs$lang$applyTo = (function (arglist__59301){
var args = cljs.core.seq(arglist__59301);
return G__59299__delegate(args);
});
G__59299.cljs$core$IFn$_invoke$arity$variadic = G__59299__delegate;
return G__59299;
})()
;
})());
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__59278_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__59278_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
