...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__57871,fn_name,macro_QMARK_,with_meta_QMARK_){
...
var _m = map__57872__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57872__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57872__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57872__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57872__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__57895 = cljs.core.next(args__$1);
var G__57896 = cljs.core.next(params__$1);
var G__57897 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__57895;
params__$1 = G__57896;
ret = G__57897;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__57880 = ctx__$1;
var G__57881 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__57880,G__57881) : interpret.call(null,G__57880,G__57881));
...
var vec__57882 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57882,(0),null);
var vec__57885 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57882,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57885,(0),null);
var G__57898 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__57898;
continue;
} else {
var G__57899 = recur_val;
args = G__57899;
continue;
}
} else {
...
var G__57900__i = 0, G__57900__a = new Array(arguments.length -  0);
while (G__57900__i < G__57900__a.length) {G__57900__a[G__57900__i] = arguments[G__57900__i + 0]; ++G__57900__i;}
  args = new cljs.core.IndexedSeq(G__57900__a,0,null);
} 
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__57901){
var args = cljs.core.seq(arglist__57901);
...
var map__57888 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57888__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57888__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__57892){
...
var f = map__57893__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57893__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57893__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var G__57904__delegate = function (args){
...
while (G__57905__i < G__57905__a.length) {G__57905__a[G__57905__i] = arguments[G__57905__i + 0]; ++G__57905__i;}
  args = new cljs.core.IndexedSeq(G__57905__a,0,null);
} 
return G__57904__delegate.call(this,args);};
G__57904.cljs$lang$maxFixedArity = 0;
G__57904.cljs$lang$applyTo = (function (arglist__57906){
var args = cljs.core.seq(arglist__57906);
return G__57904__delegate(args);
});
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57890_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__57890_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__57907__delegate = function (args){
...
while (G__57910__i < G__57910__a.length) {G__57910__a[G__57910__i] = arguments[G__57910__i + 0]; ++G__57910__i;}
  args = new cljs.core.IndexedSeq(G__57910__a,0,null);
} 
return G__57907__delegate.call(this,args);};
G__57907.cljs$lang$maxFixedArity = 0;
G__57907.cljs$lang$applyTo = (function (arglist__57911){
var args = cljs.core.seq(arglist__57911);
return G__57907__delegate(args);
});
...
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__57891_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__57891_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
