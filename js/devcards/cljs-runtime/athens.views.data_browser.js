...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__58757__$1)].join('')));

}
});
athens.views.data_browser.coll_rows = (function athens$views$data_browser$coll_rows(coll){
var row = (function (p__58758){
var vec__58759 = p__58758;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58759,(0),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58759,(1),null);
...
var G__58762 = new cljs.core.PersistentVector(null, 8, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"find","find",496279456),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?parent","?parent",-1403127243,null),new cljs.core.Symbol(null,"...","...",-1926939749,null)], null),new cljs.core.Keyword(null,"in","in",-1531184865),new cljs.core.Symbol(null,"$","$",-1580747756,null),new cljs.core.Symbol(null,"?attr","?attr",-2066507837,null),new cljs.core.Symbol(null,"?eid","?eid",1087837141,null),new cljs.core.Keyword(null,"where","where",-2044795965),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?parent","?parent",-1403127243,null),new cljs.core.Keyword("block","children","block/children",-1040716209),new cljs.core.Symbol(null,"?eid","?eid",1087837141,null)], null)], null);
var G__58763 = cljs.core.deref(athens.db.dsdb);
var G__58764 = attr;
var G__58765 = eid;
return (datascript.core.q.cljs$core$IFn$_invoke$arity$4 ? datascript.core.q.cljs$core$IFn$_invoke$arity$4(G__58762,G__58763,G__58764,G__58765) : datascript.core.q.call(null,G__58762,G__58763,G__58764,G__58765));
});
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function athens$views$data_browser$reverse_refs_$_iter__58766(s__58767){
return (new cljs.core.LazySeq(null,(function (){
var s__58767__$1 = s__58767;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__58767__$1);
if(temp__5735__auto__){
var s__58767__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__58767__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__58767__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__58769 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__58768 = (0);
while(true){
if((i__58768 < size__4581__auto__)){
var attr = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__58768);
cljs.core.chunk_append(b__58769,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.views.data_browser.reverse_attr(attr),cljs.core.map.cljs$core$IFn$_invoke$arity$2(athens.views.data_browser.wrap_with_db_id,athens.views.data_browser.reverse_refs_for_attr(attr,eid))], null));

var G__58831 = (i__58768 + (1));
i__58768 = G__58831;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58769),athens$views$data_browser$reverse_refs_$_iter__58766(cljs.core.chunk_rest(s__58767__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__58769),null);
}
} else {
var attr = cljs.core.first(s__58767__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.views.data_browser.reverse_attr(attr),cljs.core.map.cljs$core$IFn$_invoke$arity$2(athens.views.data_browser.wrap_with_db_id,athens.views.data_browser.reverse_refs_for_attr(attr,eid))], null),athens$views$data_browser$reverse_refs_$_iter__58766(cljs.core.rest(s__58767__$2)));
}
} else {
return null;
}
...
athens.views.data_browser.reverse_rows = (function athens$views$data_browser$reverse_rows(p__58770){
...
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58771__$1,new cljs.core.Keyword("db","id","db/id",-1388397098));
...
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58778,(0),null);
var values = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58778,(1),null);
...
var iter__4582__auto__ = (function athens$views$data_browser$maps_rows_$_iter__58781(s__58782){
return (new cljs.core.LazySeq(null,(function (){
...
var idx = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__58783);
cljs.core.chunk_append(b__58784,cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"value","value",305978217),idx,new cljs.core.Keyword(null,"heading","heading",-1312171873),"idx",new cljs.core.Keyword(null,"idx","idx",1053688473),idx], null)], null),(function (){var iter__4582__auto__ = ((function (i__58783,idx,c__4580__auto__,size__4581__auto__,b__58784,s__58782__$2,temp__5735__auto__,hs){
return (function athens$views$data_browser$maps_rows_$_iter__58781_$_iter__58785(s__58786){
return (new cljs.core.LazySeq(null,((function (i__58783,idx,c__4580__auto__,size__4581__auto__,b__58784,s__58782__$2,temp__5735__auto__,hs){
return (function (){
var s__58786__$1 = s__58786;
while(true){
var temp__5735__auto____$1 = cljs.core.seq(s__58786__$1);
if(temp__5735__auto____$1){
var s__58786__$2 = temp__5735__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__58786__$2)){
var c__4580__auto____$1 = cljs.core.chunk_first(s__58786__$2);
var size__4581__auto____$1 = cljs.core.count(c__4580__auto____$1);
var b__58788 = cljs.core.chunk_buffer(size__4581__auto____$1);
if((function (){var i__58787 = (0);
while(true){
if((i__58787 < size__4581__auto____$1)){
var h = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto____$1,i__58787);
cljs.core.chunk_append(b__58788,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(ms,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,h], null)),new cljs.core.Keyword(null,"attr","attr",-604132353),h,new cljs.core.Keyword(null,"heading","heading",-1312171873),cljs.core.str.cljs$core$IFn$_invoke$arity$1(h),new cljs.core.Keyword(null,"idx","idx",1053688473),idx], null));

var G__58832 = (i__58787 + (1));
i__58787 = G__58832;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58788),athens$views$data_browser$maps_rows_$_iter__58781_$_iter__58785(cljs.core.chunk_rest(s__58786__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__58788),null);
}
} else {
var h = cljs.core.first(s__58786__$2);
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(ms,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,h], null)),new cljs.core.Keyword(null,"attr","attr",-604132353),h,new cljs.core.Keyword(null,"heading","heading",-1312171873),cljs.core.str.cljs$core$IFn$_invoke$arity$1(h),new cljs.core.Keyword(null,"idx","idx",1053688473),idx], null),athens$views$data_browser$maps_rows_$_iter__58781_$_iter__58785(cljs.core.rest(s__58786__$2)));
}
} else {
return null;
}
...
});})(i__58783,idx,c__4580__auto__,size__4581__auto__,b__58784,s__58782__$2,temp__5735__auto__,hs))
,null,null));
});})(i__58783,idx,c__4580__auto__,size__4581__auto__,b__58784,s__58782__$2,temp__5735__auto__,hs))
;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58784),athens$views$data_browser$maps_rows_$_iter__58781(cljs.core.chunk_rest(s__58782__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__58784),null);
}
} else {
var idx = cljs.core.first(s__58782__$2);
return cljs.core.cons(cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"value","value",305978217),idx,new cljs.core.Keyword(null,"heading","heading",-1312171873),"idx",new cljs.core.Keyword(null,"idx","idx",1053688473),idx], null)], null),(function (){var iter__4582__auto__ = ((function (idx,s__58782__$2,temp__5735__auto__,hs){
return (function athens$views$data_browser$maps_rows_$_iter__58781_$_iter__58789(s__58790){
return (new cljs.core.LazySeq(null,(function (){
...
var h = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__58791);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58792),athens$views$data_browser$maps_rows_$_iter__58781_$_iter__58789(cljs.core.chunk_rest(s__58790__$2)));
} else {
...
});})(idx,s__58782__$2,temp__5735__auto__,hs))
;
return iter__4582__auto__(cljs.core.rest(hs));
})()),athens$views$data_browser$maps_rows_$_iter__58781(cljs.core.rest(s__58782__$2)));
}
} else {
return null;
}
...
athens.views.data_browser.cell = (function athens$views$data_browser$cell(p__58794){
...
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58795__$1,new cljs.core.Keyword(null,"value","value",305978217));
...
athens.views.data_browser.table_view = (function athens$views$data_browser$table_view(data,mode,limit,p__58797){
...
var cell_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__58798__$1,new cljs.core.Keyword(null,"cell-fn","cell-fn",706974519),athens.views.data_browser.cell);
var hs = athens.views.data_browser.headings(data,mode);
var rows = athens.views.data_browser.get_rows(data,mode);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"overflow-x","overflow-x",-26547754),"auto"], null)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"table","table",-564943036),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.views.data_browser.table_style),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"thead","thead",-291875296),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tr","tr",-1424774646),(function (){var iter__4582__auto__ = (function athens$views$data_browser$table_view_$_iter__58800(s__58801){
return (new cljs.core.LazySeq(null,(function (){
...
cljs.core.chunk_append(b__58803,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"th","th",-545608566),cljs.core.str.cljs$core$IFn$_invoke$arity$1(h)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["heading-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(h)].join('')], null)));

var G__58836 = (i__58802 + (1));
i__58802 = G__58836;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58803),athens$views$data_browser$table_view_$_iter__58800(cljs.core.chunk_rest(s__58801__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__58803),null);
}
} else {
var h = cljs.core.first(s__58801__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"th","th",-545608566),cljs.core.str.cljs$core$IFn$_invoke$arity$1(h)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["heading-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(h)].join('')], null)),athens$views$data_browser$table_view_$_iter__58800(cljs.core.rest(s__58801__$2)));
}
} else {
return null;
}
...
})()], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tbody","tbody",-80678300),(function (){var iter__4582__auto__ = (function athens$views$data_browser$table_view_$_iter__58804(s__58805){
return (new cljs.core.LazySeq(null,(function (){
...
var row = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__58806);
cljs.core.chunk_append(b__58807,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tr","tr",-1424774646),(function (){var iter__4582__auto__ = ((function (i__58806,row,c__4580__auto__,size__4581__auto__,b__58807,s__58805__$2,temp__5735__auto__,hs,rows,map__58798,map__58798__$1,cell_fn){
return (function athens$views$data_browser$table_view_$_iter__58804_$_iter__58808(s__58809){
return (new cljs.core.LazySeq(null,((function (i__58806,row,c__4580__auto__,size__4581__auto__,b__58807,s__58805__$2,temp__5735__auto__,hs,rows,map__58798,map__58798__$1,cell_fn){
return (function (){
...
var map__58812 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto____$1,i__58810);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58811),athens$views$data_browser$table_view_$_iter__58804_$_iter__58808(cljs.core.chunk_rest(s__58809__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__58811),null);
}
} else {
var map__58814 = cljs.core.first(s__58809__$2);
...
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"background-color","background-color",570434026),"none"], null)], null),(cell_fn.cljs$core$IFn$_invoke$arity$1 ? cell_fn.cljs$core$IFn$_invoke$arity$1(c) : cell_fn.call(null,c))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(idx),cljs.core.str.cljs$core$IFn$_invoke$arity$1(heading)].join('')], null)),athens$views$data_browser$table_view_$_iter__58804_$_iter__58808(cljs.core.rest(s__58809__$2)));
}
} else {
return null;
}
...
});})(i__58806,row,c__4580__auto__,size__4581__auto__,b__58807,s__58805__$2,temp__5735__auto__,hs,rows,map__58798,map__58798__$1,cell_fn))
,null,null));
});})(i__58806,row,c__4580__auto__,size__4581__auto__,b__58807,s__58805__$2,temp__5735__auto__,hs,rows,map__58798,map__58798__$1,cell_fn))
;
...
var row = cljs.core.first(s__58805__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tr","tr",-1424774646),(function (){var iter__4582__auto__ = ((function (row,s__58805__$2,temp__5735__auto__,hs,rows,map__58798,map__58798__$1,cell_fn){
return (function athens$views$data_browser$table_view_$_iter__58804_$_iter__58816(s__58817){
return (new cljs.core.LazySeq(null,(function (){
var s__58817__$1 = s__58817;
while(true){
var temp__5735__auto____$1 = cljs.core.seq(s__58817__$1);
if(temp__5735__auto____$1){
var s__58817__$2 = temp__5735__auto____$1;
...
var map__58820 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__58818);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58819),athens$views$data_browser$table_view_$_iter__58804_$_iter__58816(cljs.core.chunk_rest(s__58817__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__58819),null);
}
} else {
var map__58822 = cljs.core.first(s__58817__$2);
...
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"background-color","background-color",570434026),"none"], null)], null),(cell_fn.cljs$core$IFn$_invoke$arity$1 ? cell_fn.cljs$core$IFn$_invoke$arity$1(c) : cell_fn.call(null,c))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(idx),cljs.core.str.cljs$core$IFn$_invoke$arity$1(heading)].join('')], null)),athens$views$data_browser$table_view_$_iter__58804_$_iter__58816(cljs.core.rest(s__58817__$2)));
}
} else {
return null;
}
...
});})(row,s__58805__$2,temp__5735__auto__,hs,rows,map__58798,map__58798__$1,cell_fn))
;
return iter__4582__auto__(row);
})()], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["row-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(cljs.core.first(row)))].join('')], null)),athens$views$data_browser$table_view_$_iter__58804(cljs.core.rest(s__58805__$2)));
}
} else {
return null;
}
...
(athens.views.data_browser.browser.cljs$core$IFn$_invoke$arity$variadic = (function (_,p__58826){
var vec__58827 = p__58826;
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58827,(0),null);
var limit = reagent.core.atom.cljs$core$IFn$_invoke$arity$1((10));
var increase_limit = (function (){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$3(limit,cljs.core._PLUS_,(10));
});
return (function() { 
var G__58843__delegate = function (result,___$1){
...
var G__58843 = function (result,var_args){
var ___$1 = null;
if (arguments.length > 1) {
var G__58844__i = 0, G__58844__a = new Array(arguments.length -  1);
while (G__58844__i < G__58844__a.length) {G__58844__a[G__58844__i] = arguments[G__58844__i + 1]; ++G__58844__i;}
  ___$1 = new cljs.core.IndexedSeq(G__58844__a,0,null);
} 
return G__58843__delegate.call(this,result,___$1);};
G__58843.cljs$lang$maxFixedArity = 1;
G__58843.cljs$lang$applyTo = (function (arglist__58845){
var result = cljs.core.first(arglist__58845);
var ___$1 = cljs.core.rest(arglist__58845);
return G__58843__delegate(result,___$1);
});
...
/** @this {Function} */
(athens.views.data_browser.browser.cljs$lang$applyTo = (function (seq58824){
var G__58825 = cljs.core.first(seq58824);
var seq58824__$1 = cljs.core.next(seq58824);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__58825,seq58824__$1);
}));
