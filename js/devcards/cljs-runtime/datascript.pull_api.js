...
var G__32634 = db;
var G__32635 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__32634;
p__32618 = G__32635;
continue;
}
...
while(true){
var G__32622 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first(frames));
var G__32622__$1 = (((G__32622 instanceof cljs.core.Keyword))?G__32622.fqn:null);
switch (G__32622__$1) {
case "expand":
var G__32637 = db;
var G__32638 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__32637;
frames = G__32638;
continue;
...
case "expand-rev":
var G__32639 = db;
var G__32640 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__32639;
frames = G__32640;
continue;
...
case "pattern":
var G__32641 = db;
var G__32642 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__32641;
frames = G__32642;
continue;
...
case "recursion":
var G__32643 = db;
var G__32644 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__32643;
frames = G__32644;
continue;
...
var f = first__32625;
var remaining = seq__32624__$1;
var result = (function (){var G__32626 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__32626);
} else {
return G__32626;
}
})();
...
var G__32645 = db;
var G__32646 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__32627 = cljs.core.first(remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__32627,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__32627;
}
})());
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__32628_SHARP_){
return datascript.db.entid_strict(db,p1__32628_SHARP_);
})),eids);
