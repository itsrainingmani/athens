...
var vec__28193 = cljs.core.first(datoms_by_attr);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28193,(0),null);
var datoms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28193,(1),null);
...
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28198__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28198__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__28200 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__28200,attr,eid);
} else {
return G__28200;
}
})();
...
var eid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28205__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28205__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__28213){
while(true){
...
var frame = first__28216;
var frames = seq__28215__$1;
var temp__5733__auto__ = cljs.core.seq(new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5733__auto__){
var eids = temp__5733__auto__;
...
while(true){
var G__28218 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first(frames));
...
case "pattern":
var G__28271 = db;
var G__28272 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__28271;
frames = G__28272;
continue;
...
case "recursion":
var G__28273 = db;
var G__28274 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__28273;
frames = G__28274;
continue;
...
break;
case "done":
var vec__28223 = frames;
var seq__28224 = cljs.core.seq(vec__28223);
var first__28225 = cljs.core.first(seq__28224);
var seq__28224__$1 = cljs.core.next(seq__28224);
var f = first__28225;
var remaining = seq__28224__$1;
var result = (function (){var G__28229 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__28229);
} else {
return G__28229;
}
})();
...
var G__28275 = db;
var G__28276 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__28230 = cljs.core.first(remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__28230,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__28230;
}
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__28218__$1)].join('')));
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__28234_SHARP_){
return datascript.db.entid_strict(db,p1__28234_SHARP_);
})),eids);
