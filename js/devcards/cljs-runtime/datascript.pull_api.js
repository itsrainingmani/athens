...
var depth = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53948__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53948__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
var G__53961 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__53961__$1 = (((G__53961 == null))?null:cljs.core.persistent_BANG_(G__53961));
if((G__53961__$1 == null)){
return null;
} else {
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__53961__$1,key);
}
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__53965){
var vec__53966 = p__53965;
var seq__53967 = cljs.core.seq(vec__53966);
var first__53968 = cljs.core.first(seq__53967);
var seq__53967__$1 = cljs.core.next(seq__53967);
var frame = first__53968;
var frames = seq__53967__$1;
...
var results = (function (){var G__53972 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq(kvps)){
return cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(G__53972,kvps);
} else {
return G__53972;
}
})();
...
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53979__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53979__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_54072 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_54072,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__53991){
var vec__53993 = p__53991;
var seq__53994 = cljs.core.seq(vec__53993);
var first__53995 = cljs.core.first(seq__53994);
var seq__53994__$1 = cljs.core.next(seq__53994);
var parent = first__53995;
var frames = seq__53994__$1;
...
var found = cljs.core.not_empty((function (){var G__53996 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.take.cljs$core$IFn$_invoke$arity$1(limit),G__53996);
} else {
return G__53996;
}
})());
...
if(ref_QMARK_){
return cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__53983_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__53983_SHARP_]);
}),G__54002);
} else {
return G__54002;
}
...
var vec__54006 = spec;
var attr_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54006,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54006,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p__54009){
var vec__54013 = p__54009;
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__54016){
var vec__54017 = p__54016;
var seq__54018 = cljs.core.seq(vec__54017);
var first__54019 = cljs.core.first(seq__54018);
var seq__54018__$1 = cljs.core.next(seq__54018);
var frame = first__54019;
var frames = seq__54018__$1;
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__54020){
...
var frame = first__54023;
var frames = seq__54022__$1;
...
var vec__54024 = cljs.core.first(datoms_by_attr);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54024,(0),null);
var datoms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54024,(1),null);
...
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54027__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54027__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__54029 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__54029,attr,eid);
} else {
return G__54029;
}
})();
...
var eid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54030__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54030__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__54041){
while(true){
var vec__54042 = p__54041;
var seq__54043 = cljs.core.seq(vec__54042);
var first__54044 = cljs.core.first(seq__54043);
var seq__54043__$1 = cljs.core.next(seq__54043);
var frame = first__54044;
var frames = seq__54043__$1;
var temp__5733__auto__ = cljs.core.seq(new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5733__auto__){
var eids = temp__5733__auto__;
...
var G__54084 = db;
var G__54085 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__54084;
p__54041 = G__54085;
continue;
}
...
while(true){
var G__54050 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first(frames));
var G__54050__$1 = (((G__54050 instanceof cljs.core.Keyword))?G__54050.fqn:null);
switch (G__54050__$1) {
case "expand":
var G__54087 = db;
var G__54088 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__54087;
frames = G__54088;
continue;
...
case "expand-rev":
var G__54089 = db;
var G__54090 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__54089;
frames = G__54090;
continue;
...
case "pattern":
var G__54091 = db;
var G__54092 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__54091;
frames = G__54092;
continue;
...
case "recursion":
var G__54093 = db;
var G__54094 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__54093;
frames = G__54094;
continue;
...
break;
case "done":
var vec__54051 = frames;
var seq__54052 = cljs.core.seq(vec__54051);
var first__54053 = cljs.core.first(seq__54052);
var seq__54052__$1 = cljs.core.next(seq__54052);
var f = first__54053;
var remaining = seq__54052__$1;
var result = (function (){var G__54054 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__54054);
} else {
return G__54054;
}
})();
...
var G__54095 = db;
var G__54096 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__54055 = cljs.core.first(remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__54055,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__54055;
}
})());
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__54056_SHARP_){
return datascript.db.entid_strict(db,p1__54056_SHARP_);
})),eids);
