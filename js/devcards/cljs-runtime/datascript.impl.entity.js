...
var G__28182 = db;
var G__28183 = e;
var G__28184 = cljs.core.volatile_BANG_(false);
var G__28185 = cljs.core.volatile_BANG_(cljs.core.PersistentArrayMap.EMPTY);
return (datascript.impl.entity.__GT_Entity.cljs$core$IFn$_invoke$arity$4 ? datascript.impl.entity.__GT_Entity.cljs$core$IFn$_invoke$arity$4(G__28182,G__28183,G__28184,G__28185) : datascript.impl.entity.__GT_Entity.call(null,G__28182,G__28183,G__28184,G__28185));
} else {
return null;
}
});
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__28189_SHARP_,datascript.impl.entity.entity(db,new cljs.core.Keyword(null,"v","v",21465059).cljs$core$IFn$_invoke$arity$1(p2__28190_SHARP_)));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
} else {
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__28191_SHARP_,p2__28192_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__28191_SHARP_,new cljs.core.Keyword(null,"v","v",21465059).cljs$core$IFn$_invoke$arity$1(p2__28192_SHARP_));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
}
} else {
if(datascript.db.ref_QMARK_(db,a)){
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__28196_SHARP_,datascript.impl.entity.entity(db,new cljs.core.Keyword(null,"e","e",1381269198).cljs$core$IFn$_invoke$arity$1(p2__28197_SHARP_)));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
}
} else {
return not_found;
...
var iter__4529__auto__ = (function datascript$impl$entity$js_seq_$_iter__28201(s__28202){
return (new cljs.core.LazySeq(null,(function (){
var s__28202__$1 = s__28202;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__28202__$1);
if(temp__5735__auto__){
var s__28202__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__28202__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__28202__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__28204 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__28203 = (0);
while(true){
if((i__28203 < size__4528__auto__)){
var vec__28207 = cljs.core._nth(c__4527__auto__,i__28203);
...
cljs.core.chunk_append(b__28204,((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)));

var G__28270 = (i__28203 + (1));
i__28203 = G__28270;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__28204),datascript$impl$entity$js_seq_$_iter__28201(cljs.core.chunk_rest(s__28202__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__28204),null);
}
} else {
var vec__28210 = cljs.core.first(s__28202__$2);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28210,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28210,(1),null);
return cljs.core.cons(((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)),datascript$impl$entity$js_seq_$_iter__28201(cljs.core.rest(s__28202__$2)));
}
} else {
return null;
}
...
var self__ = this;
var this$ = this;
var seq__28219 = cljs.core.seq(datascript.impl.entity.js_seq(this$));
var chunk__28220 = null;
var count__28221 = (0);
var i__28222 = (0);
while(true){
if((i__28222 < count__28221)){
var vec__28235 = chunk__28220.cljs$core$IIndexed$_nth$arity$2(null,i__28222);
...
var G__28278 = seq__28219;
var G__28279 = chunk__28220;
var G__28280 = count__28221;
var G__28281 = (i__28222 + (1));
seq__28219 = G__28278;
chunk__28220 = G__28279;
count__28221 = G__28280;
i__28222 = G__28281;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__28219);
if(temp__5735__auto__){
var seq__28219__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__28219__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__28219__$1);
var G__28282 = cljs.core.chunk_rest(seq__28219__$1);
var G__28283 = c__4556__auto__;
var G__28284 = cljs.core.count(c__4556__auto__);
var G__28285 = (0);
seq__28219 = G__28282;
chunk__28220 = G__28283;
count__28221 = G__28284;
i__28222 = G__28285;
continue;
} else {
var vec__28238 = cljs.core.first(seq__28219__$1);
...
var G__28286 = cljs.core.next(seq__28219__$1);
var G__28287 = null;
var G__28288 = (0);
var G__28289 = (0);
seq__28219 = G__28286;
chunk__28220 = G__28287;
count__28221 = G__28288;
i__28222 = G__28289;
continue;
}
} else {
...
(datascript.impl.entity.Entity.prototype.apply = (function (self__,args28217){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args28217)));
}));
