...
var vec__56539 = nums;
var lo = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56539,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56539,(1),null);
var hi = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56539,(2),null);
return instaparse.combinators_source.unicode_char.cljs$core$IFn$_invoke$arity$2(lo,hi);
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(instaparse.combinators_source.cat,(function (){var iter__4529__auto__ = (function instaparse$abnf$iter__56542(s__56543){
...
var c__4527__auto__ = cljs.core.chunk_first(s__56543__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__56545 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__56544 = (0);
while(true){
if((i__56544 < size__4528__auto__)){
var n = cljs.core._nth(c__4527__auto__,i__56544);
cljs.core.chunk_append(b__56545,instaparse.combinators_source.unicode_char.cljs$core$IFn$_invoke$arity$1(n));

var G__56610 = (i__56544 + (1));
i__56544 = G__56610;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__56545),instaparse$abnf$iter__56542(cljs.core.chunk_rest(s__56543__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__56545),null);
}
} else {
var n = cljs.core.first(s__56543__$2);
return cljs.core.cons(instaparse.combinators_source.unicode_char.cljs$core$IFn$_invoke$arity$1(n),instaparse$abnf$iter__56542(cljs.core.rest(s__56543__$2)));
}
} else {
return null;
}
...
/** @this {Function} */
(instaparse.abnf.get_char_combinator.cljs$lang$applyTo = (function (seq56537){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq56537));
}));
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4529__auto__ = (function instaparse$abnf$project_$_iter__56550(s__56551){
return (new cljs.core.LazySeq(null,(function (){
...
var k = cljs.core._nth(c__4527__auto__,i__56552);
if(cljs.core.contains_QMARK_(m,k)){
cljs.core.chunk_append(b__56553,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,(m.cljs$core$IFn$_invoke$arity$1 ? m.cljs$core$IFn$_invoke$arity$1(k) : m.call(null,k))], null));

var G__56611 = (i__56552 + (1));
i__56552 = G__56611;
continue;
} else {
var G__56612 = (i__56552 + (1));
i__56552 = G__56612;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__56553),instaparse$abnf$project_$_iter__56550(cljs.core.chunk_rest(s__56551__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__56553),null);
}
} else {
var k = cljs.core.first(s__56551__$2);
if(cljs.core.contains_QMARK_(m,k)){
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,(m.cljs$core$IFn$_invoke$arity$1 ? m.cljs$core$IFn$_invoke$arity$1(k) : m.call(null,k))], null),instaparse$abnf$project_$_iter__56550(cljs.core.rest(s__56551__$2)));
} else {
var G__56616 = cljs.core.rest(s__56551__$2);
s__56551__$1 = G__56616;
continue;
}
}
} else {
...
var G__56624__delegate = function (rest__56558_SHARP_){
if(cljs.core.truth_(instaparse.abnf._STAR_case_insensitive_STAR_)){
return instaparse.combinators_source.nt(cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(clojure.string.upper_case(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,rest__56558_SHARP_))));
} else {
return instaparse.combinators_source.nt(cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,rest__56558_SHARP_)));
}
};
...
while (G__56625__i < G__56625__a.length) {G__56625__a[G__56625__i] = arguments[G__56625__i + 0]; ++G__56625__i;}
  rest__56558_SHARP_ = new cljs.core.IndexedSeq(G__56625__a,0,null);
} 
return G__56624__delegate.call(this,rest__56558_SHARP_);};
G__56624.cljs$lang$maxFixedArity = 0;
G__56624.cljs$lang$applyTo = (function (arglist__56626){
var rest__56558_SHARP_ = cljs.core.seq(arglist__56626);
return G__56624__delegate(rest__56558_SHARP_);
});
G__56624.cljs$core$IFn$_invoke$arity$variadic = G__56624__delegate;
return G__56624;
})()
,(function() { 
var G__56627__delegate = function (rest__56559_SHARP_){
return instaparse.abnf.parse_int(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,rest__56559_SHARP_));
};
...
while (G__56628__i < G__56628__a.length) {G__56628__a[G__56628__i] = arguments[G__56628__i + 0]; ++G__56628__i;}
  rest__56559_SHARP_ = new cljs.core.IndexedSeq(G__56628__a,0,null);
} 
return G__56627__delegate.call(this,rest__56559_SHARP_);};
G__56627.cljs$lang$maxFixedArity = 0;
G__56627.cljs$lang$applyTo = (function (arglist__56629){
var rest__56559_SHARP_ = cljs.core.seq(arglist__56629);
return G__56627__delegate(rest__56559_SHARP_);
});
...
,(function() { 
var G__56641__delegate = function (rest__56557_SHARP_){
if(cljs.core.truth_(instaparse.abnf._STAR_case_insensitive_STAR_)){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(clojure.string.upper_case(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,rest__56557_SHARP_)));
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,rest__56557_SHARP_));
}
};
...
while (G__56644__i < G__56644__a.length) {G__56644__a[G__56644__i] = arguments[G__56644__i + 0]; ++G__56644__i;}
  rest__56557_SHARP_ = new cljs.core.IndexedSeq(G__56644__a,0,null);
} 
return G__56641__delegate.call(this,rest__56557_SHARP_);};
G__56641.cljs$lang$maxFixedArity = 0;
G__56641.cljs$lang$applyTo = (function (arglist__56645){
var rest__56557_SHARP_ = cljs.core.seq(arglist__56645);
return G__56641__delegate(rest__56557_SHARP_);
});
