...
var G__24980 = (node.pointers[me.tonsky.persistent_sorted_set.path_get(path,level)]);
level = G__24978;
node = G__24980;
continue;
} else {
...
var pos_25118 = (0);
while(true){
var rest_25119 = (len - pos_25118);
if((rest_25119 <= max_len)){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25118));
} else {
if((rest_25119 >= (chunk_len + min_len))){
...
var piece_len_25122 = (rest_25119 >>> (1));
