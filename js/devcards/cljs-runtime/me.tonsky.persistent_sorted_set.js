...
(new_arr[(i__26847__auto___27044 + (0))] = (arr[(i__26847__auto___27044 + cut_from)]));
...
var n__4666__auto___27049 = l__26846__auto___27047;
...
var self__ = this;
var ___$1 = this;
var arr__26883__auto__ = self__.keys;
return (arr__26883__auto__[(arr__26883__auto__.length - (1))]);
}));
...
while(true){
if((level > (0))){
var G__27146 = (level - me.tonsky.persistent_sorted_set.level_shift);
var G__27147 = (node.pointers[me.tonsky.persistent_sorted_set.path_get(path,level)]);
level = G__27146;
node = G__27147;
continue;
} else {
...
while(true){
if((level__$1 > (0))){
var G__27158 = (function (){var arr__26883__auto__ = node__$1.pointers;
return (arr__26883__auto__[(arr__26883__auto__.length - (1))]);
})();
var G__27159 = me.tonsky.persistent_sorted_set.path_set(path,level__$1,(node__$1.pointers.length - (1)));
var G__27160 = (level__$1 - me.tonsky.persistent_sorted_set.level_shift);
node__$1 = G__27158;
path = G__27159;
level__$1 = G__27160;
continue;
...
var G__27204 = new_left;
var G__27205 = me.tonsky.persistent_sorted_set.keys_for(self__.set,new_left);
var G__27206 = me.tonsky.persistent_sorted_set.path_get(new_left,(0));
var G__27207 = new_acc;
left__$1 = G__27204;
keys__$1 = G__27205;
idx__$1 = G__27206;
acc = G__27207;
...
var pos_27273 = (0);
while(true){
var rest_27274 = (len - pos_27273);
if((rest_27274 <= max_len)){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_27273));
} else {
if((rest_27274 >= (chunk_len + min_len))){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_27273,(pos_27273 + chunk_len)));

var G__27275 = (pos_27273 + chunk_len);
pos_27273 = G__27275;
continue;
} else {
var piece_len_27277 = (rest_27274 >>> (1));
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_27273,(pos_27273 + piece_len_27277)));

var G__27278 = (pos_27273 + piece_len_27277);
pos_27273 = G__27278;
continue;
