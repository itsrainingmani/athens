...
me.tonsky.persistent_sorted_set.level_shift = (cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__26600_SHARP_){
return (((32) & (1 << p1__26600_SHARP_)) != 0);
...
while(true){
if((level__$1 > (0))){
var G__26817 = (function (){var arr__26555__auto__ = node__$1.pointers;
return (arr__26555__auto__[(arr__26555__auto__.length - (1))]);
})();
var G__26818 = me.tonsky.persistent_sorted_set.path_set(path,level__$1,(node__$1.pointers.length - (1)));
var G__26819 = (level__$1 - me.tonsky.persistent_sorted_set.level_shift);
node__$1 = G__26817;
path = G__26818;
level__$1 = G__26819;
continue;
...
var me$tonsky$persistent_sorted_set$IIter$_copy$dyn_26846 = (function (this$,left,right){
...
return me$tonsky$persistent_sorted_set$IIter$_copy$dyn_26846(this$,left,right);
}
});
...
var G__26922 = (node.pointers[idx]);
var G__26923 = me.tonsky.persistent_sorted_set.path_set(path,level,idx);
var G__26924 = (level - me.tonsky.persistent_sorted_set.level_shift);
node = G__26922;
path = G__26923;
level = G__26924;
continue;
...
var G__26927 = (node.pointers[idx]);
var G__26928 = me.tonsky.persistent_sorted_set.path_set(path,level,idx);
var G__26929 = (level - me.tonsky.persistent_sorted_set.level_shift);
node = G__26927;
path = G__26928;
level = G__26929;
continue;
...
while(true){
if((i_26934 < len)){
(arr[i_26934] = (function (){var G__26671 = (arr[i_26934]);
...
var pos_26937 = (0);
while(true){
var rest_26938 = (len - pos_26937);
if((rest_26938 <= max_len)){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_26937));
} else {
if((rest_26938 >= (chunk_len + min_len))){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_26937,(pos_26937 + chunk_len)));

var G__26940 = (pos_26937 + chunk_len);
pos_26937 = G__26940;
continue;
} else {
var piece_len_26941 = (rest_26938 >>> (1));
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_26937,(pos_26937 + piece_len_26941)));

var G__26942 = (pos_26937 + piece_len_26941);
pos_26937 = G__26942;
continue;
...
break;
default:
var G__26976 = me.tonsky.persistent_sorted_set.arr_map_inplace(((function (current_level,shift,G__26681,leaves){
...
var G__26977 = (shift + me.tonsky.persistent_sorted_set.level_shift);
current_level = G__26976;
shift = G__26977;
continue;
...
var G__26986 = (i__4737__auto___26985 + (1));
i__4737__auto___26985 = G__26986;
continue;
} else {
}
break;
