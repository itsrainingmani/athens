...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.filters !== 'undefined') && (typeof athens.devcards.filters.t_athens$devcards$filters60141 !== 'undefined')){
} else {
...
*/
athens.devcards.filters.t_athens$devcards$filters60141 = (function (meta60142){
this.meta60142 = meta60142;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.filters.t_athens$devcards$filters60141.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60143,meta60142__$1){
var self__ = this;
var _60143__$1 = this;
return (new athens.devcards.filters.t_athens$devcards$filters60141(meta60142__$1));
}));

(athens.devcards.filters.t_athens$devcards$filters60141.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60143){
var self__ = this;
var _60143__$1 = this;
return self__.meta60142;
}));

(athens.devcards.filters.t_athens$devcards$filters60141.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.filters.t_athens$devcards$filters60141.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__47726__auto__,devcard_opts__47727__auto__){
var self__ = this;
...
(athens.devcards.filters.t_athens$devcards$filters60141.getBasis = (function (){
...
(athens.devcards.filters.t_athens$devcards$filters60141.cljs$lang$type = true);

(athens.devcards.filters.t_athens$devcards$filters60141.cljs$lang$ctorStr = "athens.devcards.filters/t_athens$devcards$filters60141");

(athens.devcards.filters.t_athens$devcards$filters60141.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"athens.devcards.filters/t_athens$devcards$filters60141");
}));

/**
 * Positional factory function for athens.devcards.filters/t_athens$devcards$filters60141.
 */
athens.devcards.filters.__GT_t_athens$devcards$filters60141 = (function athens$devcards$filters$__GT_t_athens$devcards$filters60141(meta60142){
return (new athens.devcards.filters.t_athens$devcards$filters60141(meta60142));
});

}

return (new athens.devcards.filters.t_athens$devcards$filters60141(null));
})()
