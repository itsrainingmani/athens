...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.filters !== 'undefined') && (typeof athens.devcards.filters.t_athens$devcards$filters60106 !== 'undefined')){
} else {
...
*/
athens.devcards.filters.t_athens$devcards$filters60106 = (function (meta60107){
this.meta60107 = meta60107;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.filters.t_athens$devcards$filters60106.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60108,meta60107__$1){
var self__ = this;
var _60108__$1 = this;
return (new athens.devcards.filters.t_athens$devcards$filters60106(meta60107__$1));
}));

(athens.devcards.filters.t_athens$devcards$filters60106.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60108){
var self__ = this;
var _60108__$1 = this;
return self__.meta60107;
}));

(athens.devcards.filters.t_athens$devcards$filters60106.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.filters.t_athens$devcards$filters60106.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__47717__auto__,devcard_opts__47718__auto__){
var self__ = this;
...
(athens.devcards.filters.t_athens$devcards$filters60106.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta60107","meta60107",1337368214,null)], null);
}));

(athens.devcards.filters.t_athens$devcards$filters60106.cljs$lang$type = true);

(athens.devcards.filters.t_athens$devcards$filters60106.cljs$lang$ctorStr = "athens.devcards.filters/t_athens$devcards$filters60106");

(athens.devcards.filters.t_athens$devcards$filters60106.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"athens.devcards.filters/t_athens$devcards$filters60106");
}));

/**
 * Positional factory function for athens.devcards.filters/t_athens$devcards$filters60106.
 */
athens.devcards.filters.__GT_t_athens$devcards$filters60106 = (function athens$devcards$filters$__GT_t_athens$devcards$filters60106(meta60107){
return (new athens.devcards.filters.t_athens$devcards$filters60106(meta60107));
});

}

return (new athens.devcards.filters.t_athens$devcards$filters60106(null));
})()
