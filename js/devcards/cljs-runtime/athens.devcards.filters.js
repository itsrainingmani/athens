...
var num_filters = cljs.core.count(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p__82776){
var vec__82777 = p__82776;
var _k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82777,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82777,(1),null);
...
})], null)], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.devcards.filters.filter_list_style),(((cljs.core.count(items__$2) > (0)))?cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4582__auto__ = (function athens$devcards$filters$filters_el_$_iter__82780(s__82781){
return (new cljs.core.LazySeq(null,(function (){
var s__82781__$1 = s__82781;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__82781__$1);
if(temp__5735__auto__){
var s__82781__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__82781__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__82781__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__82783 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__82782 = (0);
while(true){
if((i__82782 < size__4581__auto__)){
var vec__82784 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__82782);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82784,(0),null);
var map__82787 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82784,(1),null);
var map__82787__$1 = (((((!((map__82787 == null))))?(((((map__82787.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__82787.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__82787):map__82787);
var count = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82787__$1,new cljs.core.Keyword(null,"count","count",2139924085));
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82787__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
...
cljs.core.chunk_append(b__82783,cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([athens.devcards.filters.filter_style,((added_QMARK_)?athens.devcards.filters.added_style:((excluded_QMARK_)?athens.devcards.filters.excluded_style:null))], 0)),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__82782,added_QMARK_,excluded_QMARK_,vec__82784,k,map__82787,map__82787__$1,count,state,c__4580__auto__,size__4581__auto__,b__82783,s__82781__$2,temp__5735__auto__,sort_,filtered_items,items__$2,num_filters,s){
return (function (_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(s,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"items","items",1031954938),k,new cljs.core.Keyword(null,"state","state",-1988618099)], null),(function (){var G__82789 = state;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__82789)){
return new cljs.core.Keyword(null,"added","added",2057651688);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"added","added",2057651688),G__82789)){
return new cljs.core.Keyword(null,"excluded","excluded",-715952088);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"excluded","excluded",-715952088),G__82789)){
return null;
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__82789)].join('')));

}
}
}
})());
});})(i__82782,added_QMARK_,excluded_QMARK_,vec__82784,k,map__82787,map__82787__$1,count,state,c__4580__auto__,size__4581__auto__,b__82783,s__82781__$2,temp__5735__auto__,sort_,filtered_items,items__$2,num_filters,s))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__82783),athens$devcards$filters$filters_el_$_iter__82780(cljs.core.chunk_rest(s__82781__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__82783),null);
}
} else {
var vec__82790 = cljs.core.first(s__82781__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82790,(0),null);
var map__82793 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82790,(1),null);
var map__82793__$1 = (((((!((map__82793 == null))))?(((((map__82793.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__82793.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__82793):map__82793);
var count = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82793__$1,new cljs.core.Keyword(null,"count","count",2139924085));
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82793__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var added_QMARK_ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(state,new cljs.core.Keyword(null,"added","added",2057651688));
var excluded_QMARK_ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(state,new cljs.core.Keyword(null,"excluded","excluded",-715952088));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([athens.devcards.filters.filter_style,((added_QMARK_)?athens.devcards.filters.added_style:((excluded_QMARK_)?athens.devcards.filters.excluded_style:null))], 0)),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (added_QMARK_,excluded_QMARK_,vec__82790,k,map__82793,map__82793__$1,count,state,s__82781__$2,temp__5735__auto__,sort_,filtered_items,items__$2,num_filters,s){
return (function (_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(s,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"items","items",1031954938),k,new cljs.core.Keyword(null,"state","state",-1988618099)], null),(function (){var G__82796 = state;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__82796)){
return new cljs.core.Keyword(null,"added","added",2057651688);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"added","added",2057651688),G__82796)){
return new cljs.core.Keyword(null,"excluded","excluded",-715952088);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"excluded","excluded",-715952088),G__82796)){
return null;
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__82796)].join('')));

}
}
}
})());
});})(added_QMARK_,excluded_QMARK_,vec__82790,k,map__82793,map__82793__$1,count,state,s__82781__$2,temp__5735__auto__,sort_,filtered_items,items__$2,num_filters,s))
], null)),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.devcards.filters.count_style),count], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.devcards.filters.filter_name_style),k], null),((((added_QMARK_) || (excluded_QMARK_)))?new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.devcards.filters.state_style),state,((added_QMARK_)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$material_ui$icons$index.Check], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$material_ui$icons$index.Block], null))], null):null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),k], null)),athens$devcards$filters$filters_el_$_iter__82780(cljs.core.rest(s__82781__$2)));
}
} else {
return null;
}
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.filters !== 'undefined') && (typeof athens.devcards.filters.t_athens$devcards$filters82798 !== 'undefined')){
} else {
...
*/
athens.devcards.filters.t_athens$devcards$filters82798 = (function (meta82799){
this.meta82799 = meta82799;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.filters.t_athens$devcards$filters82798.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_82800,meta82799__$1){
var self__ = this;
var _82800__$1 = this;
return (new athens.devcards.filters.t_athens$devcards$filters82798(meta82799__$1));
}));

(athens.devcards.filters.t_athens$devcards$filters82798.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_82800){
var self__ = this;
var _82800__$1 = this;
return self__.meta82799;
}));

(athens.devcards.filters.t_athens$devcards$filters82798.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.filters.t_athens$devcards$filters82798.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__64674__auto__,devcard_opts__64675__auto__){
var self__ = this;
...
(athens.devcards.filters.t_athens$devcards$filters82798.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta82799","meta82799",-2048675536,null)], null);
}));

(athens.devcards.filters.t_athens$devcards$filters82798.cljs$lang$type = true);

(athens.devcards.filters.t_athens$devcards$filters82798.cljs$lang$ctorStr = "athens.devcards.filters/t_athens$devcards$filters82798");

(athens.devcards.filters.t_athens$devcards$filters82798.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.filters/t_athens$devcards$filters82798");
}));

/**
 * Positional factory function for athens.devcards.filters/t_athens$devcards$filters82798.
 */
athens.devcards.filters.__GT_t_athens$devcards$filters82798 = (function athens$devcards$filters$__GT_t_athens$devcards$filters82798(meta82799){
return (new athens.devcards.filters.t_athens$devcards$filters82798(meta82799));
});

}

return (new athens.devcards.filters.t_athens$devcards$filters82798(null));
})()
