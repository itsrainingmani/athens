...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.filters !== 'undefined') && (typeof athens.devcards.filters.t_athens$devcards$filters61539 !== 'undefined')){
} else {
...
*/
athens.devcards.filters.t_athens$devcards$filters61539 = (function (meta61540){
this.meta61540 = meta61540;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.filters.t_athens$devcards$filters61539.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61541,meta61540__$1){
var self__ = this;
var _61541__$1 = this;
return (new athens.devcards.filters.t_athens$devcards$filters61539(meta61540__$1));
}));

(athens.devcards.filters.t_athens$devcards$filters61539.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61541){
var self__ = this;
var _61541__$1 = this;
return self__.meta61540;
}));

(athens.devcards.filters.t_athens$devcards$filters61539.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.filters.t_athens$devcards$filters61539.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__49619__auto__,devcard_opts__49620__auto__){
var self__ = this;
...
(athens.devcards.filters.t_athens$devcards$filters61539.getBasis = (function (){
...
(athens.devcards.filters.t_athens$devcards$filters61539.cljs$lang$type = true);

(athens.devcards.filters.t_athens$devcards$filters61539.cljs$lang$ctorStr = "athens.devcards.filters/t_athens$devcards$filters61539");

(athens.devcards.filters.t_athens$devcards$filters61539.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.filters/t_athens$devcards$filters61539");
}));

/**
 * Positional factory function for athens.devcards.filters/t_athens$devcards$filters61539.
 */
athens.devcards.filters.__GT_t_athens$devcards$filters61539 = (function athens$devcards$filters$__GT_t_athens$devcards$filters61539(meta61540){
return (new athens.devcards.filters.t_athens$devcards$filters61539(meta61540));
});

}

return (new athens.devcards.filters.t_athens$devcards$filters61539(null));
})()
