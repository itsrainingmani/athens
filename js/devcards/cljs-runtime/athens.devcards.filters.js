...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.filters !== 'undefined') && (typeof athens.devcards.filters.t_athens$devcards$filters61085 !== 'undefined')){
} else {
...
*/
athens.devcards.filters.t_athens$devcards$filters61085 = (function (meta61086){
this.meta61086 = meta61086;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.filters.t_athens$devcards$filters61085.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61087,meta61086__$1){
var self__ = this;
var _61087__$1 = this;
return (new athens.devcards.filters.t_athens$devcards$filters61085(meta61086__$1));
}));

(athens.devcards.filters.t_athens$devcards$filters61085.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61087){
var self__ = this;
var _61087__$1 = this;
return self__.meta61086;
}));

(athens.devcards.filters.t_athens$devcards$filters61085.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.filters.t_athens$devcards$filters61085.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__42228__auto__,devcard_opts__42229__auto__){
var self__ = this;
...
(athens.devcards.filters.t_athens$devcards$filters61085.getBasis = (function (){
...
(athens.devcards.filters.t_athens$devcards$filters61085.cljs$lang$type = true);

(athens.devcards.filters.t_athens$devcards$filters61085.cljs$lang$ctorStr = "athens.devcards.filters/t_athens$devcards$filters61085");

(athens.devcards.filters.t_athens$devcards$filters61085.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.filters/t_athens$devcards$filters61085");
}));

/**
 * Positional factory function for athens.devcards.filters/t_athens$devcards$filters61085.
 */
athens.devcards.filters.__GT_t_athens$devcards$filters61085 = (function athens$devcards$filters$__GT_t_athens$devcards$filters61085(meta61086){
return (new athens.devcards.filters.t_athens$devcards$filters61085(meta61086));
});

}

return (new athens.devcards.filters.t_athens$devcards$filters61085(null));
})()
