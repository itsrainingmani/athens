...
var self__ = this;
var self__ = this;
var G__51599 = (arguments.length - (1));
switch (G__51599) {
case (2):
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(this$__$1,new cljs.core.Keyword("tick","intervals","tick/intervals",2091945314),cljs.core.vec(cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p1__51715_SHARP_){
return tick.interval.slice(p1__51715_SHARP_,beginning,end);
}),intervals)));
} else {
...
if(cljs.core.truth_(temp__5733__auto__)){
var intervals = temp__5733__auto__;
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(this$__$1,new cljs.core.Keyword("tick","intervals","tick/intervals",2091945314),cljs.core.vec(cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p1__51716_SHARP_){
return tick.interval.slice(p1__51716_SHARP_,tick.core.beginning(this$__$1),t);
}),intervals))),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(this$__$1,new cljs.core.Keyword("tick","intervals","tick/intervals",2091945314),cljs.core.vec(cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p1__51720_SHARP_){
return tick.interval.slice(p1__51720_SHARP_,t,tick.core.end(this$__$1));
}),intervals)))], null);
} else {
...
var x = cljs.core.first(xs);
var y = cljs.core.first(ys);
var G__51870 = tick.interval.relation(x,y);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__51870__$1)].join('')));
