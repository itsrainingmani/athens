...
var G__51728 = cljs.core.rest(s__51487__$1);
s__51487__$1 = G__51728;
continue;
}
} else {
return null;
...
var x = cljs.core.first(xs);
var y = cljs.core.first(ys);
var G__51609 = tick.interval.relation(x,y);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__51609__$1)].join('')));
