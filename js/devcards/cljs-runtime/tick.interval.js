...
var G__51460 = tick.interval.relation(x,y);
...
var iter__4582__auto__ = (function tick$interval$iter__51480(s__51481){
...
var iterys__4578__auto__ = ((function (s__51481__$1,xi,xs__6292__auto__,temp__5735__auto__,intervals__$1){
return (function tick$interval$iter__51480_$_iter__51482(s__51483){
return (new cljs.core.LazySeq(null,((function (s__51481__$1,xi,xs__6292__auto__,temp__5735__auto__,intervals__$1){
return (function (){
var s__51483__$1 = s__51483;
while(true){
var temp__5735__auto____$1 = cljs.core.seq(s__51483__$1);
if(temp__5735__auto____$1){
var s__51483__$2 = temp__5735__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__51483__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__51483__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__51485 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__51484 = (0);
while(true){
if((i__51484 < size__4581__auto__)){
var yi = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__51484);
if((xi < yi)){
...
cljs.core.chunk_append(b__51485,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"x","x",2099068185),x,new cljs.core.Keyword(null,"y","y",-1757859776),y,new cljs.core.Keyword(null,"relation","relation",-693437925),tick.interval.relation(x,y),new cljs.core.Keyword(null,"concur","concur",4812827),conc], null));

var G__51732 = (i__51484 + (1));
i__51484 = G__51732;
continue;
} else {
var G__51733 = (i__51484 + (1));
i__51484 = G__51733;
continue;
}
} else {
var G__51734 = (i__51484 + (1));
i__51484 = G__51734;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__51485),tick$interval$iter__51480_$_iter__51482(cljs.core.chunk_rest(s__51483__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__51485),null);
}
} else {
var yi = cljs.core.first(s__51483__$2);
if((xi < yi)){
var x = cljs.core.get.cljs$core$IFn$_invoke$arity$2(intervals__$1,xi);
var y = cljs.core.get.cljs$core$IFn$_invoke$arity$2(intervals__$1,yi);
var conc = tick.interval.concur(x,y);
if(cljs.core.truth_(conc)){
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"x","x",2099068185),x,new cljs.core.Keyword(null,"y","y",-1757859776),y,new cljs.core.Keyword(null,"relation","relation",-693437925),tick.interval.relation(x,y),new cljs.core.Keyword(null,"concur","concur",4812827),conc], null),tick$interval$iter__51480_$_iter__51482(cljs.core.rest(s__51483__$2)));
} else {
var G__51735 = cljs.core.rest(s__51483__$2);
s__51483__$1 = G__51735;
continue;
}
} else {
var G__51736 = cljs.core.rest(s__51483__$2);
s__51483__$1 = G__51736;
continue;
}
}
} else {
...
});})(s__51481__$1,xi,xs__6292__auto__,temp__5735__auto__,intervals__$1))
,null,null));
});})(s__51481__$1,xi,xs__6292__auto__,temp__5735__auto__,intervals__$1))
;
...
if(fs__4579__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__4579__auto__,tick$interval$iter__51480(cljs.core.rest(s__51481__$1)));
} else {
var G__51737 = cljs.core.rest(s__51481__$1);
s__51481__$1 = G__51737;
continue;
}
} else {
return null;
...
var G__51604 = r;
var G__51604__$1 = ((cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(tick.core.beginning(cljs.core.first(coll)),tick.core.min_of_type(tick.core.beginning(cljs.core.first(coll)))))?(function (){var fexpr__51605 = (function (p1__51597_SHARP_){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [tick.interval.new_interval(tick.core.min_of_type(tick.core.beginning(cljs.core.first(coll))),tick.core.beginning(cljs.core.first(coll)))], null),p1__51597_SHARP_);
});
...
var fexpr__51607 = (function (p1__51598_SHARP_){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(p1__51598_SHARP_,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [tick.interval.new_interval(tick.core.end(cljs.core.last(coll)),tick.core.max_of_type(tick.core.end(cljs.core.last(coll))))], null));
});
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,(function (p1__51623_SHARP_){
return tick.core.min.cljs$core$IFn$_invoke$arity$variadic(tick.core.forward_duration(p1__51623_SHARP_,period),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([tick.core.end(ival)], 0));
