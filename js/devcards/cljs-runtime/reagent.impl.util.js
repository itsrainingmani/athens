...
var vec__30847 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(name_str,/-/);
...
var start = first__30849;
var parts = seq__30848__$1;
...
var self__ = this;
var self__ = this;
var G__30884 = (arguments.length - (1));
switch (G__30884) {
case (0):
...
(reagent.impl.util.PartialFn.prototype.apply = (function (self__,args30881){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args30881)));
}));
...
var i__4737__auto___31011 = (0);
while(true){
if((i__4737__auto___31011 < len__4736__auto___31009)){
args_arr__4757__auto__.push((arguments[i__4737__auto___31011]));

var G__31015 = (i__4737__auto___31011 + (1));
i__4737__auto___31011 = G__31015;
continue;
} else {
}
break;
