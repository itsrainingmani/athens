...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.breadcrumbs !== 'undefined') && (typeof athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58585 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58585 = (function (meta58586){
this.meta58586 = meta58586;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58585.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_58587,meta58586__$1){
var self__ = this;
var _58587__$1 = this;
return (new athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58585(meta58586__$1));
}));

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58585.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_58587){
var self__ = this;
var _58587__$1 = this;
return self__.meta58586;
}));

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58585.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58585.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__49619__auto__,devcard_opts__49620__auto__){
var self__ = this;
var this__49619__auto____$1 = this;
...
(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58585.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta58586","meta58586",178419679,null)], null);
}));

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58585.cljs$lang$type = true);

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58585.cljs$lang$ctorStr = "athens.devcards.breadcrumbs/t_athens$devcards$breadcrumbs58585");

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58585.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.breadcrumbs/t_athens$devcards$breadcrumbs58585");
}));

/**
 * Positional factory function for athens.devcards.breadcrumbs/t_athens$devcards$breadcrumbs58585.
 */
athens.devcards.breadcrumbs.__GT_t_athens$devcards$breadcrumbs58585 = (function athens$devcards$breadcrumbs$__GT_t_athens$devcards$breadcrumbs58585(meta58586){
return (new athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58585(meta58586));
});

}

return (new athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58585(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.breadcrumbs !== 'undefined') && (typeof athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58588 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58588 = (function (meta58589){
this.meta58589 = meta58589;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58588.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_58590,meta58589__$1){
var self__ = this;
var _58590__$1 = this;
return (new athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58588(meta58589__$1));
}));

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58588.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_58590){
var self__ = this;
var _58590__$1 = this;
return self__.meta58589;
}));

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58588.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58588.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__49619__auto__,devcard_opts__49620__auto__){
var self__ = this;
var this__49619__auto____$1 = this;
...
(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58588.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta58589","meta58589",1702815650,null)], null);
}));

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58588.cljs$lang$type = true);

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58588.cljs$lang$ctorStr = "athens.devcards.breadcrumbs/t_athens$devcards$breadcrumbs58588");

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58588.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.breadcrumbs/t_athens$devcards$breadcrumbs58588");
}));

/**
 * Positional factory function for athens.devcards.breadcrumbs/t_athens$devcards$breadcrumbs58588.
 */
athens.devcards.breadcrumbs.__GT_t_athens$devcards$breadcrumbs58588 = (function athens$devcards$breadcrumbs$__GT_t_athens$devcards$breadcrumbs58588(meta58589){
return (new athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58588(meta58589));
});

}

return (new athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58588(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
