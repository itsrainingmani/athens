...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50382_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__50382_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50381_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50381_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50383_SHARP_){
return (((p1__50383_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__50383_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__50386,mapping){
var map__50387 = p__50386;
var map__50387__$1 = (((((!((map__50387 == null))))?(((((map__50387.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__50387.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__50387):map__50387);
var state = map__50387__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50387__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50387__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50387__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50384_SHARP_){
if((p1__50384_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__50384_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__50436 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__50437 = clojure.zip.next(loc);
loc = G__50437;
continue;
}
}
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__50397){
var vec__50398 = p__50397;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50398,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq50395){
var G__50396 = cljs.core.first(seq50395);
var seq50395__$1 = cljs.core.next(seq50395);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50396,seq50395__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__50401_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50401_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__50403_50444 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__50404_50445 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__50405_50446 = true;
var _STAR_print_fn_STAR__temp_val__50406_50447 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__50405_50446);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__50406_50447);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__50404_50445);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__50403_50444);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__50402_SHARP_){
return debux.common.util.prepend_bars(p1__50402_SHARP_,indent_level);
...
if(cljs.core.truth_((function (){var fexpr__50409 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
...
if(cljs.core.truth_((function (){var fexpr__50410 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__50428 = quoted_form;
var G__50429 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__50428,G__50429) : debux.common.util.remove_d.call(null,G__50428,G__50429));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__50432 = quoted_form;
var G__50433 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__50432,G__50433) : debux.common.util.remove_d.call(null,G__50432,G__50433));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
