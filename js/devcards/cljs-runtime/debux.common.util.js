...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__51387_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__51387_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__51386_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__51386_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__51389_SHARP_){
return (((p1__51389_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__51389_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__51411,mapping){
...
var state = map__51412__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51412__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51412__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51412__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__51407_SHARP_){
if((p1__51407_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__51407_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__51454 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__51455 = clojure.zip.next(loc);
loc = G__51455;
continue;
}
}
...
var len__4789__auto___51458 = arguments.length;
var i__4790__auto___51459 = (0);
while(true){
if((i__4790__auto___51459 < len__4789__auto___51458)){
args__4795__auto__.push((arguments[i__4790__auto___51459]));

var G__51460 = (i__4790__auto___51459 + (1));
i__4790__auto___51459 = G__51460;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__51419){
var vec__51420 = p__51419;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51420,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq51417){
var G__51418 = cljs.core.first(seq51417);
var seq51417__$1 = cljs.core.next(seq51417);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51418,seq51417__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__51423_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__51423_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__51425_51461 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__51426_51462 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__51427_51463 = true;
var _STAR_print_fn_STAR__temp_val__51428_51464 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__51427_51463);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__51428_51464);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__51426_51462);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__51425_51461);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__51424_SHARP_){
return debux.common.util.prepend_bars(p1__51424_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__51465 = cljs.core.next(opts__$1);
var G__51466 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__51465;
acc = G__51466;
continue;
} else {
if(typeof f === 'string'){
var G__51467 = cljs.core.next(opts__$1);
var G__51468 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__51467;
acc = G__51468;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__51469 = cljs.core.nnext(opts__$1);
var G__51470 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__51469;
acc = G__51470;
continue;
} else {
...
var G__51472 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__51471;
acc = G__51472;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__51431 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__51431.cljs$core$IFn$_invoke$arity$1 ? fexpr__51431.cljs$core$IFn$_invoke$arity$1(f) : fexpr__51431.call(null,f));
})())){
var G__51473 = cljs.core.next(opts__$1);
var G__51474 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__51473;
acc = G__51474;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__51432 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__51432.cljs$core$IFn$_invoke$arity$1 ? fexpr__51432.cljs$core$IFn$_invoke$arity$1(f) : fexpr__51432.call(null,f));
})())){
var G__51475 = cljs.core.nnext(opts__$1);
var G__51476 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__51475;
acc = G__51476;
continue;
} else {
...
var G__51478 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__51477;
acc = G__51478;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__51433){
var vec__51434 = p__51433;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51434,(0),null);
...
var G__51439 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__51438 = (function (){var fexpr__51440 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten);
return (fexpr__51440.cljs$core$IFn$_invoke$arity$1 ? fexpr__51440.cljs$core$IFn$_invoke$arity$1(form) : fexpr__51440.call(null,form));
})();
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__51442 = quoted_form;
var G__51443 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__51442,G__51443) : debux.common.util.remove_d.call(null,G__51442,G__51443));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__51444 = quoted_form;
var G__51445 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__51444,G__51445) : debux.common.util.remove_d.call(null,G__51444,G__51445));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__51487__delegate = function (arg){
...
while (G__51488__i < G__51488__a.length) {G__51488__a[G__51488__i] = arguments[G__51488__i + 0]; ++G__51488__i;}
  arg = new cljs.core.IndexedSeq(G__51488__a,0,null);
} 
return G__51487__delegate.call(this,arg);};
G__51487.cljs$lang$maxFixedArity = 0;
G__51487.cljs$lang$applyTo = (function (arglist__51489){
var arg = cljs.core.seq(arglist__51489);
return G__51487__delegate(arg);
});
...
var G__51492 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__51492;
continue;
} else {
...
var G__51493 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__51493;
continue;
} else {
var G__51494 = clojure.zip.next(loc);
loc = G__51494;
continue;
