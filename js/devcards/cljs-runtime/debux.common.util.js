...
var G__46358 = cljs.core.next(opts__$1);
var G__46359 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__46358;
acc = G__46359;
continue;
} else {
...
G__46369.cljs$lang$applyTo = (function (arglist__46373){
var arg = cljs.core.seq(arglist__46373);
...
var G__46381 = clojure.zip.next(loc);
loc = G__46381;
continue;
