...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__51418_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__51418_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__51417_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__51417_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__51419_SHARP_){
return (((p1__51419_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__51419_SHARP_) == null)));
...
var len__4789__auto___51475 = arguments.length;
var i__4790__auto___51476 = (0);
while(true){
if((i__4790__auto___51476 < len__4789__auto___51475)){
args__4795__auto__.push((arguments[i__4790__auto___51476]));

var G__51477 = (i__4790__auto___51476 + (1));
i__4790__auto___51476 = G__51477;
continue;
} else {
}
break;
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq51434){
...
var _STAR_print_newline_STAR__orig_val__51444_51478 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__51445_51479 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__51446_51480 = true;
var _STAR_print_fn_STAR__temp_val__51447_51481 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__51446_51480);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__51447_51481);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__51445_51479);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__51444_51478);
}
...
var G__51483 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__51482;
acc = G__51483;
continue;
} else {
if(typeof f === 'string'){
var G__51484 = cljs.core.next(opts__$1);
var G__51485 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__51484;
acc = G__51485;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__51486 = cljs.core.nnext(opts__$1);
var G__51487 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__51486;
acc = G__51487;
continue;
} else {
...
var G__51489 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__51488;
acc = G__51489;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__51451 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__51451.cljs$core$IFn$_invoke$arity$1 ? fexpr__51451.cljs$core$IFn$_invoke$arity$1(f) : fexpr__51451.call(null,f));
})())){
var G__51490 = cljs.core.next(opts__$1);
var G__51491 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__51490;
acc = G__51491;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__51452 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__51452.cljs$core$IFn$_invoke$arity$1 ? fexpr__51452.cljs$core$IFn$_invoke$arity$1(f) : fexpr__51452.call(null,f));
})())){
var G__51492 = cljs.core.nnext(opts__$1);
var G__51493 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__51492;
acc = G__51493;
continue;
} else {
...
var G__51495 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__51494;
acc = G__51495;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__51453){
var vec__51454 = p__51453;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51454,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51454,(1),null);
...
var G__51459 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__51458 = (function (){var fexpr__51460 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten);
return (fexpr__51460.cljs$core$IFn$_invoke$arity$1 ? fexpr__51460.cljs$core$IFn$_invoke$arity$1(form) : fexpr__51460.call(null,form));
})();
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__51462 = quoted_form;
var G__51463 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__51462,G__51463) : debux.common.util.remove_d.call(null,G__51462,G__51463));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__51464 = quoted_form;
var G__51465 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__51464,G__51465) : debux.common.util.remove_d.call(null,G__51464,G__51465));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__51496__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__51466 = quoted_form;
var G__51467 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__51466,G__51467) : debux.common.util.remove_d.call(null,G__51466,G__51467));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
var G__51501 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__51501;
continue;
} else {
var G__51502 = clojure.zip.next(loc);
loc = G__51502;
continue;
