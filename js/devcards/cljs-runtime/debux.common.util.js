...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__51346_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__51346_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__51345_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__51345_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__51347_SHARP_){
return (((p1__51347_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__51347_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__51375,mapping){
...
var state = map__51376__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51376__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51376__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51376__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__51366_SHARP_){
if((p1__51366_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__51366_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__51451 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__51452 = clojure.zip.next(loc);
loc = G__51452;
continue;
}
}
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__51395){
var vec__51396 = p__51395;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51396,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq51389){
var G__51390 = cljs.core.first(seq51389);
var seq51389__$1 = cljs.core.next(seq51389);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51390,seq51389__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__51399_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__51399_SHARP_)].join('');
}),lines);
});
