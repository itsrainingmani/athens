...
var G__46070 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__46069;
acc = G__46070;
continue;
} else {
...
var G__46073 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__46072;
acc = G__46073;
continue;
} else {
...
var G__46089 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__46088;
acc = G__46089;
continue;
} else {
...
return (function() { 
var G__46098__delegate = function (arg){
...
return G__46098__delegate.call(this,arg);};
G__46098.cljs$lang$maxFixedArity = 0;
G__46098.cljs$lang$applyTo = (function (arglist__46102){
var arg = cljs.core.seq(arglist__46102);
return G__46098__delegate(arg);
});
...
var G__46107 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__46107;
continue;
} else {
