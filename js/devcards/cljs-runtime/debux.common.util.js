...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__51683_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__51683_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__51682_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__51682_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__51684_SHARP_){
return (((p1__51684_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__51684_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__51687,mapping){
...
var state = map__51688__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51688__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51688__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51688__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__51685_SHARP_){
if((p1__51685_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__51685_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__51738 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__51740 = clojure.zip.next(loc);
loc = G__51740;
continue;
}
}
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__51701){
var vec__51702 = p__51701;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51702,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq51697){
var G__51698 = cljs.core.first(seq51697);
var seq51697__$1 = cljs.core.next(seq51697);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51698,seq51697__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__51705_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__51705_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__51707_51746 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__51708_51747 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__51709_51748 = true;
var _STAR_print_fn_STAR__temp_val__51710_51749 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__51709_51748);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__51710_51749);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__51708_51747);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__51707_51746);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__51706_SHARP_){
return debux.common.util.prepend_bars(p1__51706_SHARP_,indent_level);
...
var G__51751 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__51750;
acc = G__51751;
continue;
} else {
if(typeof f === 'string'){
var G__51752 = cljs.core.next(opts__$1);
var G__51753 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__51752;
acc = G__51753;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__51754 = cljs.core.nnext(opts__$1);
var G__51755 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__51754;
acc = G__51755;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__51756 = cljs.core.next(opts__$1);
var G__51757 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__51756;
acc = G__51757;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__51713 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__51713.cljs$core$IFn$_invoke$arity$1 ? fexpr__51713.cljs$core$IFn$_invoke$arity$1(f) : fexpr__51713.call(null,f));
})())){
var G__51758 = cljs.core.next(opts__$1);
var G__51759 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__51758;
acc = G__51759;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__51714 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__51714.cljs$core$IFn$_invoke$arity$1 ? fexpr__51714.cljs$core$IFn$_invoke$arity$1(f) : fexpr__51714.call(null,f));
})())){
var G__51760 = cljs.core.nnext(opts__$1);
var G__51761 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__51760;
acc = G__51761;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__51762 = cljs.core.next(opts__$1);
var G__51763 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__51762;
acc = G__51763;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__51715){
...
var G__51721 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__51720 = (function (){var fexpr__51722 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten);
return (fexpr__51722.cljs$core$IFn$_invoke$arity$1 ? fexpr__51722.cljs$core$IFn$_invoke$arity$1(form) : fexpr__51722.call(null,form));
})();
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__51724 = quoted_form;
var G__51725 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__51724,G__51725) : debux.common.util.remove_d.call(null,G__51724,G__51725));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__51727 = quoted_form;
var G__51728 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__51727,G__51728) : debux.common.util.remove_d.call(null,G__51727,G__51728));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__51764__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__51730 = quoted_form;
var G__51731 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__51730,G__51731) : debux.common.util.remove_d.call(null,G__51730,G__51731));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
while (G__51765__i < G__51765__a.length) {G__51765__a[G__51765__i] = arguments[G__51765__i + 0]; ++G__51765__i;}
  arg = new cljs.core.IndexedSeq(G__51765__a,0,null);
} 
return G__51764__delegate.call(this,arg);};
G__51764.cljs$lang$maxFixedArity = 0;
G__51764.cljs$lang$applyTo = (function (arglist__51766){
var arg = cljs.core.seq(arglist__51766);
return G__51764__delegate(arg);
});
...
var G__51767 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__51767;
continue;
} else {
...
var G__51768 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__51768;
continue;
} else {
var G__51769 = clojure.zip.next(loc);
loc = G__51769;
continue;
