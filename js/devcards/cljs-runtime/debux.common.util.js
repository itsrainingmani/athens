...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50395_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__50395_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50394_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50394_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50396_SHARP_){
return (((p1__50396_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__50396_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__50401,mapping){
...
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50402__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50402__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50402__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50399_SHARP_){
if((p1__50399_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__50399_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var len__4736__auto___50450 = arguments.length;
var i__4737__auto___50451 = (0);
while(true){
if((i__4737__auto___50451 < len__4736__auto___50450)){
args__4742__auto__.push((arguments[i__4737__auto___50451]));

var G__50452 = (i__4737__auto___50451 + (1));
i__4737__auto___50451 = G__50452;
continue;
} else {
}
break;
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq50406){
var G__50407 = cljs.core.first(seq50406);
var seq50406__$1 = cljs.core.next(seq50406);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50407,seq50406__$1);
}));
...
var _STAR_print_newline_STAR__orig_val__50415_50453 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__50416_50454 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__50417_50455 = true;
var _STAR_print_fn_STAR__temp_val__50418_50456 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__50417_50455);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__50418_50456);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__50416_50454);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__50415_50453);
}
...
var G__50458 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__50457;
acc = G__50458;
continue;
} else {
...
var G__50460 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__50459;
acc = G__50460;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__50462 = cljs.core.nnext(opts__$1);
var G__50463 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__50462;
acc = G__50463;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__50464 = cljs.core.next(opts__$1);
var G__50465 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__50464;
acc = G__50465;
continue;
} else {
...
var G__50467 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__50466;
acc = G__50467;
continue;
} else {
...
var G__50468 = cljs.core.nnext(opts__$1);
var G__50469 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__50468;
acc = G__50469;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__50470 = cljs.core.next(opts__$1);
var G__50471 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__50470;
acc = G__50471;
continue;
} else {
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__50435 = quoted_form;
var G__50436 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__50435,G__50436) : debux.common.util.remove_d.call(null,G__50435,G__50436));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
var G__50479 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__50479;
continue;
} else {
var G__50481 = clojure.zip.next(loc);
loc = G__50481;
continue;
