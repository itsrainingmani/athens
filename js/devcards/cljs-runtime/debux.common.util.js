...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50379_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__50379_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50378_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50378_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50381_SHARP_){
return (((p1__50381_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__50381_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__50384,mapping){
...
var state = map__50385__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50385__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50385__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50385__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50382_SHARP_){
if((p1__50382_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__50382_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
args__4742__auto__.push((arguments[i__4737__auto___50440]));
...
var _STAR_print_newline_STAR__orig_val__50398_50442 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__50399_50443 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__50400_50444 = true;
var _STAR_print_fn_STAR__temp_val__50401_50445 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__50400_50444);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__50401_50445);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__50399_50443);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__50398_50442);
}
...
var G__50447 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__50446;
acc = G__50447;
continue;
} else {
...
var G__50449 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__50448;
acc = G__50449;
continue;
} else {
...
var G__50451 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__50450;
acc = G__50451;
continue;
} else {
...
var G__50453 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__50452;
acc = G__50453;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__50407 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__50407.cljs$core$IFn$_invoke$arity$1 ? fexpr__50407.cljs$core$IFn$_invoke$arity$1(f) : fexpr__50407.call(null,f));
})())){
var G__50454 = cljs.core.next(opts__$1);
var G__50455 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__50454;
acc = G__50455;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__50408 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
...
var G__50458 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__50457;
acc = G__50458;
continue;
} else {
...
var G__50460 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__50459;
acc = G__50460;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__50411){
var vec__50412 = p__50411;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50412,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50412,(1),null);
...
var G__50416 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__50415 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__50418 = quoted_form;
var G__50419 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__50418,G__50419) : debux.common.util.remove_d.call(null,G__50418,G__50419));
...
return (function() { 
var G__50461__delegate = function (arg){
...
var G__50461 = function (var_args){
var arg = null;
...
while (G__50462__i < G__50462__a.length) {G__50462__a[G__50462__i] = arguments[G__50462__i + 0]; ++G__50462__i;}
  arg = new cljs.core.IndexedSeq(G__50462__a,0,null);
} 
return G__50461__delegate.call(this,arg);};
G__50461.cljs$lang$maxFixedArity = 0;
G__50461.cljs$lang$applyTo = (function (arglist__50463){
var arg = cljs.core.seq(arglist__50463);
return G__50461__delegate(arg);
});
...
var G__50464 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__50464;
continue;
} else {
...
var G__50465 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__50465;
continue;
} else {
var G__50466 = clojure.zip.next(loc);
loc = G__50466;
continue;
