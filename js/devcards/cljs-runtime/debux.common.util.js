...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__67692_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__67692_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__67691_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__67691_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__67693_SHARP_){
return (((p1__67693_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__67693_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__67696,mapping){
...
var state = map__67697__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67697__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67697__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67697__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__67694_SHARP_){
if((p1__67694_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__67694_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__67741 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__67742 = clojure.zip.next(loc);
loc = G__67742;
continue;
}
}
...
var len__4789__auto___67745 = arguments.length;
var i__4790__auto___67746 = (0);
while(true){
if((i__4790__auto___67746 < len__4789__auto___67745)){
args__4795__auto__.push((arguments[i__4790__auto___67746]));

var G__67747 = (i__4790__auto___67746 + (1));
i__4790__auto___67746 = G__67747;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__67702){
var vec__67703 = p__67702;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67703,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq67700){
var G__67701 = cljs.core.first(seq67700);
var seq67700__$1 = cljs.core.next(seq67700);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__67701,seq67700__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__67706_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__67706_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__67708_67748 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__67709_67749 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__67710_67750 = true;
var _STAR_print_fn_STAR__temp_val__67711_67751 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__67710_67750);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__67711_67751);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__67709_67749);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__67708_67748);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__67707_SHARP_){
return debux.common.util.prepend_bars(p1__67707_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__67752 = cljs.core.next(opts__$1);
var G__67753 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__67752;
acc = G__67753;
continue;
} else {
if(typeof f === 'string'){
var G__67754 = cljs.core.next(opts__$1);
var G__67755 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__67754;
acc = G__67755;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__67756 = cljs.core.nnext(opts__$1);
var G__67757 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__67756;
acc = G__67757;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__67758 = cljs.core.next(opts__$1);
var G__67759 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__67758;
acc = G__67759;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__67714 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__67714.cljs$core$IFn$_invoke$arity$1 ? fexpr__67714.cljs$core$IFn$_invoke$arity$1(f) : fexpr__67714.call(null,f));
})())){
var G__67760 = cljs.core.next(opts__$1);
var G__67761 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__67760;
acc = G__67761;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__67715 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__67715.cljs$core$IFn$_invoke$arity$1 ? fexpr__67715.cljs$core$IFn$_invoke$arity$1(f) : fexpr__67715.call(null,f));
})())){
var G__67762 = cljs.core.nnext(opts__$1);
var G__67763 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__67762;
acc = G__67763;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__67764 = cljs.core.next(opts__$1);
var G__67765 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__67764;
acc = G__67765;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__67716){
var vec__67717 = p__67716;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67717,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67717,(1),null);
...
var G__67722 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__67721 = (function (){var fexpr__67723 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten);
return (fexpr__67723.cljs$core$IFn$_invoke$arity$1 ? fexpr__67723.cljs$core$IFn$_invoke$arity$1(form) : fexpr__67723.call(null,form));
})();
return (fexpr__67721.cljs$core$IFn$_invoke$arity$1 ? fexpr__67721.cljs$core$IFn$_invoke$arity$1(G__67722) : fexpr__67721.call(null,G__67722));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__67725 = quoted_form;
var G__67726 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__67725,G__67726) : debux.common.util.remove_d.call(null,G__67725,G__67726));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__67727 = quoted_form;
var G__67728 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__67727,G__67728) : debux.common.util.remove_d.call(null,G__67727,G__67728));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__67773__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__67729 = quoted_form;
var G__67730 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__67729,G__67730) : debux.common.util.remove_d.call(null,G__67729,G__67730));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));

return result;
};
var G__67773 = function (var_args){
var arg = null;
if (arguments.length > 0) {
var G__67774__i = 0, G__67774__a = new Array(arguments.length -  0);
while (G__67774__i < G__67774__a.length) {G__67774__a[G__67774__i] = arguments[G__67774__i + 0]; ++G__67774__i;}
  arg = new cljs.core.IndexedSeq(G__67774__a,0,null);
} 
return G__67773__delegate.call(this,arg);};
G__67773.cljs$lang$maxFixedArity = 0;
G__67773.cljs$lang$applyTo = (function (arglist__67775){
var arg = cljs.core.seq(arglist__67775);
return G__67773__delegate(arg);
});
G__67773.cljs$core$IFn$_invoke$arity$variadic = G__67773__delegate;
return G__67773;
})()
;
});
...
var G__67776 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__67776;
continue;
} else {
...
var G__67777 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__67777;
continue;
} else {
var G__67778 = clojure.zip.next(loc);
loc = G__67778;
continue;
