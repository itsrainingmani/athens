...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50333_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__50333_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50332_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50332_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50334_SHARP_){
return (((p1__50334_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__50334_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__50349,mapping){
...
var state = map__50350__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50350__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50350__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50350__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50347_SHARP_){
if((p1__50347_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__50347_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__50359){
var vec__50360 = p__50359;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50360,(0),null);
...
if(cljs.core.truth_((function (){var fexpr__50386 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__50386.cljs$core$IFn$_invoke$arity$1 ? fexpr__50386.cljs$core$IFn$_invoke$arity$1(f) : fexpr__50386.call(null,f));
})())){
...
if(cljs.core.truth_((function (){var fexpr__50387 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__50387.cljs$core$IFn$_invoke$arity$1 ? fexpr__50387.cljs$core$IFn$_invoke$arity$1(f) : fexpr__50387.call(null,f));
})())){
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__50393){
...
var G__50400 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__50399 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__50402 = quoted_form;
var G__50403 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__50402,G__50403) : debux.common.util.remove_d.call(null,G__50402,G__50403));
