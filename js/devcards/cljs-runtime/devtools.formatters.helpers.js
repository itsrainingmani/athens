...
var G__42690 = devtools.prefs.pref(v);
v = G__42690;
continue;
} else {
return v;
...
}catch (e42652){var _e__40241__auto__ = e42652;
return false;
}})();
...
}catch (e42656){var _e__40241__auto__ = e42656;
return false;
}})();
...
}catch (e42658){var _e__40241__auto__ = e42658;
return false;
}}
}
});
...
var vec__42665 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42665,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42665,(1),null);
...
return cljs.core.some((function (p1__42674_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__42674_SHARP_);
}),template);
});
