...
var G__56364 = new cljs.core.Keyword(null,"reduction-type","reduction-type",-488293450).cljs$core$IFn$_invoke$arity$1(f);
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$reduction$iter__56367(s__56368){
return (new cljs.core.LazySeq(null,(function (){
var s__56368__$1 = s__56368;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__56368__$1);
if(temp__5735__auto__){
var s__56368__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__56368__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__56368__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__56370 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__56369 = (0);
while(true){
if((i__56369 < size__4581__auto__)){
var vec__56371 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__56369);
...
cljs.core.chunk_append(b__56370,(cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)));

var G__56380 = (i__56369 + (1));
i__56369 = G__56380;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__56370),instaparse$reduction$iter__56367(cljs.core.chunk_rest(s__56368__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__56370),null);
}
} else {
var vec__56374 = cljs.core.first(s__56368__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56374,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56374,(1),null);
return cljs.core.cons((cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)),instaparse$reduction$iter__56367(cljs.core.rest(s__56368__$2)));
}
} else {
return null;
}
