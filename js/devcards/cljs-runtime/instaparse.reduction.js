...
var G__55076 = new cljs.core.Keyword(null,"reduction-type","reduction-type",-488293450).cljs$core$IFn$_invoke$arity$1(f);
var G__55076__$1 = (((G__55076 instanceof cljs.core.Keyword))?G__55076.fqn:null);
switch (G__55076__$1) {
case "raw":
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4529__auto__ = (function instaparse$reduction$iter__55079(s__55080){
return (new cljs.core.LazySeq(null,(function (){
var s__55080__$1 = s__55080;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__55080__$1);
if(temp__5735__auto__){
var s__55080__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__55080__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__55080__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__55082 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__55081 = (0);
while(true){
if((i__55081 < size__4528__auto__)){
var vec__55083 = cljs.core._nth(c__4527__auto__,i__55081);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55083,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55083,(1),null);
cljs.core.chunk_append(b__55082,(cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)));

var G__55091 = (i__55081 + (1));
i__55081 = G__55091;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__55082),instaparse$reduction$iter__55079(cljs.core.chunk_rest(s__55080__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__55082),null);
}
} else {
var vec__55086 = cljs.core.first(s__55080__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55086,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55086,(1),null);
return cljs.core.cons((cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)),instaparse$reduction$iter__55079(cljs.core.rest(s__55080__$2)));
}
} else {
return null;
}
