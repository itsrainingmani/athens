...
var ref_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24031,(0),null);
var ref_pull = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24031,(1),null);
...
posh.lib.pull_analyze.pull_analyze = (function posh$lib$pull_analyze$pull_analyze(dcfg,retrieve,p__24051,pull_pattern,ent_id){
var map__24055 = p__24051;
...
var affected_datoms = posh.lib.pull_analyze.pull_affected_datoms(new cljs.core.Keyword(null,"pull","pull",-860544805).cljs$core$IFn$_invoke$arity$1(dcfg),db,pull_pattern,(function (){var fexpr__24067 = new cljs.core.Keyword(null,"entid","entid",1720688982).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__24067.cljs$core$IFn$_invoke$arity$2 ? fexpr__24067.cljs$core$IFn$_invoke$arity$2(db,ent_id) : fexpr__24067.call(null,db,ent_id));
})());
...
posh.lib.pull_analyze.pull_many_analyze = (function posh$lib$pull_analyze$pull_many_analyze(dcfg,retrieve,p__24085,pull_pattern,ent_ids){
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24088__$1,new cljs.core.Keyword(null,"db","db",993250759));
var schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24088__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
var db_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24088__$1,new cljs.core.Keyword(null,"db-id","db-id",747248515));
if(cljs.core.empty_QMARK_(retrieve)){
return null;
} else {
var resolved_ent_ids = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__24079_SHARP_){
var fexpr__24100 = new cljs.core.Keyword(null,"entid","entid",1720688982).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__24100.cljs$core$IFn$_invoke$arity$2 ? fexpr__24100.cljs$core$IFn$_invoke$arity$2(db,p1__24079_SHARP_) : fexpr__24100.call(null,db,p1__24079_SHARP_));
}),ent_ids);
