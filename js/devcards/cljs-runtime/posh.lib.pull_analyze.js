...
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([v], 0)):new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [entity_id,k__$1,v], null)], null)),(function (){var G__29372 = schema;
var G__29373 = entity_id;
var G__29374 = cljs.core.rest(pull_map);
return (posh.lib.pull_analyze.tx_datoms_for_pull_map.cljs$core$IFn$_invoke$arity$3 ? posh.lib.pull_analyze.tx_datoms_for_pull_map.cljs$core$IFn$_invoke$arity$3(G__29372,G__29373,G__29374) : posh.lib.pull_analyze.tx_datoms_for_pull_map.call(null,G__29372,G__29373,G__29374));
})());
...
var entity_keys = cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__29405_SHARP_){
return ((cljs.core.map_QMARK_(p1__29405_SHARP_)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("db","id","db/id",-1388397098),p1__29405_SHARP_)));
}),pull_pattern);
var val_keys = cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__29407_SHARP_){
return ((posh.lib.pull_analyze.reverse_lookup_QMARK_(p1__29407_SHARP_)) || (posh.lib.pull_analyze.ref_QMARK_(schema,p1__29407_SHARP_)));
}),entity_keys);
