...
var vec__79257 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79257,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79257,(1),null);
...
var vec__79260 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79260,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79260,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__79263 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79263,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79263,(1),null);
...
var G__79330 = cljs.core.next(parses__$1);
parses__$1 = G__79330;
continue;
}
...
var G__79271 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__79272 = G__79271;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79272,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79272,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79272,(2),null);
var selection = vec__79272;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__79271__$1 = G__79271;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__79278 = G__79271__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79278,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79278,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79278,(2),null);
var selection__$1 = vec__79278;
...
var G__79336 = cljs.core.long$(end__$1);
var G__79337 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__79338 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__79336;
parses__$1 = G__79337;
G__79271__$1 = G__79338;
continue;
...
var G__79286 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__79287 = G__79286;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79287,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79287,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79287,(2),null);
var selection = vec__79287;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__79286__$1 = G__79286;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__79293 = G__79286__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79293,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79293,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79293,(2),null);
var selection__$1 = vec__79293;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__79340 = cljs.core.long$(end__$1);
var G__79341 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__79342 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__79340;
parses__$1 = G__79341;
G__79286__$1 = G__79342;
continue;
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__79301 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__79302 = G__79301;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79302,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79302,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79302,(2),null);
var selection = vec__79302;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__79301__$1 = G__79301;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__79308 = G__79301__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79308,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79308,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79308,(2),null);
var selection__$1 = vec__79308;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__79345 = cljs.core.long$(end__$1);
var G__79346 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__79347 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__79345;
parses__$1 = G__79346;
G__79301__$1 = G__79347;
continue;
...
if(cljs.core.truth_((function (){var fexpr__79313 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__79313.cljs$core$IFn$_invoke$arity$1 ? fexpr__79313.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__79313.call(null,output_format));
})())){
} else {
...
var G__79314 = output_format;
var G__79314__$1 = (((G__79314 instanceof cljs.core.Keyword))?G__79314.fqn:null);
switch (G__79314__$1) {
case "enlive":
...
if(cljs.core.not(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207)))?(function (){var and__4174__auto__ = (function (){var G__79322 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__79321 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__79321.cljs$core$IFn$_invoke$arity$1 ? fexpr__79321.cljs$core$IFn$_invoke$arity$1(G__79322) : fexpr__79321.call(null,G__79322));
})();
