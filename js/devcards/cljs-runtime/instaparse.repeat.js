...
var vec__56471 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56471,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56471,(1),null);
...
var vec__56474 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56474,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56474,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__56477 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56477,(0),null);
...
var G__56538 = cljs.core.next(parses__$1);
parses__$1 = G__56538;
continue;
}
...
var G__56485 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__56486 = G__56485;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56486,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56486,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56486,(2),null);
var selection = vec__56486;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__56485__$1 = G__56485;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__56492 = G__56485__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56492,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56492,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56492,(2),null);
var selection__$1 = vec__56492;
...
var G__56540 = cljs.core.long$(end__$1);
var G__56541 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__56542 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__56540;
parses__$1 = G__56541;
G__56485__$1 = G__56542;
continue;
...
var G__56500 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__56501 = G__56500;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56501,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56501,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56501,(2),null);
var selection = vec__56501;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__56500__$1 = G__56500;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__56507 = G__56500__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56507,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56507,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56507,(2),null);
var selection__$1 = vec__56507;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__56544 = cljs.core.long$(end__$1);
var G__56545 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__56546 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__56544;
parses__$1 = G__56545;
G__56500__$1 = G__56546;
continue;
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__56515 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__56516 = G__56515;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56516,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56516,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56516,(2),null);
var selection = vec__56516;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__56515__$1 = G__56515;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__56522 = G__56515__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56522,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56522,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56522,(2),null);
var selection__$1 = vec__56522;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__56548 = cljs.core.long$(end__$1);
var G__56549 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__56550 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__56548;
parses__$1 = G__56549;
G__56515__$1 = G__56550;
continue;
...
if(cljs.core.truth_((function (){var fexpr__56527 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__56527.cljs$core$IFn$_invoke$arity$1 ? fexpr__56527.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__56527.call(null,output_format));
})())){
} else {
...
var G__56528 = output_format;
var G__56528__$1 = (((G__56528 instanceof cljs.core.Keyword))?G__56528.fqn:null);
switch (G__56528__$1) {
case "enlive":
...
if(cljs.core.not(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207)))?(function (){var and__4115__auto__ = (function (){var G__56536 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__56535 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__56535.cljs$core$IFn$_invoke$arity$1 ? fexpr__56535.cljs$core$IFn$_invoke$arity$1(G__56536) : fexpr__56535.call(null,G__56536));
})();
