...
var vec__39327 = ((cljs.core.map_QMARK_(credentials))?cljs.core.map.cljs$core$IFn$_invoke$arity$2(credentials,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"username","username",1605666410),new cljs.core.Keyword(null,"password","password",417022471)], null)):credentials);
var username = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39327,(0),null);
var password = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39327,(1),null);
 ...
 */
cljs_http.util.build_url = (function cljs_http$util$build_url(p__39330){
...
var scheme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39331__$1,new cljs.core.Keyword(null,"scheme","scheme",90199613));
var server_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39331__$1,new cljs.core.Keyword(null,"server-name","server-name",-1012104295));
var server_port = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39331__$1,new cljs.core.Keyword(null,"server-port","server-port",663745648));
var uri = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39331__$1,new cljs.core.Keyword(null,"uri","uri",-774711847));
var query_string = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39331__$1,new cljs.core.Keyword(null,"query-string","query-string",-1018845061));
return cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__39337 = (new goog.Uri());
G__39337.setScheme(cljs.core.name((function (){var or__4185__auto__ = scheme;
...
G__39337.setDomain(server_name);

G__39337.setPort(server_port);

G__39337.setPath(uri);

G__39337.setQuery(query_string,true);
