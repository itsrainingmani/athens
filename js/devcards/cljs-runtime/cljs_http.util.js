...
var vec__46726 = ((cljs.core.map_QMARK_(credentials))?cljs.core.map.cljs$core$IFn$_invoke$arity$2(credentials,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"username","username",1605666410),new cljs.core.Keyword(null,"password","password",417022471)], null)):credentials);
var username = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46726,(0),null);
var password = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46726,(1),null);
 ...
 */
cljs_http.util.build_url = (function cljs_http$util$build_url(p__46729){
...
var scheme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46730__$1,new cljs.core.Keyword(null,"scheme","scheme",90199613));
var server_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46730__$1,new cljs.core.Keyword(null,"server-name","server-name",-1012104295));
var server_port = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46730__$1,new cljs.core.Keyword(null,"server-port","server-port",663745648));
var uri = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46730__$1,new cljs.core.Keyword(null,"uri","uri",-774711847));
var query_string = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46730__$1,new cljs.core.Keyword(null,"query-string","query-string",-1018845061));
return cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__46733 = (new goog.Uri());
G__46733.setScheme(cljs.core.name((function (){var or__4185__auto__ = scheme;
...
G__46733.setDomain(server_name);

G__46733.setPort(server_port);

G__46733.setPath(uri);

G__46733.setQuery(query_string,true);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__46735_SHARP_,p2__46734_SHARP_){
var vec__46736 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(p2__46734_SHARP_,/:\s+/);
...
return p1__46735_SHARP_;
} else {
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__46735_SHARP_,clojure.string.lower_case(k),v);
}
