...
posh.lib.update.update_pull = (function posh$lib$update$update_pull(p__57427,storage_key){
...
var posh_tree = map__57428__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57428__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57428__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));
var vec__57430 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57430,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57430,(1),null);
var pull_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57430,(2),null);
var eid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57430,(3),null);
...
posh.lib.update.update_filter_pull = (function posh$lib$update$update_filter_pull(p__57433,storage_key){
...
var posh_tree = map__57434__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57434__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57434__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));
var vec__57436 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57436,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57436,(1),null);
var pull_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57436,(2),null);
var eid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57436,(3),null);
...
posh.lib.update.update_pull_many = (function posh$lib$update$update_pull_many(p__57439,storage_key){
...
var posh_tree = map__57440__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57440__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57440__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));
var vec__57442 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57442,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57442,(1),null);
var pull_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57442,(2),null);
var eids = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57442,(3),null);
...
posh.lib.update.update_q_with_dbvarmap = (function posh$lib$update$update_q_with_dbvarmap(p__57445,storage_key){
...
var posh_tree = map__57446__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57446__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57446__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));

var vec__57448 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57448,(0),null);
var query = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57448,(1),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57448,(2),null);
...
var poshdbmap = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.merge,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__57451){
var vec__57452 = p__57451;
var db_sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57452,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57452,(1),null);
return cljs.core.PersistentArrayMap.createAsIfByAssoc([db_sym,posh.lib.db.poshdb__GT_analyze_db(posh_tree,poshdb)]);
}),dbvarmap));
var fixed_args = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__57455){
var vec__57456 = p__57455;
var sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57456,(0),null);
var arg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57456,(1),null);
...
var G__57459 = cljs.core.first(storage_key);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57459__$1)].join('')));
