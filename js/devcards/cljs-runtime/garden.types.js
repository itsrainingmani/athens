...
var G__32881 = expr__32874;
return (pred__32873.cljs$core$IFn$_invoke$arity$2 ? pred__32873.cljs$core$IFn$_invoke$arity$2(G__32880,G__32881) : pred__32873.call(null,G__32880,G__32881));
})())){
...
var extmap__4478__auto__ = (function (){var G__32882 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__32866,new cljs.core.Keyword(null,"unit","unit",375175175),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"magnitude","magnitude",1924274222)], 0));
...
(garden.types.CSSFunction.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k32885,else__4442__auto__){
var self__ = this;
var this__4441__auto____$1 = this;
var G__32891 = k32885;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k32885,else__4442__auto__);
...
(garden.types.CSSFunction.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__32884){
var self__ = this;
var G__32884__$1 = this;
return (new cljs.core.RecordIter((0),G__32884__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"f","f",-1597136552),new cljs.core.Keyword(null,"args","args",1315556576)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(garden.types.CSSFunction.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this32886,other32887){
var self__ = this;
var this32886__$1 = this;
return (((!((other32887 == null)))) && ((this32886__$1.constructor === other32887.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this32886__$1.f,other32887.f)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this32886__$1.args,other32887.args)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this32886__$1.__extmap,other32887.__extmap)));
}));
...
(garden.types.CSSFunction.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__32884){
var self__ = this;
var this__4446__auto____$1 = this;
...
return (new garden.types.CSSFunction(G__32884,self__.args,self__.__meta,self__.__extmap,null));
} else {
...
return (new garden.types.CSSFunction(self__.f,G__32884,self__.__meta,self__.__extmap,null));
} else {
return (new garden.types.CSSFunction(self__.f,self__.args,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__32884),null));
}
}
}));
...
(garden.types.CSSFunction.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__32884){
var self__ = this;
var this__4438__auto____$1 = this;
return (new garden.types.CSSFunction(self__.f,self__.args,G__32884,self__.__extmap,self__.__hash));
}));
 ...
 */
garden.types.map__GT_CSSFunction = (function garden$types$map__GT_CSSFunction(G__32888){
var extmap__4478__auto__ = (function (){var G__32904 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__32888,new cljs.core.Keyword(null,"f","f",-1597136552),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"args","args",1315556576)], 0));
if(cljs.core.record_QMARK_(G__32888)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__32904);
} else {
return G__32904;
}
})();
return (new garden.types.CSSFunction(new cljs.core.Keyword(null,"f","f",-1597136552).cljs$core$IFn$_invoke$arity$1(G__32888),new cljs.core.Keyword(null,"args","args",1315556576).cljs$core$IFn$_invoke$arity$1(G__32888),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
