...
var G__59268 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(vals,next_val);
vals = G__59268;
continue;
...
if(("\\" === ch)){
var ch_59269__$1 = reader.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
if((ch_59269__$1 == null)){
edamame.impl.parser.throw_reader.cljs$core$IFn$_invoke$arity$2(reader,"Error while parsing regex");
} else {
}

sb.append(ch_59269__$1);
} else {
}

var G__59270 = reader.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__59270;
continue;
}
}
