...
var datascript$db$IIndexAccess$_seek_datoms$dyn_27872 = (function (db,index,components){
var x__4428__auto__ = (((db == null))?null:db);
...
return datascript$db$IIndexAccess$_seek_datoms$dyn_27872(db,index,components);
}
});
