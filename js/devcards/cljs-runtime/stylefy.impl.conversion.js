 ...
 */
stylefy.impl.conversion.convert_manual_styles = (function stylefy$impl$conversion$convert_manual_styles(p__34624,options){
...
var manual_selector_and_css_props = clojure.walk.walk((function (p1__34623_SHARP_){
if(cljs.core.map_QMARK_(p1__34623_SHARP_)){
return stylefy.impl.utils.remove_special_keywords(p1__34623_SHARP_);
} else {
return p1__34623_SHARP_;
}
