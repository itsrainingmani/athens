...
var fexpr__52801 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__52801.cljs$core$IFn$_invoke$arity$1 ? fexpr__52801.cljs$core$IFn$_invoke$arity$1(type) : fexpr__52801.call(null,type));
});
...
var G__52825 = cljs.spec.alpha.form(cljs.spec.alpha.get_spec(x));
x = G__52825;
continue;
} else {
if((x instanceof cljs.core.Symbol)){
var G__52802 = spec_tools.impl.normalize_symbol(x);
var G__52803 = null;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__52802,G__52803) : spec_tools.parse.parse_form.call(null,G__52802,G__52803));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__52804 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__52805 = x;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__52804,G__52805) : spec_tools.parse.parse_form.call(null,G__52804,G__52805));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__52826 = cljs.spec.alpha.form(x);
x = G__52826;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__52806 = (spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1 ? spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x) : spec_tools.form.resolve_form.call(null,x));
var G__52807 = null;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__52806,G__52807) : spec_tools.parse.parse_form.call(null,G__52806,G__52807));
} else {
...
var G__52808 = parse_data;
var G__52808__$1 = (((G__52808 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__52808));
var G__52808__$2 = (((G__52808__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__52808__$1));
var G__52808__$3 = (((G__52808__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__52808__$2));
var G__52808__$4 = (((G__52808__$3 == null))?null:cljs.core.seq(G__52808__$3));
if((G__52808__$4 == null)){
return null;
} else {
return cljs.core.set(G__52808__$4);
}
}
});
...
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.parse","default","spec-tools.parse/default",-1184283850)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__52809 = cljs.core.get_global_hierarchy;
return (fexpr__52809.cljs$core$IFn$_invoke$arity$0 ? fexpr__52809.cljs$core$IFn$_invoke$arity$0() : fexpr__52809.call(null));
})());
...
var map__52810 = spec_tools.impl.parse_keys(form);
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52810__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52810__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52810__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52810__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52810__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__52812 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__52812__$1 = (cljs.core.truth_((function (){var or__4185__auto__ = req;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52812,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__52812);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52812__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__52812__$1;
}
}));
...
var map__52815 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
...
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52815__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__52817){
var vec__52818 = p__52817;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52818,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52818,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52818,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__52821){
...
var ___$1 = first__52824;
var values = seq__52823__$1;
