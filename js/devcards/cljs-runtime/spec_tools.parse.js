...
var fexpr__69229 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__69229.cljs$core$IFn$_invoke$arity$1 ? fexpr__69229.cljs$core$IFn$_invoke$arity$1(type) : fexpr__69229.call(null,type));
});
...
var G__69257 = cljs.spec.alpha.form(cljs.spec.alpha.get_spec(x));
x = G__69257;
continue;
} else {
if((x instanceof cljs.core.Symbol)){
var G__69230 = spec_tools.impl.normalize_symbol(x);
var G__69231 = null;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__69230,G__69231) : spec_tools.parse.parse_form.call(null,G__69230,G__69231));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__69232 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__69233 = x;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__69232,G__69233) : spec_tools.parse.parse_form.call(null,G__69232,G__69233));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__69258 = cljs.spec.alpha.form(x);
x = G__69258;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__69234 = (spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1 ? spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x) : spec_tools.form.resolve_form.call(null,x));
var G__69235 = null;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__69234,G__69235) : spec_tools.parse.parse_form.call(null,G__69234,G__69235));
} else {
...
var G__69236 = parse_data;
var G__69236__$1 = (((G__69236 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__69236));
var G__69236__$2 = (((G__69236__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__69236__$1));
var G__69236__$3 = (((G__69236__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__69236__$2));
var G__69236__$4 = (((G__69236__$3 == null))?null:cljs.core.seq(G__69236__$3));
if((G__69236__$4 == null)){
return null;
} else {
return cljs.core.set(G__69236__$4);
}
}
});
...
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.parse","default","spec-tools.parse/default",-1184283850)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__69237 = cljs.core.get_global_hierarchy;
return (fexpr__69237.cljs$core$IFn$_invoke$arity$0 ? fexpr__69237.cljs$core$IFn$_invoke$arity$0() : fexpr__69237.call(null));
})());
...
var map__69242 = spec_tools.impl.parse_keys(form);
var map__69242__$1 = (((((!((map__69242 == null))))?(((((map__69242.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__69242.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__69242):map__69242);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69242__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69242__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69242__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69242__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69242__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__69244 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__69244__$1 = (cljs.core.truth_((function (){var or__4185__auto__ = req;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__69244,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__69244);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__69244__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__69244__$1;
}
}));
...
var map__69245 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__69245__$1 = (((((!((map__69245 == null))))?(((((map__69245.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__69245.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__69245):map__69245);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69245__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__69247 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__69247__$1 = (((((!((map__69247 == null))))?(((((map__69247.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__69247.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__69247):map__69247);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69247__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__69249){
var vec__69250 = p__69249;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69250,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69250,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69250,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__69253){
var vec__69254 = p__69253;
var seq__69255 = cljs.core.seq(vec__69254);
var first__69256 = cljs.core.first(seq__69255);
var seq__69255__$1 = cljs.core.next(seq__69255);
var ___$1 = first__69256;
var values = seq__69255__$1;
