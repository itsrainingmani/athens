...
return [(function (){var pred__49706 = cljs.core.instance_QMARK_;
var expr__49707 = reactive_val;
if(cljs.core.truth_((pred__49706.cljs$core$IFn$_invoke$arity$2 ? pred__49706.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__49707) : pred__49706.call(null,reagent.ratom.RAtom,expr__49707)))){
return "ra";
} else {
if(cljs.core.truth_((pred__49706.cljs$core$IFn$_invoke$arity$2 ? pred__49706.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__49707) : pred__49706.call(null,reagent.ratom.RCursor,expr__49707)))){
return "rc";
} else {
if(cljs.core.truth_((pred__49706.cljs$core$IFn$_invoke$arity$2 ? pred__49706.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__49707) : pred__49706.call(null,reagent.ratom.Reaction,expr__49707)))){
return "rx";
} else {
if(cljs.core.truth_((pred__49706.cljs$core$IFn$_invoke$arity$2 ? pred__49706.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__49707) : pred__49706.call(null,reagent.ratom.Track,expr__49707)))){
return "tr";
} else {
return "other";
}
