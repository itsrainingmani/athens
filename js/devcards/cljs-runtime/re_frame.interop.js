...
return [(function (){var pred__49702 = cljs.core.instance_QMARK_;
var expr__49703 = reactive_val;
if(cljs.core.truth_((pred__49702.cljs$core$IFn$_invoke$arity$2 ? pred__49702.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__49703) : pred__49702.call(null,reagent.ratom.RAtom,expr__49703)))){
return "ra";
} else {
if(cljs.core.truth_((pred__49702.cljs$core$IFn$_invoke$arity$2 ? pred__49702.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__49703) : pred__49702.call(null,reagent.ratom.RCursor,expr__49703)))){
return "rc";
} else {
if(cljs.core.truth_((pred__49702.cljs$core$IFn$_invoke$arity$2 ? pred__49702.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__49703) : pred__49702.call(null,reagent.ratom.Reaction,expr__49703)))){
return "rx";
} else {
if(cljs.core.truth_((pred__49702.cljs$core$IFn$_invoke$arity$2 ? pred__49702.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__49703) : pred__49702.call(null,reagent.ratom.Track,expr__49703)))){
return "tr";
} else {
return "other";
}
