...
return [(function (){var pred__50729 = cljs.core.instance_QMARK_;
var expr__50730 = reactive_val;
if(cljs.core.truth_((pred__50729.cljs$core$IFn$_invoke$arity$2 ? pred__50729.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__50730) : pred__50729.call(null,reagent.ratom.RAtom,expr__50730)))){
return "ra";
} else {
if(cljs.core.truth_((pred__50729.cljs$core$IFn$_invoke$arity$2 ? pred__50729.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__50730) : pred__50729.call(null,reagent.ratom.RCursor,expr__50730)))){
return "rc";
} else {
if(cljs.core.truth_((pred__50729.cljs$core$IFn$_invoke$arity$2 ? pred__50729.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__50730) : pred__50729.call(null,reagent.ratom.Reaction,expr__50730)))){
return "rx";
} else {
if(cljs.core.truth_((pred__50729.cljs$core$IFn$_invoke$arity$2 ? pred__50729.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__50730) : pred__50729.call(null,reagent.ratom.Track,expr__50730)))){
return "tr";
} else {
return "other";
}
