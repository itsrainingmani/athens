...
var seq__61509 = cljs.core.seq(cljs.core.keys(cljs.core.deref(stylefy.impl.dom.styles_in_dom)));
var chunk__61510 = null;
var count__61511 = (0);
var i__61512 = (0);
while(true){
if((i__61512 < count__61511)){
var style_hash = chunk__61510.cljs$core$IIndexed$_nth$arity$2(null,i__61512);
...
var G__61703 = seq__61509;
var G__61704 = chunk__61510;
var G__61705 = count__61511;
var G__61706 = (i__61512 + (1));
seq__61509 = G__61703;
chunk__61510 = G__61704;
count__61511 = G__61705;
i__61512 = G__61706;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__61509);
if(temp__5735__auto__){
var seq__61509__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__61509__$1)){
var c__4609__auto__ = cljs.core.chunk_first(seq__61509__$1);
var G__61712 = cljs.core.chunk_rest(seq__61509__$1);
var G__61713 = c__4609__auto__;
var G__61714 = cljs.core.count(c__4609__auto__);
var G__61715 = (0);
seq__61509 = G__61712;
chunk__61510 = G__61713;
count__61511 = G__61714;
i__61512 = G__61715;
continue;
} else {
var style_hash = cljs.core.first(seq__61509__$1);
cljs.core.reset_BANG_(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(stylefy.impl.dom.styles_in_dom),style_hash),true);


var G__61716 = cljs.core.next(seq__61509__$1);
var G__61717 = null;
var G__61718 = (0);
var G__61719 = (0);
seq__61509 = G__61716;
chunk__61510 = G__61717;
count__61511 = G__61718;
i__61512 = G__61719;
continue;
}
} else {
...
}catch (e61551){var e_61720 = e61551;
stylefy.impl.log.warn(["Unable to cache styles, error: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(e_61720)].join(''));
...
var c__46094__auto___61721 = cljs.core.async.chan.cljs$core$IFn$_invoke$arity$1((1));
cljs.core.async.impl.dispatch.run((function (){
var f__46095__auto__ = (function (){var switch__45998__auto__ = (function (state_61569){
var state_val_61570 = (state_61569[(1)]);
if((state_val_61570 === (1))){
var inst_61567 = stylefy.impl.dom.update_dom();
var state_61569__$1 = state_61569;
return cljs.core.async.impl.ioc_helpers.return_chan(state_61569__$1,inst_61567);
} else {
return null;
}
});
return (function() {
var stylefy$impl$dom$request_asynchronous_dom_update_$_state_machine__45999__auto__ = null;
var stylefy$impl$dom$request_asynchronous_dom_update_$_state_machine__45999__auto____0 = (function (){
var statearr_61574 = [null,null,null,null,null,null,null];
(statearr_61574[(0)] = stylefy$impl$dom$request_asynchronous_dom_update_$_state_machine__45999__auto__);

(statearr_61574[(1)] = (1));

return statearr_61574;
});
var stylefy$impl$dom$request_asynchronous_dom_update_$_state_machine__45999__auto____1 = (function (state_61569){
while(true){
var ret_value__46000__auto__ = (function (){try{while(true){
var result__46001__auto__ = switch__45998__auto__(state_61569);
...
}catch (e61575){if((e61575 instanceof Object)){
var ex__46002__auto__ = e61575;
var statearr_61576_61722 = state_61569;
(statearr_61576_61722[(5)] = ex__46002__auto__);


cljs.core.async.impl.ioc_helpers.process_exception(state_61569);
...
var G__61725 = state_61569;
state_61569 = G__61725;
continue;
} else {
...
stylefy$impl$dom$request_asynchronous_dom_update_$_state_machine__45999__auto__ = function(state_61569){
switch(arguments.length){
case 0:
return stylefy$impl$dom$request_asynchronous_dom_update_$_state_machine__45999__auto____0.call(this);
case 1:
return stylefy$impl$dom$request_asynchronous_dom_update_$_state_machine__45999__auto____1.call(this,state_61569);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
stylefy$impl$dom$request_asynchronous_dom_update_$_state_machine__45999__auto__.cljs$core$IFn$_invoke$arity$0 = stylefy$impl$dom$request_asynchronous_dom_update_$_state_machine__45999__auto____0;
stylefy$impl$dom$request_asynchronous_dom_update_$_state_machine__45999__auto__.cljs$core$IFn$_invoke$arity$1 = stylefy$impl$dom$request_asynchronous_dom_update_$_state_machine__45999__auto____1;
return stylefy$impl$dom$request_asynchronous_dom_update_$_state_machine__45999__auto__;
})()
})();
var state__46096__auto__ = (function (){var statearr_61581 = (f__46095__auto__.cljs$core$IFn$_invoke$arity$0 ? f__46095__auto__.cljs$core$IFn$_invoke$arity$0() : f__46095__auto__.call(null));
(statearr_61581[(6)] = c__46094__auto___61721);
...
stylefy.impl.dom.init_multi_instance = (function stylefy$impl$dom$init_multi_instance(p__61590){
...
var options = map__61592__$1;
var multi_instance = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61592__$1,new cljs.core.Keyword(null,"multi-instance","multi-instance",-1525956512));
...
return cljs.core.reset_BANG_(stylefy.impl.dom.styles_in_dom,cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.merge,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__61609_SHARP_){
return cljs.core.PersistentArrayMap.createAsIfByAssoc([p1__61609_SHARP_,reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false)]);
 ...
 */
stylefy.impl.dom.save_style_BANG_ = (function stylefy$impl$dom$save_style_BANG_(p__61633){
...
var style = map__61634__$1;
var css = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61634__$1,new cljs.core.Keyword(null,"css","css",1135045163));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61634__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
