...
}catch (e38559){var e_38625 = e38559;
stylefy.impl.log.warn(["Unable to cache styles, error: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(e_38625)].join(''));
...
return cljs.core.async.impl.ioc_helpers.return_chan(state_38565__$1,inst_38562);
} else {
return null;
}
});
...
var G__38633 = state_38565;
state_38565 = G__38633;
continue;
} else {
