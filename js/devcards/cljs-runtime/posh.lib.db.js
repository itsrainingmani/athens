...
var G__57401 = cljs.core.first(poshdb);
...
var G__57423 = cljs.core.cons(pdb,path);
var G__57424 = posh.lib.db.get_parent_db(pdb);
path = G__57423;
pdb = G__57424;
continue;
} else {
...
var G__57425 = posh.lib.db.get_parent_db(poshdb);
poshdb = G__57425;
continue;
}
break;
...
var filter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57405__$1,new cljs.core.Keyword(null,"filter","filter",-948537934));
var as_of = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57405__$1,new cljs.core.Keyword(null,"as-of","as-of",-1841962382));
var since = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57405__$1,new cljs.core.Keyword(null,"since","since",315379842));
var with$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57405__$1,new cljs.core.Keyword(null,"with","with",-1536296876));
var db__$1 = (function (){var or__4185__auto__ = db;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var fexpr__57407 = new cljs.core.Keyword(null,"db","db",993250759).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__57407.cljs$core$IFn$_invoke$arity$1 ? fexpr__57407.cljs$core$IFn$_invoke$arity$1(conn) : fexpr__57407.call(null,conn));
}
})();
var db__$2 = (cljs.core.truth_(since)?(function (){var fexpr__57408 = new cljs.core.Keyword(null,"since","since",315379842).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__57408.cljs$core$IFn$_invoke$arity$2 ? fexpr__57408.cljs$core$IFn$_invoke$arity$2(db__$1,since) : fexpr__57408.call(null,db__$1,since));
})():db__$1);
var db__$3 = (cljs.core.truth_(as_of)?(function (){var fexpr__57409 = new cljs.core.Keyword(null,"as-of","as-of",-1841962382).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__57409.cljs$core$IFn$_invoke$arity$2 ? fexpr__57409.cljs$core$IFn$_invoke$arity$2(db__$2,as_of) : fexpr__57409.call(null,db__$2,as_of));
})():db__$2);
var db__$4 = (cljs.core.truth_(with$)?new cljs.core.Keyword(null,"db-after","db-after",-571884666).cljs$core$IFn$_invoke$arity$1((function (){var fexpr__57410 = new cljs.core.Keyword(null,"with","with",-1536296876).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__57410.cljs$core$IFn$_invoke$arity$2 ? fexpr__57410.cljs$core$IFn$_invoke$arity$2(db__$3,with$) : fexpr__57410.call(null,db__$3,with$));
})()):db__$3);
var db__$5 = (cljs.core.truth_(filter)?(function (){var G__57412 = db__$4;
var G__57413 = (((filter instanceof cljs.core.Symbol))?null:filter);
var fexpr__57411 = new cljs.core.Keyword(null,"filter","filter",-948537934).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__57411.cljs$core$IFn$_invoke$arity$2 ? fexpr__57411.cljs$core$IFn$_invoke$arity$2(G__57412,G__57413) : fexpr__57411.call(null,G__57412,G__57413));
})():db__$4);
return db__$5;
}));
...
posh.lib.db.poshdb__GT_db = (function posh$lib$db$poshdb__GT_db(p__57414,poshdb){
...
var posh_tree = map__57415__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57415__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var cache = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57415__$1,new cljs.core.Keyword(null,"cache","cache",-1237023054));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(poshdb),new cljs.core.Keyword(null,"db","db",993250759))){
return posh.lib.db.db_id__GT_db(posh_tree,cljs.core.second(poshdb));
} else {
var G__57418 = (function (){var G__57420 = posh_tree;
var G__57421 = posh.lib.db.get_parent_db(poshdb);
return (posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2 ? posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2(G__57420,G__57421) : posh.lib.db.poshdb__GT_db.call(null,G__57420,G__57421));
})();
var G__57419 = posh.lib.db.make_filter_pred(new cljs.core.Keyword(null,"pass-patterns","pass-patterns",1090887263).cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cache,poshdb)));
var fexpr__57417 = new cljs.core.Keyword(null,"filter","filter",-948537934).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__57417.cljs$core$IFn$_invoke$arity$2 ? fexpr__57417.cljs$core$IFn$_invoke$arity$2(G__57418,G__57419) : fexpr__57417.call(null,G__57418,G__57419));
}
});
