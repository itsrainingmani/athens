...
var listener_39400 = (function (direction,evt){
...
G__39350_39401.listen(goog.net.EventType.UPLOAD_PROGRESS,cljs.core.partial.cljs$core$IFn$_invoke$arity$2(listener_39400,new cljs.core.Keyword(null,"upload","upload",-255769218)));

G__39350_39401.listen(goog.net.EventType.DOWNLOAD_PROGRESS,cljs.core.partial.cljs$core$IFn$_invoke$arity$2(listener_39400,new cljs.core.Keyword(null,"download","download",-300081668)));
...
if(cljs.core.truth_(cancel)){
var c__37003__auto___39402 = cljs.core.async.chan.cljs$core$IFn$_invoke$arity$1((1));
...
var statearr_39370_39409 = state_39361;
(statearr_39370_39409[(5)] = ex__36939__auto__);
...
var G__39410 = state_39361;
state_39361 = G__39410;
continue;
} else {
...
(statearr_39371[(6)] = c__37003__auto___39402);
...
var req_39413 = jsonp.send(null,(function cljs_http$core$jsonp_$_success_callback(data){
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_http.core.pending_requests,cljs.core.assoc,channel,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"jsonp","jsonp",226119588),jsonp,new cljs.core.Keyword(null,"request","request",1772954723),req_39413], null));

if(cljs.core.truth_(cancel)){
var c__37003__auto___39419 = cljs.core.async.chan.cljs$core$IFn$_invoke$arity$1((1));
cljs.core.async.impl.dispatch.run((function (){
...
var inst_39377 = jsonp.cancel(req_39413);
...
var statearr_39384_39426 = state_39379;
(statearr_39384_39426[(5)] = ex__36939__auto__);
...
if(cljs.core.keyword_identical_QMARK_(ret_value__36937__auto__,new cljs.core.Keyword(null,"recur","recur",-437573268))){
var G__39427 = state_39379;
state_39379 = G__39427;
continue;
} else {
return ret_value__36937__auto__;
}
...
(statearr_39385[(6)] = c__37003__auto___39419);
