...
var G__80326 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__80327 = n;
var G__80328 = cljs.core.nnext(bs);
var G__80329 = true;
ret = G__80326;
n = G__80327;
bs = G__80328;
seen_rest_QMARK_ = G__80329;
continue;
} else {
...
});})(G__80317,gmap,defaults,pvec,bents))
;
return fexpr__80316(G__80317);
})();
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__80305_SHARP_){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__80305_SHARP_);
}
})(),cljs.core.name(p1__80305_SHARP_));
}));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(mkn,"syms")){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__80306_SHARP_){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__80306_SHARP_);
}
})(),cljs.core.name(p1__80306_SHARP_));
}));
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__80307_SHARP_,p2__80308_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__80307_SHARP_,p2__80308_SHARP_,(function (){var fexpr__80322 = cljs.core.val(entry);
return (fexpr__80322.cljs$core$IFn$_invoke$arity$1 ? fexpr__80322.cljs$core$IFn$_invoke$arity$1(p2__80308_SHARP_) : fexpr__80322.call(null,p2__80308_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__80324 = cljs.core.key(entry);
return (fexpr__80324.cljs$core$IFn$_invoke$arity$1 ? fexpr__80324.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__80324.call(null,bes));
})());
...
var G__80334 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__80335 = cljs.core.next(bes);
ret = G__80334;
bes = G__80335;
continue;
} else {
...
var temp__5733__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__80309_SHARP_){
return (cljs.core.first(p1__80309_SHARP_) instanceof cljs.core.Keyword);
}),bents));
