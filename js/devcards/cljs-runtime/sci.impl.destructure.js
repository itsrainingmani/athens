...
var G__57611 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__57612 = n;
var G__57613 = cljs.core.nnext(bs);
var G__57614 = true;
ret = G__57611;
n = G__57612;
bs = G__57613;
seen_rest_QMARK_ = G__57614;
continue;
} else {
...
var G__57616 = (n + (1));
var G__57617 = cljs.core.next(bs);
var G__57618 = seen_rest_QMARK_;
ret = G__57615;
n = G__57616;
bs = G__57617;
seen_rest_QMARK_ = G__57618;
continue;
}
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__57600_SHARP_){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var or__4126__auto__ = mkns;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
return cljs.core.namespace(p1__57600_SHARP_);
}
})(),cljs.core.name(p1__57600_SHARP_));
}));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(mkn,"syms")){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__57601_SHARP_){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2((function (){var or__4126__auto__ = mkns;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
return cljs.core.namespace(p1__57601_SHARP_);
}
})(),cljs.core.name(p1__57601_SHARP_));
}));
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__57602_SHARP_,p2__57603_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__57602_SHARP_,p2__57603_SHARP_,(function (){var fexpr__57608 = cljs.core.val(entry);
return (fexpr__57608.cljs$core$IFn$_invoke$arity$1 ? fexpr__57608.cljs$core$IFn$_invoke$arity$1(p2__57603_SHARP_) : fexpr__57608.call(null,p2__57603_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__57609 = cljs.core.key(entry);
return (fexpr__57609.cljs$core$IFn$_invoke$arity$1 ? fexpr__57609.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__57609.call(null,bes));
})());
...
var G__57619 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__57620 = cljs.core.next(bes);
ret = G__57619;
bes = G__57620;
continue;
} else {
...
var temp__5733__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57604_SHARP_){
return (cljs.core.first(p1__57604_SHARP_) instanceof cljs.core.Keyword);
}),bents));
