...
var G__24090 = data;
var target__20582__auto__ = G__24090;
if(cljs.core.truth_(target__20582__auto__)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24090)].join(''),"\n","target__20582__auto__"].join('')));
}

(target__20582__auto__["config"] = devtools.formatters.state.set_depth_budget(config,depth_budget));
