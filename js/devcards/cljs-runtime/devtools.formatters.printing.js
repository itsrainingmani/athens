...
}catch (e23877){var _e__20583__auto__ = e23877;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__23887 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__23888 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__23888);

try{var map__23889 = opts;
var map__23889__$1 = (((((!((map__23889 == null))))?(((((map__23889.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__23889.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__23889):map__23889);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23889__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__23887);
}});
...
try{devtools.formatters.state.update_current_state_BANG_((function (p1__23904_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__23904_SHARP_,null);
}));
