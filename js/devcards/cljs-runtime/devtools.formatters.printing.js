...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq42867){
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__42938_SHARP_){
return (!((cljs.core.meta(p1__42938_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42974__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e42981){var _e__40241__auto__ = e42981;
return false;
}})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
}catch (e42983){var _e__40241__auto__ = e42983;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__42985 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__42986 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__42986);

try{var map__42987 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42987__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__42985);
}});
...
var temp__5733__auto___43033 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___43033)){
var managed_print_level_43034 = temp__5733__auto___43033;
var _STAR_print_level_STAR__orig_val__42995_43035 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__42996_43036 = managed_print_level_43034;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__42996_43036);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__42991_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__42991_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__42995_43035);
}} else {
job_fn();
}
