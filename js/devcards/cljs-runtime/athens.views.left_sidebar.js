...
athens.views.left_sidebar.shortcut_component = (function athens$views$left_sidebar$shortcut_component(p__60130){
var vec__60131 = p__60130;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60131,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60131,(1),null);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60131,(2),null);
var drag = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(null);
return (function (p__60134){
var vec__60135 = p__60134;
var order = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60135,(0),null);
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60135,(1),null);
var uid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60135,(2),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a","a",-2123407586),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([athens.views.left_sidebar.shortcut_style,(function (){var G__60138 = cljs.core.deref(drag);
...
var source_order_60144 = parseInt(e.dataTransfer.getData("text/plain"));
cljs.core.prn.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([source_order_60144,order], 0));

if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(source_order_60144,order)){
} else {
if(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(source_order_60144,(order - (1)))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(drag),new cljs.core.Keyword(null,"above","above",-1286866470))))){
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(drag),new cljs.core.Keyword(null,"below","below",-926774883))){
re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("left-sidebar","drop-below","left-sidebar/drop-below",1291292866),source_order_60144,order], null));
} else {
re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("left-sidebar","drop-above","left-sidebar/drop-above",75584917),source_order_60144,order], null));
...
var c__4527__auto__ = cljs.core.chunk_first(s__60140__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__60142 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__60141 = (0);
while(true){
if((i__60141 < size__4528__auto__)){
var sh = cljs.core._nth(c__4527__auto__,i__60141);
cljs.core.chunk_append(b__60142,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.views.left_sidebar.shortcut_component,sh], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["left-sidebar-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.second(sh))].join('')], null)));

var G__60145 = (i__60141 + (1));
i__60141 = G__60145;
continue;
} else {
return true;
