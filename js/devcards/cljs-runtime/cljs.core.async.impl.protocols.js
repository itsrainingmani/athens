...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_40140 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_40140(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_40143 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_40143(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_40151 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_40151(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_40155 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_40155(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_40159 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_40159(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_40163 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_40163(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_40166 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_40166(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_40171 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_40171(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_40172 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_40172(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_40173 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_40173(b,itm);
}
});
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_40176(b);
}
});
