...
var G__48574 = cljs.spec.alpha.get_spec(x);
x = G__48574;
continue;
} else {
...
var G__48578 = cljs.spec.alpha.get_spec(new cljs.core.Keyword(null,"spec","spec",347520401).cljs$core$IFn$_invoke$arity$1(x));
x = G__48578;
continue;
} else {
