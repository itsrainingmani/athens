...
var G__48218 = (i__4790__auto___48214 + (1));
i__4790__auto___48214 = G__48218;
continue;
} else {
}
break;
...
var G__48316 = cljs.spec.alpha.get_spec(new cljs.core.Keyword(null,"spec","spec",347520401).cljs$core$IFn$_invoke$arity$1(x));
x = G__48316;
continue;
} else {
...
if((x instanceof cljs.core.Keyword)){
var G__48352 = cljs.spec.alpha.get_spec(x);
x = G__48352;
continue;
} else {
