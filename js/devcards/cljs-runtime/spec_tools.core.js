...
var G__52715 = cljs.spec.alpha.get_spec(x);
x = G__52715;
continue;
} else {
...
var G__52716 = cljs.spec.alpha.get_spec(new cljs.core.Keyword(null,"spec","spec",347520401).cljs$core$IFn$_invoke$arity$1(x));
x = G__52716;
continue;
} else {
