...
var G__48534 = cljs.spec.alpha.get_spec(x);
x = G__48534;
continue;
} else {
...
var G__48535 = cljs.spec.alpha.get_spec(new cljs.core.Keyword(null,"spec","spec",347520401).cljs$core$IFn$_invoke$arity$1(x));
x = G__48535;
continue;
} else {
