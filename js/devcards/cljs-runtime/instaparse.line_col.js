...
(instaparse.line_col.Cursor.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k56550,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k56550,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__56556){
var vec__56557 = p__56556;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56557,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56557,(1),null);
...
(instaparse.line_col.Cursor.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__56549){
var self__ = this;
var G__56549__$1 = this;
return (new cljs.core.RecordIter((0),G__56549__$1,3,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"index","index",-1531685915),new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"column","column",2078222095)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(instaparse.line_col.Cursor.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this56551,other56552){
var self__ = this;
var this56551__$1 = this;
return (((!((other56552 == null)))) && ((this56551__$1.constructor === other56552.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56551__$1.index,other56552.index)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56551__$1.line,other56552.line)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56551__$1.column,other56552.column)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56551__$1.__extmap,other56552.__extmap)));
}));
...
(instaparse.line_col.Cursor.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__56549){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__56571 = cljs.core.keyword_identical_QMARK_;
var expr__56572 = k__4388__auto__;
if(cljs.core.truth_((pred__56571.cljs$core$IFn$_invoke$arity$2 ? pred__56571.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"index","index",-1531685915),expr__56572) : pred__56571.call(null,new cljs.core.Keyword(null,"index","index",-1531685915),expr__56572)))){
return (new instaparse.line_col.Cursor(G__56549,self__.line,self__.column,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__56571.cljs$core$IFn$_invoke$arity$2 ? pred__56571.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"line","line",212345235),expr__56572) : pred__56571.call(null,new cljs.core.Keyword(null,"line","line",212345235),expr__56572)))){
return (new instaparse.line_col.Cursor(self__.index,G__56549,self__.column,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__56571.cljs$core$IFn$_invoke$arity$2 ? pred__56571.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"column","column",2078222095),expr__56572) : pred__56571.call(null,new cljs.core.Keyword(null,"column","column",2078222095),expr__56572)))){
return (new instaparse.line_col.Cursor(self__.index,self__.line,G__56549,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.line_col.Cursor(self__.index,self__.line,self__.column,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__56549),null));
}
}
}
}));
...
(instaparse.line_col.Cursor.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__56549){
var self__ = this;
var this__4379__auto____$1 = this;
return (new instaparse.line_col.Cursor(self__.index,self__.line,self__.column,G__56549,self__.__extmap,self__.__hash));
}));
 ...
 */
instaparse.line_col.map__GT_Cursor = (function instaparse$line_col$map__GT_Cursor(G__56553){
var extmap__4419__auto__ = (function (){var G__56577 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__56553,new cljs.core.Keyword(null,"index","index",-1531685915),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"column","column",2078222095)], 0));
if(cljs.core.record_QMARK_(G__56553)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__56577);
} else {
return G__56577;
}
})();
return (new instaparse.line_col.Cursor(new cljs.core.Keyword(null,"index","index",-1531685915).cljs$core$IFn$_invoke$arity$1(G__56553),new cljs.core.Keyword(null,"line","line",212345235).cljs$core$IFn$_invoke$arity$1(G__56553),new cljs.core.Keyword(null,"column","column",2078222095).cljs$core$IFn$_invoke$arity$1(G__56553),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
var G__56598 = (index + (1));
var G__56599 = line;
var G__56600 = (column + (1));
index = G__56598;
line = G__56599;
column = G__56600;
continue;
