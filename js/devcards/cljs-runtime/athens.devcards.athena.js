...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.athena !== 'undefined') && (typeof athens.devcards.athena.t_athens$devcards$athena56095 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.athena.t_athens$devcards$athena56095 = (function (meta56096){
this.meta56096 = meta56096;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.athena.t_athens$devcards$athena56095.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_56097,meta56096__$1){
var self__ = this;
var _56097__$1 = this;
return (new athens.devcards.athena.t_athens$devcards$athena56095(meta56096__$1));
}));

(athens.devcards.athena.t_athens$devcards$athena56095.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_56097){
var self__ = this;
var _56097__$1 = this;
return self__.meta56096;
}));

(athens.devcards.athena.t_athens$devcards$athena56095.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.athena.t_athens$devcards$athena56095.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__49619__auto__,devcard_opts__49620__auto__){
var self__ = this;
var this__49619__auto____$1 = this;
...
(athens.devcards.athena.t_athens$devcards$athena56095.getBasis = (function (){
...
(athens.devcards.athena.t_athens$devcards$athena56095.cljs$lang$type = true);

(athens.devcards.athena.t_athens$devcards$athena56095.cljs$lang$ctorStr = "athens.devcards.athena/t_athens$devcards$athena56095");

(athens.devcards.athena.t_athens$devcards$athena56095.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.athena/t_athens$devcards$athena56095");
}));

/**
 * Positional factory function for athens.devcards.athena/t_athens$devcards$athena56095.
 */
athens.devcards.athena.__GT_t_athens$devcards$athena56095 = (function athens$devcards$athena$__GT_t_athens$devcards$athena56095(meta56096){
return (new athens.devcards.athena.t_athens$devcards$athena56095(meta56096));
});

}

return (new athens.devcards.athena.t_athens$devcards$athena56095(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
