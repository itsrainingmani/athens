...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.athena !== 'undefined') && (typeof athens.devcards.athena.t_athens$devcards$athena56088 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.athena.t_athens$devcards$athena56088 = (function (meta56089){
this.meta56089 = meta56089;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.athena.t_athens$devcards$athena56088.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_56090,meta56089__$1){
var self__ = this;
var _56090__$1 = this;
return (new athens.devcards.athena.t_athens$devcards$athena56088(meta56089__$1));
}));

(athens.devcards.athena.t_athens$devcards$athena56088.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_56090){
var self__ = this;
var _56090__$1 = this;
return self__.meta56089;
}));

(athens.devcards.athena.t_athens$devcards$athena56088.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.athena.t_athens$devcards$athena56088.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__48675__auto__,devcard_opts__48676__auto__){
var self__ = this;
var this__48675__auto____$1 = this;
...
(athens.devcards.athena.t_athens$devcards$athena56088.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta56089","meta56089",256982237,null)], null);
}));

(athens.devcards.athena.t_athens$devcards$athena56088.cljs$lang$type = true);

(athens.devcards.athena.t_athens$devcards$athena56088.cljs$lang$ctorStr = "athens.devcards.athena/t_athens$devcards$athena56088");

(athens.devcards.athena.t_athens$devcards$athena56088.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.athena/t_athens$devcards$athena56088");
}));

/**
 * Positional factory function for athens.devcards.athena/t_athens$devcards$athena56088.
 */
athens.devcards.athena.__GT_t_athens$devcards$athena56088 = (function athens$devcards$athena$__GT_t_athens$devcards$athena56088(meta56089){
return (new athens.devcards.athena.t_athens$devcards$athena56088(meta56089));
});

}

return (new athens.devcards.athena.t_athens$devcards$athena56088(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
