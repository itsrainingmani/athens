...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.athena !== 'undefined') && (typeof athens.devcards.athena.t_athens$devcards$athena55789 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.athena.t_athens$devcards$athena55789 = (function (meta55790){
this.meta55790 = meta55790;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.athena.t_athens$devcards$athena55789.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_55791,meta55790__$1){
var self__ = this;
var _55791__$1 = this;
return (new athens.devcards.athena.t_athens$devcards$athena55789(meta55790__$1));
}));

(athens.devcards.athena.t_athens$devcards$athena55789.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_55791){
var self__ = this;
var _55791__$1 = this;
return self__.meta55790;
}));

(athens.devcards.athena.t_athens$devcards$athena55789.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.athena.t_athens$devcards$athena55789.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__42236__auto__,devcard_opts__42237__auto__){
var self__ = this;
var this__42236__auto____$1 = this;
...
(athens.devcards.athena.t_athens$devcards$athena55789.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta55790","meta55790",1516347426,null)], null);
}));

(athens.devcards.athena.t_athens$devcards$athena55789.cljs$lang$type = true);

(athens.devcards.athena.t_athens$devcards$athena55789.cljs$lang$ctorStr = "athens.devcards.athena/t_athens$devcards$athena55789");

(athens.devcards.athena.t_athens$devcards$athena55789.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.athena/t_athens$devcards$athena55789");
}));

/**
 * Positional factory function for athens.devcards.athena/t_athens$devcards$athena55789.
 */
athens.devcards.athena.__GT_t_athens$devcards$athena55789 = (function athens$devcards$athena$__GT_t_athens$devcards$athena55789(meta55790){
return (new athens.devcards.athena.t_athens$devcards$athena55789(meta55790));
});

}

return (new athens.devcards.athena.t_athens$devcards$athena55789(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
