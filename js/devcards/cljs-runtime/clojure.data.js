...
if(cljs.core.seq(m)){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__21094){
...
var vec__21102 = clojure.data.diff(va,vb);
var a_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21102,(0),null);
var b_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21102,(1),null);
var ab = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21102,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_21153 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_21153(x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_21154 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_21154(a,b);
}
});
...
var fexpr__21137 = (function (){var G__21138 = clojure.data.equality_partition(a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__21138__$1)].join('')));
