...
var clojure$data$EqualityPartition$equality_partition$dyn_20967 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_20967(x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_20968 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_20968(a,b);
}
});
...
var fexpr__20947 = (function (){var G__20948 = clojure.data.equality_partition(a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20948__$1)].join('')));
