...
var sablono$util$ToString$to_str$dyn_45093 = (function (x){
...
return sablono$util$ToString$to_str$dyn_45093(x);
}
});
...
var sablono$util$ToURI$to_uri$dyn_45096 = (function (x){
var x__4428__auto__ = (((x == null))?null:x);
...
return sablono$util$ToURI$to_uri$dyn_45096(x);
}
});
...
var G__45105 = (i__4737__auto___45102 + (1));
i__4737__auto___45102 = G__45105;
continue;
} else {
}
break;
...
var vec__45065 = cljs.core.name(k).split("-");
...
var first_word = first__45067;
var words = seq__45066__$1;
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__45078,new cljs.core.Keyword(null,"style","style",-496642736),sablono.util.camel_case_keys);
} else {
return G__45078;
}
} else {
