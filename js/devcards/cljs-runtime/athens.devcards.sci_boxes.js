...
return devcards.core.card_base(new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"name","name",1843675177),"sci-examples",new cljs.core.Keyword(null,"documentation","documentation",1889593999),null,new cljs.core.Keyword(null,"main-obj","main-obj",-1544409742),(function (){var iter__4529__auto__ = (function athens$devcards$sci_boxes$iter__60200(s__60201){
return (new cljs.core.LazySeq(null,(function (){
var s__60201__$1 = s__60201;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__60201__$1);
if(temp__5735__auto__){
var s__60201__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__60201__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__60201__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__60203 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__60202 = (0);
while(true){
if((i__60202 < size__4528__auto__)){
var vec__60204 = cljs.core._nth(c__4527__auto__,i__60202);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60204,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60204,(1),null);
cljs.core.chunk_append(b__60203,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),s,new cljs.core.Keyword(null,"result","result",1415092211),sci.core.eval_string.cljs$core$IFn$_invoke$arity$2(s,opts)], null),(cljs.core.truth_(opts)?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"opts","opts",155075701),opts], null):null)], 0)));

var G__60254 = (i__60202 + (1));
i__60202 = G__60254;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60203),athens$devcards$sci_boxes$iter__60200(cljs.core.chunk_rest(s__60201__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__60203),null);
}
} else {
var vec__60207 = cljs.core.first(s__60201__$2);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60207,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60207,(1),null);
return cljs.core.cons(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),s,new cljs.core.Keyword(null,"result","result",1415092211),sci.core.eval_string.cljs$core$IFn$_invoke$arity$2(s,opts)], null),(cljs.core.truth_(opts)?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"opts","opts",155075701),opts], null):null)], 0)),athens$devcards$sci_boxes$iter__60200(cljs.core.rest(s__60201__$2)));
}
} else {
return null;
}
...
return cljs.core.some((function (p__60210){
var vec__60211 = p__60210;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60211,(0),null);
var box = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60211,(1),null);
...
athens.devcards.sci_boxes.sci_node_QMARK_ = (function athens$devcards$sci_boxes$sci_node_QMARK_(p__60214){
...
athens.devcards.sci_boxes.eval_box = (function athens$devcards$sci_boxes$eval_box(p__60217,parent){
...
var temp__5733__auto____$1 = cljs.core.some((function (p1__60221_SHARP_){
if(cljs.core.not((visited.cljs$core$IFn$_invoke$arity$1 ? visited.cljs$core$IFn$_invoke$arity$1(p1__60221_SHARP_) : visited.call(null,p1__60221_SHARP_)))){
return p1__60221_SHARP_;
} else {
return null;
}
}),children);
...
var temp__5733__auto____$1 = cljs.core.some((function (p1__60222_SHARP_){
if(cljs.core.not((visited.cljs$core$IFn$_invoke$arity$1 ? visited.cljs$core$IFn$_invoke$arity$1(p1__60222_SHARP_) : visited.call(null,p1__60222_SHARP_)))){
return p1__60222_SHARP_;
} else {
return null;
}
}),siblings);
...
var G__60255 = boxes_SINGLEQUOTE_;
var G__60256 = visited_SINGLEQUOTE_;
var G__60257 = id_SINGLEQUOTE_;
boxes__$1 = G__60255;
visited = G__60256;
id = G__60257;
continue;
...
athens.devcards.sci_boxes.add_child = (function athens$devcards$sci_boxes$add_child(p__60223,idx,id){
...
var children_ids = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60224__$1,new cljs.core.Keyword(null,"children-ids","children-ids",-293558198));
var new_idx = (idx + (1));
...
athens.devcards.sci_boxes.add_sibling = (function athens$devcards$sci_boxes$add_sibling(p__60226,id){
...
var state = map__60227__$1;
var next_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60227__$1,new cljs.core.Keyword(null,"next-id","next-id",-224240762));
var boxes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60227__$1,new cljs.core.Keyword(null,"boxes","boxes",-420813822));
...
athens.devcards.sci_boxes.delete_box = (function athens$devcards$sci_boxes$delete_box(p__60229,id){
...
var state = map__60230__$1;
var boxes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60230__$1,new cljs.core.Keyword(null,"boxes","boxes",-420813822));
var parent_id = athens.devcards.sci_boxes.get_parent_id(boxes,id);
...
var map__60232 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(athens.devcards.sci_boxes.box_state_STAR_),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"boxes","boxes",-420813822),id], null));
...
var str_content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60232__$1,new cljs.core.Keyword(null,"str-content","str-content",297549190));
...
var G__60234 = k;
var G__60234__$1 = (((G__60234 instanceof cljs.core.Keyword))?G__60234.fqn:null);
switch (G__60234__$1) {
case "return":
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(athens.devcards.sci_boxes.box_state_STAR_,(function (p1__60235_SHARP_){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$5(p1__60235_SHARP_,new cljs.core.Keyword(null,"boxes","boxes",-420813822),athens.devcards.sci_boxes.update_box_content,id,value),new cljs.core.Keyword(null,"boxes","boxes",-420813822),athens.devcards.sci_boxes.eval_all_boxes);
}));
});
athens.devcards.sci_boxes.sci_result_component = (function athens$devcards$sci_boxes$sci_result_component(result){
if(cljs.core.truth_(result)){
var map__60236 = result;
...
var hiccup = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60236__$1,new cljs.core.Keyword(null,"hiccup","hiccup",1218876238));
...
var vec__60238 = cljs.core.deref(err_STAR_);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60238,(0),null);
var info = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60238,(1),null);
...
var map__60243 = cljs.core.deref(athens.devcards.sci_boxes.box_state_STAR_);
...
var boxes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60243__$1,new cljs.core.Keyword(null,"boxes","boxes",-420813822));
var map__60244 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(boxes,id);
...
var id__$1 = cljs.core._nth(c__4527__auto__,i__60249);
cljs.core.chunk_append(b__60250,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.sci_boxes.box_component,id__$1], null));

var G__60259 = (i__60249 + (1));
i__60249 = G__60259;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60250),athens$devcards$sci_boxes$box_component_$_iter__60247(cljs.core.chunk_rest(s__60248__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__60250),null);
}
} else {
var id__$1 = cljs.core.first(s__60248__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.sci_boxes.box_component,id__$1], null),athens$devcards$sci_boxes$box_component_$_iter__60247(cljs.core.rest(s__60248__$2)));
}
} else {
return null;
}
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.sci_boxes !== 'undefined') && (typeof athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60251 !== 'undefined')){
} else {
...
*/
athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60251 = (function (meta60252){
this.meta60252 = meta60252;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60251.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60253,meta60252__$1){
var self__ = this;
var _60253__$1 = this;
return (new athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60251(meta60252__$1));
}));

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60251.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60253){
var self__ = this;
var _60253__$1 = this;
return self__.meta60252;
}));

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60251.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60251.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__47726__auto__,devcard_opts__47727__auto__){
var self__ = this;
...
(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60251.getBasis = (function (){
...
(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60251.cljs$lang$type = true);

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60251.cljs$lang$ctorStr = "athens.devcards.sci-boxes/t_athens$devcards$sci_boxes60251");

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60251.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"athens.devcards.sci-boxes/t_athens$devcards$sci_boxes60251");
}));

/**
 * Positional factory function for athens.devcards.sci-boxes/t_athens$devcards$sci_boxes60251.
 */
athens.devcards.sci_boxes.__GT_t_athens$devcards$sci_boxes60251 = (function athens$devcards$sci_boxes$__GT_t_athens$devcards$sci_boxes60251(meta60252){
return (new athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60251(meta60252));
});

}

return (new athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60251(null));
})()
