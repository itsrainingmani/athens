...
if(cljs.core.truth_((function (){var fexpr__57993 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__57993.cljs$core$IFn$_invoke$arity$1 ? fexpr__57993.cljs$core$IFn$_invoke$arity$1(type) : fexpr__57993.call(null,type));
})())){
} else {
...
var G__58002 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__58002)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__58002)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__58002)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__58002)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__58002)].join('')));
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__58013){
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__58020 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq58006){
var G__58011 = cljs.core.first(seq58006);
var seq58006__$1 = cljs.core.next(seq58006);
var G__58012 = cljs.core.first(seq58006__$1);
var seq58006__$2 = cljs.core.next(seq58006__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__58011,G__58012,seq58006__$2);
}));
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__58024){
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__58027 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__58027) : instaparse.reduction.node_builders.call(null,G__58027));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq58021){
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k58029,else__4442__auto__){
var self__ = this;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__58035){
var vec__58036 = p__58035;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58036,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58036,(1),null);
...
(instaparse.core.Parser.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__58028){
var self__ = this;
...
var h__4297__auto____$1 = (function (){var fexpr__58039 = (function (coll__4436__auto__){
return (-360509877 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__58039(this__4435__auto____$1);
})();
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this58030,other58031){
var self__ = this;
var this58030__$1 = this;
return (((!((other58031 == null)))) && ((this58030__$1.constructor === other58031.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this58030__$1.grammar,other58031.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this58030__$1.start_production,other58031.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this58030__$1.output_format,other58031.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this58030__$1.__extmap,other58031.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__58028){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__58040 = cljs.core.keyword_identical_QMARK_;
var expr__58041 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__58043 = new cljs.core.Keyword(null,"grammar","grammar",1881328267);
...
return (new instaparse.core.Parser(G__58028,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__58045 = new cljs.core.Keyword(null,"start-production","start-production",687546537);
...
return (new instaparse.core.Parser(self__.grammar,G__58028,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__58047 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676);
...
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__58028,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__58028),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__58028){
var self__ = this;
var this__4438__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__58028,self__.__extmap,self__.__hash));
}));
...
var self__ = this;
var self__ = this;
var G__58049 = (arguments.length - (1));
switch (G__58049) {
case (1):
...
(instaparse.core.Parser.prototype.apply = (function (self__,args58033){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args58033)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__58032){
var extmap__4478__auto__ = (function (){var G__58050 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__58032,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
...
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__58032),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__58032),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__58032),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
(instaparse.core.parser.cljs$core$IFn$_invoke$arity$variadic = (function (grammar_specification,p__58053){
...
var _STAR_case_insensitive_literals_STAR__orig_val__58056 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__58057 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(options,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__58057);

try{var G__58058 = input_format;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__58058__$1)].join('')));

}
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__58056);
}});
...
var map__58059 = temp__5733__auto__;
...
var ws_grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58059__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var ws_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58059__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
...
/** @this {Function} */
(instaparse.core.parser.cljs$lang$applyTo = (function (seq58051){
