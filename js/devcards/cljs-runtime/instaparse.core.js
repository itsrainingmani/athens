...
var G__56698 = (i__4737__auto___56697 + (1));
i__4737__auto___56697 = G__56698;
continue;
} else {
}
break;
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__56615 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__56615) : instaparse.reduction.node_builders.call(null,G__56615));
})());
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__56647){
var vec__56649 = p__56647;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56649,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56649,(1),null);
...
var pred__56668 = cljs.core.keyword_identical_QMARK_;
var expr__56669 = k__4388__auto__;
if(cljs.core.truth_((pred__56668.cljs$core$IFn$_invoke$arity$2 ? pred__56668.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"grammar","grammar",1881328267),expr__56669) : pred__56668.call(null,new cljs.core.Keyword(null,"grammar","grammar",1881328267),expr__56669)))){
...
if(cljs.core.truth_((pred__56668.cljs$core$IFn$_invoke$arity$2 ? pred__56668.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"start-production","start-production",687546537),expr__56669) : pred__56668.call(null,new cljs.core.Keyword(null,"start-production","start-production",687546537),expr__56669)))){
return (new instaparse.core.Parser(self__.grammar,G__56628,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__56668.cljs$core$IFn$_invoke$arity$2 ? pred__56668.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"output-format","output-format",-1826382676),expr__56669) : pred__56668.call(null,new cljs.core.Keyword(null,"output-format","output-format",-1826382676),expr__56669)))){
...
var self__ = this;
var self__ = this;
var G__56675 = (arguments.length - (1));
switch (G__56675) {
case (1):
...
(instaparse.core.Parser.prototype.apply = (function (self__,args56635){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args56635)));
}));
...
var i__4737__auto___56793 = (0);
while(true){
if((i__4737__auto___56793 < len__4736__auto___56788)){
args__4742__auto__.push((arguments[i__4737__auto___56793]));

var G__56797 = (i__4737__auto___56793 + (1));
i__4737__auto___56793 = G__56797;
continue;
} else {
}
break;
