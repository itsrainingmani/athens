...
if(cljs.core.truth_((function (){var fexpr__56631 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__56631.cljs$core$IFn$_invoke$arity$1 ? fexpr__56631.cljs$core$IFn$_invoke$arity$1(type) : fexpr__56631.call(null,type));
})())){
} else {
...
if(cljs.core.truth_((function (){var fexpr__56633 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__56652){
...
var args__4742__auto__ = [];
var len__4736__auto___56727 = arguments.length;
var i__4737__auto___56728 = (0);
while(true){
if((i__4737__auto___56728 < len__4736__auto___56727)){
args__4742__auto__.push((arguments[i__4737__auto___56728]));

var G__56729 = (i__4737__auto___56728 + (1));
i__4737__auto___56728 = G__56729;
continue;
} else {
}
break;
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__56674){
var map__56675 = p__56674;
var map__56675__$1 = (((((!((map__56675 == null))))?(((((map__56675.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__56675.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__56675):map__56675);
var options = map__56675__$1;
if(cljs.core.contains_QMARK_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, [null,null,new cljs.core.Keyword(null,"tags","tags",1771418977),null,new cljs.core.Keyword(null,"content","content",15833224),null,new cljs.core.Keyword(null,"all","all",892129742),null], null), null),cljs.core.get.cljs$core$IFn$_invoke$arity$2(options,new cljs.core.Keyword(null,"unhide","unhide",-413983695)))){
} else {
throw (new Error("Assert failed: (contains? #{nil :tags :content :all} (get options :unhide))"));
}
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__56677 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__56677) : instaparse.reduction.node_builders.call(null,G__56677));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq56664){
var G__56665 = cljs.core.first(seq56664);
var seq56664__$1 = cljs.core.next(seq56664);
var G__56666 = cljs.core.first(seq56664__$1);
var seq56664__$2 = cljs.core.next(seq56664__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56665,G__56666,seq56664__$2);
}));
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k56687,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k56687,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__56693){
var vec__56694 = p__56693;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56694,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56694,(1),null);
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this56688,other56689){
var self__ = this;
var this56688__$1 = this;
return (((!((other56689 == null)))) && ((this56688__$1.constructor === other56689.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56688__$1.grammar,other56689.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56688__$1.start_production,other56689.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56688__$1.output_format,other56689.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56688__$1.__extmap,other56689.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__56686){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__56697 = cljs.core.keyword_identical_QMARK_;
var expr__56698 = k__4388__auto__;
if(cljs.core.truth_((pred__56697.cljs$core$IFn$_invoke$arity$2 ? pred__56697.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"grammar","grammar",1881328267),expr__56698) : pred__56697.call(null,new cljs.core.Keyword(null,"grammar","grammar",1881328267),expr__56698)))){
return (new instaparse.core.Parser(G__56686,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__56697.cljs$core$IFn$_invoke$arity$2 ? pred__56697.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"start-production","start-production",687546537),expr__56698) : pred__56697.call(null,new cljs.core.Keyword(null,"start-production","start-production",687546537),expr__56698)))){
return (new instaparse.core.Parser(self__.grammar,G__56686,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__56697.cljs$core$IFn$_invoke$arity$2 ? pred__56697.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"output-format","output-format",-1826382676),expr__56698) : pred__56697.call(null,new cljs.core.Keyword(null,"output-format","output-format",-1826382676),expr__56698)))){
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__56686,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__56686),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__56686){
var self__ = this;
var this__4379__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__56686,self__.__extmap,self__.__hash));
}));
...
var self__ = this;
var self__ = this;
var G__56700 = (arguments.length - (1));
switch (G__56700) {
case (1):
...
(instaparse.core.Parser.prototype.apply = (function (self__,args56691){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args56691)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__56690){
var extmap__4419__auto__ = (function (){var G__56701 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__56690,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
if(cljs.core.record_QMARK_(G__56690)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__56701);
} else {
return G__56701;
}
})();
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__56690),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__56690),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__56690),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
var args__4742__auto__ = [];
var len__4736__auto___56798 = arguments.length;
var i__4737__auto___56799 = (0);
while(true){
if((i__4737__auto___56799 < len__4736__auto___56798)){
args__4742__auto__.push((arguments[i__4737__auto___56799]));

var G__56800 = (i__4737__auto___56799 + (1));
i__4737__auto___56799 = G__56800;
continue;
} else {
}
break;
...
(instaparse.core.parser.cljs$core$IFn$_invoke$arity$variadic = (function (grammar_specification,p__56704){
...
var _STAR_case_insensitive_literals_STAR__orig_val__56707 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__56708 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(options,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__56708);

try{var G__56709 = input_format;
var G__56709__$1 = (((G__56709 instanceof cljs.core.Keyword))?G__56709.fqn:null);
switch (G__56709__$1) {
case "abnf":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__56709__$1)].join('')));

}
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__56707);
}});
...
var map__56710 = temp__5733__auto__;
...
var ws_grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56710__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var ws_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56710__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
...
/** @this {Function} */
(instaparse.core.parser.cljs$lang$applyTo = (function (seq56702){
var G__56703 = cljs.core.first(seq56702);
var seq56702__$1 = cljs.core.next(seq56702);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56703,seq56702__$1);
}));
