...
if(cljs.core.truth_((function (){var fexpr__79424 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__79424.cljs$core$IFn$_invoke$arity$1 ? fexpr__79424.cljs$core$IFn$_invoke$arity$1(type) : fexpr__79424.call(null,type));
})())){
} else {
...
if(cljs.core.truth_((function (){var fexpr__79425 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__79425.cljs$core$IFn$_invoke$arity$1 ? fexpr__79425.cljs$core$IFn$_invoke$arity$1(type) : fexpr__79425.call(null,type));
})())){
} else {
...
var G__79426 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__79426)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__79426)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__79426)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__79426)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__79426)].join('')));
...
var len__4789__auto___79518 = arguments.length;
var i__4790__auto___79519 = (0);
while(true){
if((i__4790__auto___79519 < len__4789__auto___79518)){
args__4795__auto__.push((arguments[i__4790__auto___79519]));

var G__79520 = (i__4790__auto___79519 + (1));
i__4790__auto___79519 = G__79520;
continue;
} else {
}
break;
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__79430){
var map__79431 = p__79430;
var map__79431__$1 = (((((!((map__79431 == null))))?(((((map__79431.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__79431.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__79431):map__79431);
var options = map__79431__$1;
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__79433 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__79433) : instaparse.reduction.node_builders.call(null,G__79433));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq79427){
var G__79428 = cljs.core.first(seq79427);
var seq79427__$1 = cljs.core.next(seq79427);
var G__79429 = cljs.core.first(seq79427__$1);
var seq79427__$2 = cljs.core.next(seq79427__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__79428,G__79429,seq79427__$2);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___79527 = arguments.length;
var i__4790__auto___79528 = (0);
while(true){
if((i__4790__auto___79528 < len__4789__auto___79527)){
args__4795__auto__.push((arguments[i__4790__auto___79528]));

var G__79529 = (i__4790__auto___79528 + (1));
i__4790__auto___79528 = G__79529;
continue;
} else {
}
break;
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__79437){
var map__79438 = p__79437;
var map__79438__$1 = (((((!((map__79438 == null))))?(((((map__79438.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__79438.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__79438):map__79438);
var options = map__79438__$1;
if(cljs.core.contains_QMARK_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, [null,null,new cljs.core.Keyword(null,"tags","tags",1771418977),null,new cljs.core.Keyword(null,"content","content",15833224),null,new cljs.core.Keyword(null,"all","all",892129742),null], null), null),cljs.core.get.cljs$core$IFn$_invoke$arity$2(options,new cljs.core.Keyword(null,"unhide","unhide",-413983695)))){
} else {
throw (new Error("Assert failed: (contains? #{nil :tags :content :all} (get options :unhide))"));
}
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__79440 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__79440) : instaparse.reduction.node_builders.call(null,G__79440));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq79434){
var G__79435 = cljs.core.first(seq79434);
var seq79434__$1 = cljs.core.next(seq79434);
var G__79436 = cljs.core.first(seq79434__$1);
var seq79434__$2 = cljs.core.next(seq79434__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__79435,G__79436,seq79434__$2);
}));
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k79442,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k79442,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__79448){
var vec__79449 = p__79448;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79449,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79449,(1),null);
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this79443,other79444){
var self__ = this;
var this79443__$1 = this;
return (((!((other79444 == null)))) && ((this79443__$1.constructor === other79444.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this79443__$1.grammar,other79444.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this79443__$1.start_production,other79444.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this79443__$1.output_format,other79444.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this79443__$1.__extmap,other79444.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__79441){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__79459 = cljs.core.keyword_identical_QMARK_;
var expr__79460 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__79463 = new cljs.core.Keyword(null,"grammar","grammar",1881328267);
var G__79464 = expr__79460;
return (pred__79459.cljs$core$IFn$_invoke$arity$2 ? pred__79459.cljs$core$IFn$_invoke$arity$2(G__79463,G__79464) : pred__79459.call(null,G__79463,G__79464));
})())){
return (new instaparse.core.Parser(G__79441,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__79465 = new cljs.core.Keyword(null,"start-production","start-production",687546537);
var G__79466 = expr__79460;
return (pred__79459.cljs$core$IFn$_invoke$arity$2 ? pred__79459.cljs$core$IFn$_invoke$arity$2(G__79465,G__79466) : pred__79459.call(null,G__79465,G__79466));
})())){
return (new instaparse.core.Parser(self__.grammar,G__79441,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__79467 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676);
var G__79468 = expr__79460;
return (pred__79459.cljs$core$IFn$_invoke$arity$2 ? pred__79459.cljs$core$IFn$_invoke$arity$2(G__79467,G__79468) : pred__79459.call(null,G__79467,G__79468));
})())){
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__79441,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__79441),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__79441){
var self__ = this;
var this__4438__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__79441,self__.__extmap,self__.__hash));
}));
...
var self__ = this;
var self__ = this;
var G__79469 = (arguments.length - (1));
switch (G__79469) {
case (1):
...
(instaparse.core.Parser.prototype.apply = (function (self__,args79446){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args79446)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__79445){
var extmap__4478__auto__ = (function (){var G__79507 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__79445,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
if(cljs.core.record_QMARK_(G__79445)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__79507);
} else {
return G__79507;
}
})();
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__79445),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__79445),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__79445),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var args__4795__auto__ = [];
var len__4789__auto___79573 = arguments.length;
var i__4790__auto___79574 = (0);
while(true){
if((i__4790__auto___79574 < len__4789__auto___79573)){
args__4795__auto__.push((arguments[i__4790__auto___79574]));

var G__79575 = (i__4790__auto___79574 + (1));
i__4790__auto___79574 = G__79575;
continue;
} else {
}
break;
...
(instaparse.core.parser.cljs$core$IFn$_invoke$arity$variadic = (function (grammar_specification,p__79510){
var map__79511 = p__79510;
var map__79511__$1 = (((((!((map__79511 == null))))?(((((map__79511.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__79511.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__79511):map__79511);
var options = map__79511__$1;
...
var _STAR_case_insensitive_literals_STAR__orig_val__79513 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__79514 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(options,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__79514);

try{var G__79515 = input_format;
var G__79515__$1 = (((G__79515 instanceof cljs.core.Keyword))?G__79515.fqn:null);
switch (G__79515__$1) {
case "abnf":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__79515__$1)].join('')));

}
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__79513);
}});
...
var ws_grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__79516__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var ws_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__79516__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
...
/** @this {Function} */
(instaparse.core.parser.cljs$lang$applyTo = (function (seq79508){
var G__79509 = cljs.core.first(seq79508);
var seq79508__$1 = cljs.core.next(seq79508);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__79509,seq79508__$1);
}));
