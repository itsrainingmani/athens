...
if(cljs.core.truth_((function (){var fexpr__56642 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__56642.cljs$core$IFn$_invoke$arity$1 ? fexpr__56642.cljs$core$IFn$_invoke$arity$1(type) : fexpr__56642.call(null,type));
})())){
} else {
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__56663){
var map__56664 = p__56663;
var map__56664__$1 = (((((!((map__56664 == null))))?(((((map__56664.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__56664.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__56664):map__56664);
var options = map__56664__$1;
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__56670 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__56670) : instaparse.reduction.node_builders.call(null,G__56670));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq56657){
var G__56658 = cljs.core.first(seq56657);
var seq56657__$1 = cljs.core.next(seq56657);
var G__56659 = cljs.core.first(seq56657__$1);
var seq56657__$2 = cljs.core.next(seq56657__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56658,G__56659,seq56657__$2);
}));
...
var G__56719 = (i__4737__auto___56718 + (1));
i__4737__auto___56718 = G__56719;
continue;
} else {
}
break;
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__56678){
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__56681 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__56681) : instaparse.reduction.node_builders.call(null,G__56681));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq56675){
var G__56676 = cljs.core.first(seq56675);
var seq56675__$1 = cljs.core.next(seq56675);
var G__56677 = cljs.core.first(seq56675__$1);
var seq56675__$2 = cljs.core.next(seq56675__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56676,G__56677,seq56675__$2);
}));
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k56683,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k56683,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__56689){
var vec__56690 = p__56689;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56690,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56690,(1),null);
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this56684,other56685){
var self__ = this;
var this56684__$1 = this;
return (((!((other56685 == null)))) && ((this56684__$1.constructor === other56685.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56684__$1.grammar,other56685.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56684__$1.start_production,other56685.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56684__$1.output_format,other56685.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56684__$1.__extmap,other56685.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__56682){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__56693 = cljs.core.keyword_identical_QMARK_;
var expr__56694 = k__4388__auto__;
if(cljs.core.truth_((pred__56693.cljs$core$IFn$_invoke$arity$2 ? pred__56693.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"grammar","grammar",1881328267),expr__56694) : pred__56693.call(null,new cljs.core.Keyword(null,"grammar","grammar",1881328267),expr__56694)))){
return (new instaparse.core.Parser(G__56682,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__56693.cljs$core$IFn$_invoke$arity$2 ? pred__56693.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"start-production","start-production",687546537),expr__56694) : pred__56693.call(null,new cljs.core.Keyword(null,"start-production","start-production",687546537),expr__56694)))){
return (new instaparse.core.Parser(self__.grammar,G__56682,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__56693.cljs$core$IFn$_invoke$arity$2 ? pred__56693.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"output-format","output-format",-1826382676),expr__56694) : pred__56693.call(null,new cljs.core.Keyword(null,"output-format","output-format",-1826382676),expr__56694)))){
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__56682,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__56682),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__56682){
var self__ = this;
var this__4379__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__56682,self__.__extmap,self__.__hash));
}));
...
var self__ = this;
var self__ = this;
var G__56696 = (arguments.length - (1));
switch (G__56696) {
case (1):
...
(instaparse.core.Parser.prototype.apply = (function (self__,args56687){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args56687)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__56686){
var extmap__4419__auto__ = (function (){var G__56697 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__56686,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
if(cljs.core.record_QMARK_(G__56686)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__56697);
} else {
return G__56697;
}
})();
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__56686),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__56686),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__56686),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
var i__4737__auto___56788 = (0);
while(true){
if((i__4737__auto___56788 < len__4736__auto___56784)){
args__4742__auto__.push((arguments[i__4737__auto___56788]));

var G__56790 = (i__4737__auto___56788 + (1));
i__4737__auto___56788 = G__56790;
continue;
} else {
}
break;
...
(instaparse.core.parser.cljs$core$IFn$_invoke$arity$variadic = (function (grammar_specification,p__56700){
...
var _STAR_case_insensitive_literals_STAR__orig_val__56703 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__56704 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(options,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__56704);

try{var G__56705 = input_format;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__56705__$1)].join('')));

}
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__56703);
}});
...
var map__56706 = temp__5733__auto__;
...
var ws_grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56706__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var ws_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56706__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
...
/** @this {Function} */
(instaparse.core.parser.cljs$lang$applyTo = (function (seq56698){
var G__56699 = cljs.core.first(seq56698);
var seq56698__$1 = cljs.core.next(seq56698);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56699,seq56698__$1);
}));
