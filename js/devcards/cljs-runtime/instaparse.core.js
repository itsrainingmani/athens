...
if(cljs.core.truth_((function (){var fexpr__56621 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
...
if(cljs.core.truth_((function (){var fexpr__56622 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
...
var G__56715 = (i__4737__auto___56713 + (1));
i__4737__auto___56713 = G__56715;
continue;
} else {
}
break;
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__56627){
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__56630 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__56630) : instaparse.reduction.node_builders.call(null,G__56630));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq56624){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56625,G__56626,seq56624__$2);
}));
...
while(true){
if((i__4737__auto___56722 < len__4736__auto___56720)){
args__4742__auto__.push((arguments[i__4737__auto___56722]));

var G__56724 = (i__4737__auto___56722 + (1));
i__4737__auto___56722 = G__56724;
continue;
} else {
}
break;
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__56640 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__56640) : instaparse.reduction.node_builders.call(null,G__56640));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq56631){
var G__56632 = cljs.core.first(seq56631);
var seq56631__$1 = cljs.core.next(seq56631);
var G__56633 = cljs.core.first(seq56631__$1);
var seq56631__$2 = cljs.core.next(seq56631__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56632,G__56633,seq56631__$2);
}));
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k56643,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k56643,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__56652){
var vec__56653 = p__56652;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56653,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56653,(1),null);
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this56644,other56645){
var self__ = this;
var this56644__$1 = this;
return (((!((other56645 == null)))) && ((this56644__$1.constructor === other56645.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56644__$1.grammar,other56645.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56644__$1.start_production,other56645.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56644__$1.output_format,other56645.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56644__$1.__extmap,other56645.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__56642){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__56672 = cljs.core.keyword_identical_QMARK_;
var expr__56673 = k__4388__auto__;
if(cljs.core.truth_((pred__56672.cljs$core$IFn$_invoke$arity$2 ? pred__56672.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"grammar","grammar",1881328267),expr__56673) : pred__56672.call(null,new cljs.core.Keyword(null,"grammar","grammar",1881328267),expr__56673)))){
return (new instaparse.core.Parser(G__56642,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__56672.cljs$core$IFn$_invoke$arity$2 ? pred__56672.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"start-production","start-production",687546537),expr__56673) : pred__56672.call(null,new cljs.core.Keyword(null,"start-production","start-production",687546537),expr__56673)))){
return (new instaparse.core.Parser(self__.grammar,G__56642,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__56672.cljs$core$IFn$_invoke$arity$2 ? pred__56672.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"output-format","output-format",-1826382676),expr__56673) : pred__56672.call(null,new cljs.core.Keyword(null,"output-format","output-format",-1826382676),expr__56673)))){
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__56642,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__56642),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__56642){
var self__ = this;
var this__4379__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__56642,self__.__extmap,self__.__hash));
}));
...
var self__ = this;
var self__ = this;
var G__56682 = (arguments.length - (1));
switch (G__56682) {
case (1):
...
(instaparse.core.Parser.prototype.apply = (function (self__,args56649){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args56649)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__56646){
var extmap__4419__auto__ = (function (){var G__56697 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__56646,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
if(cljs.core.record_QMARK_(G__56646)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__56697);
} else {
return G__56697;
}
})();
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__56646),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__56646),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__56646),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
var G__56794 = (i__4737__auto___56790 + (1));
i__4737__auto___56790 = G__56794;
continue;
} else {
}
break;
