...
if((x instanceof cljs.core.Keyword)){
var G__52829 = spec;
var G__52830 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__52829,G__52830) : f.call(null,G__52829,G__52830));
} else {
return x;
...
}catch (e52835){if((e52835 instanceof Error)){
var ___$1 = e52835;
return x;
} else {
throw e52835;
...
spec_tools.transform.strip_extra_keys = (function spec_tools$transform$strip_extra_keys(p__52836,x){
...
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52837__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.fail_on_extra_keys = (function spec_tools$transform$fail_on_extra_keys(p__52839,x){
...
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52840__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.strip_extra_values = (function spec_tools$transform$strip_extra_values(p__52842,x){
...
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52843__$1,new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600));
