...
if((x instanceof cljs.core.Keyword)){
var G__51840 = spec;
var G__51841 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__51840,G__51841) : f.call(null,G__51840,G__51841));
} else {
if(typeof x === 'string'){
...
if((x instanceof cljs.core.Keyword)){
var G__51842 = spec;
var G__51843 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__51842,G__51843) : f.call(null,G__51842,G__51843));
} else {
return x;
...
}catch (e51844){if((e51844 instanceof Error)){
var ___$1 = e51844;
return x;
} else {
throw e51844;
...
}catch (e51845){if((e51845 instanceof Error)){
var ___$1 = e51845;
return x;
} else {
throw e51845;
...
}catch (e51846){if((e51846 instanceof Error)){
var ___$1 = e51846;
return x;
} else {
throw e51846;
...
spec_tools.transform.strip_extra_keys = (function spec_tools$transform$strip_extra_keys(p__51849,x){
...
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51850__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.fail_on_extra_keys = (function spec_tools$transform$fail_on_extra_keys(p__51852,x){
...
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51853__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.strip_extra_values = (function spec_tools$transform$strip_extra_values(p__51855,x){
...
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51856__$1,new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600));
