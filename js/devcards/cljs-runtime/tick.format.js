...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__50875 = goog.object.get(JSJodaLocale,"Locale");
if((G__50875 == null)){
return null;
} else {
return goog.object.get(G__50875,"US");
}
