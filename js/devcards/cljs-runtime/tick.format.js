...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__50879 = goog.object.get(JSJodaLocale,"Locale");
if((G__50879 == null)){
return null;
} else {
return goog.object.get(G__50879,"US");
}
}catch (e50878){if((e50878 instanceof Error)){
var e = e50878;
return null;
} else {
throw e50878;
