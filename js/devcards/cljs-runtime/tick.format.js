...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__72743 = goog.object.get(JSJodaLocale,"Locale");
if((G__72743 == null)){
return null;
} else {
return goog.object.get(G__72743,"US");
}
}catch (e72742){if((e72742 instanceof Error)){
var e = e72742;
return null;
} else {
throw e72742;
