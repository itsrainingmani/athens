...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__26170 = goog.object.get(JSJodaLocale,"Locale");
if((G__26170 == null)){
return null;
} else {
return goog.object.get(G__26170,"US");
}
