...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__51175 = goog.object.get(JSJodaLocale,"Locale");
if((G__51175 == null)){
return null;
} else {
return goog.object.get(G__51175,"US");
}
}catch (e51172){if((e51172 instanceof Error)){
var e = e51172;
return null;
} else {
throw e51172;
