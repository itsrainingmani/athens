...
var re_frame$router$IEventQueue$push$dyn_51128 = (function (this$,event){
...
return re_frame$router$IEventQueue$push$dyn_51128(this$,event);
}
});
...
var re_frame$router$IEventQueue$remove_post_event_callback$dyn_51133 = (function (this$,f){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$remove_post_event_callback$dyn_51133(this$,f);
}
});
...
var re_frame$router$IEventQueue$_add_event$dyn_51139 = (function (this$,event){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$_add_event$dyn_51139(this$,event);
}
});
...
var re_frame$router$IEventQueue$_run_next_tick$dyn_51145 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$_run_next_tick$dyn_51145(this$);
}
});
...
var re_frame$router$IEventQueue$_pause$dyn_51151 = (function (this$,later_fn){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$_pause$dyn_51151(this$,later_fn);
}
});

var re_frame$router$IEventQueue$_resume$dyn_51153 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$_resume$dyn_51153(this$);
}
});

var re_frame$router$IEventQueue$_call_post_event_callbacks$dyn_51155 = (function (this$,event){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$_call_post_event_callbacks$dyn_51155(this$,event);
}
});
...
try{try{var vec__51071 = (function (){var G__51074 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [self__.fsm_state,trigger], null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"idle","idle",-2007156861),new cljs.core.Keyword(null,"add-event","add-event",938429088)], null),G__51074)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"running","running",1554969103),new cljs.core.Keyword(null,"exception","exception",-335277064)], null),G__51074)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"running","running",1554969103),new cljs.core.Keyword(null,"finish-run","finish-run",753148477)], null),G__51074)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"running","running",1554969103),new cljs.core.Keyword(null,"pause","pause",-2095325672)], null),G__51074)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"paused","paused",-1710376127),new cljs.core.Keyword(null,"resume","resume",-118572261)], null),G__51074)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"scheduled","scheduled",553898551),new cljs.core.Keyword(null,"run-queue","run-queue",-1701798027)], null),G__51074)){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"running","running",1554969103),(function (){
return this$__$1.re_frame$router$IEventQueue$_run_queue$arity$1(null);
})], null);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"paused","paused",-1710376127),new cljs.core.Keyword(null,"add-event","add-event",938429088)], null),G__51074)){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"paused","paused",-1710376127),(function (){
return this$__$1.re_frame$router$IEventQueue$_add_event$arity$2(null,arg);
})], null);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"running","running",1554969103),new cljs.core.Keyword(null,"add-event","add-event",938429088)], null),G__51074)){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"running","running",1554969103),(function (){
return this$__$1.re_frame$router$IEventQueue$_add_event$arity$2(null,arg);
})], null);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"scheduled","scheduled",553898551),new cljs.core.Keyword(null,"add-event","add-event",938429088)], null),G__51074)){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"scheduled","scheduled",553898551),(function (){
return this$__$1.re_frame$router$IEventQueue$_add_event$arity$2(null,arg);
})], null);
} else {
...
var end__50204__auto___51169 = re_frame.interop.now();
var duration__50205__auto___51170 = (end__50204__auto___51169 - new cljs.core.Keyword(null,"start","start",-355208981).cljs$core$IFn$_invoke$arity$1(re_frame.trace._STAR_current_trace_STAR_));
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$3(re_frame.trace.traces,cljs.core.conj,cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(re_frame.trace._STAR_current_trace_STAR_,new cljs.core.Keyword(null,"duration","duration",1444101068),duration__50205__auto___51170,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"end","end",-268185958),re_frame.interop.now()], 0)));

re_frame.trace.run_tracing_callbacks_BANG_(end__50204__auto___51169);
} else {
}
...
if(re_frame.trace.is_trace_enabled_QMARK_()){
var new_trace__50206__auto___51176 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.update.cljs$core$IFn$_invoke$arity$4(re_frame.trace._STAR_current_trace_STAR_,new cljs.core.Keyword(null,"tags","tags",1771418977),cljs.core.merge,new cljs.core.Keyword(null,"tags","tags",1771418977).cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"operation","operation",-1267664310),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [self__.fsm_state,trigger], null),new cljs.core.Keyword(null,"tags","tags",1771418977),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"current-state","current-state",1048284452),self__.fsm_state,new cljs.core.Keyword(null,"new-state","new-state",-490349212),new_fsm_state], null)], null))),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"operation","operation",-1267664310),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [self__.fsm_state,trigger], null),new cljs.core.Keyword(null,"tags","tags",1771418977),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"current-state","current-state",1048284452),self__.fsm_state,new cljs.core.Keyword(null,"new-state","new-state",-490349212),new_fsm_state], null)], null),new cljs.core.Keyword(null,"tags","tags",1771418977))], 0));
(re_frame.trace._STAR_current_trace_STAR_ = new_trace__50206__auto___51176);
...
var self__ = this;
var ___$1 = this;
var seq__51093 = cljs.core.seq(cljs.core.vals(self__.post_event_callback_fns));
var chunk__51094 = null;
var count__51095 = (0);
var i__51096 = (0);
while(true){
if((i__51096 < count__51095)){
var callback = chunk__51094.cljs$core$IIndexed$_nth$arity$2(null,i__51096);
...
var G__51178 = seq__51093;
var G__51179 = chunk__51094;
var G__51180 = count__51095;
var G__51181 = (i__51096 + (1));
seq__51093 = G__51178;
chunk__51094 = G__51179;
count__51095 = G__51180;
i__51096 = G__51181;
continue;
} else {
...
var G__51184 = cljs.core.chunk_rest(seq__51093__$1);
var G__51185 = c__4556__auto__;
var G__51186 = cljs.core.count(c__4556__auto__);
var G__51187 = (0);
seq__51093 = G__51184;
chunk__51094 = G__51185;
count__51095 = G__51186;
i__51096 = G__51187;
continue;
} else {
var callback = cljs.core.first(seq__51093__$1);
(callback.cljs$core$IFn$_invoke$arity$2 ? callback.cljs$core$IFn$_invoke$arity$2(event_v,self__.queue) : callback.call(null,event_v,self__.queue));


var G__51188 = cljs.core.next(seq__51093__$1);
var G__51189 = null;
var G__51190 = (0);
var G__51191 = (0);
seq__51093 = G__51188;
chunk__51094 = G__51189;
count__51095 = G__51190;
i__51096 = G__51191;
continue;
}
} else {
