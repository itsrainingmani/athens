...
var G__78858 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__78858)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__78858)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__78858)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__78858)].join('')));
...
var G__78905 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__78906 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__78905;
v = G__78906;
continue;
} else {
var G__78907 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__78908 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__78907;
v = G__78908;
continue;
}
...
break;
case "\"":
var G__78909 = cljs.core.next(sq);
var G__78910 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__78909;
v = G__78910;
continue;
...
break;
default:
var G__78911 = cljs.core.next(sq);
var G__78912 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__78911;
v = G__78912;
continue;
...
while(true){
var G__78868 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__78868__$1 = (((G__78868 instanceof cljs.core.Keyword))?G__78868.fqn:null);
switch (G__78868__$1) {
case "rule":
var vec__78869 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78869,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78869,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__78872 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__78872) : instaparse.cfg.content.call(null,G__78872));
...
break;
case "paren":
var G__78915 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__78915;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__78873 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__78873) : instaparse.cfg.build_rule.call(null,G__78873));
})());
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__78874 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__78874) : instaparse.cfg.build_rule.call(null,G__78874));
})());

break;
case "star":
return instaparse.combinators_source.star((function (){var G__78875 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__78875) : instaparse.cfg.build_rule.call(null,G__78875));
})());

break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__78876 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__78876) : instaparse.cfg.build_rule.call(null,G__78876));
})());

break;
case "look":
return instaparse.combinators_source.look((function (){var G__78877 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__78877) : instaparse.cfg.build_rule.call(null,G__78877));
})());

break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__78878 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__78878) : instaparse.cfg.build_rule.call(null,G__78878));
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__78868__$1)].join('')));
...
while(true){
var G__78879 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
var G__78879__$1 = (((G__78879 instanceof cljs.core.Keyword))?G__78879.fqn:null);
switch (G__78879__$1) {
case "nt":
...
case "neg":
case "rep":
var G__78917 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__78917;
continue;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__78879__$1)].join('')));
...
var valid_nts_78918 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__78880_78919 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__78881_78920 = null;
var count__78882_78921 = (0);
var i__78883_78922 = (0);
while(true){
if((i__78883_78922 < count__78882_78921)){
var nt_78923 = chunk__78881_78920.cljs$core$IIndexed$_nth$arity$2(null,i__78883_78922);
if(cljs.core.truth_((valid_nts_78918.cljs$core$IFn$_invoke$arity$1 ? valid_nts_78918.cljs$core$IFn$_invoke$arity$1(nt_78923) : valid_nts_78918.call(null,nt_78923)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_78923),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__78924 = seq__78880_78919;
var G__78925 = chunk__78881_78920;
var G__78926 = count__78882_78921;
var G__78927 = (i__78883_78922 + (1));
seq__78880_78919 = G__78924;
chunk__78881_78920 = G__78925;
count__78882_78921 = G__78926;
i__78883_78922 = G__78927;
continue;
} else {
var temp__5735__auto___78928 = cljs.core.seq(seq__78880_78919);
if(temp__5735__auto___78928){
var seq__78880_78929__$1 = temp__5735__auto___78928;
if(cljs.core.chunked_seq_QMARK_(seq__78880_78929__$1)){
var c__4609__auto___78930 = cljs.core.chunk_first(seq__78880_78929__$1);
var G__78931 = cljs.core.chunk_rest(seq__78880_78929__$1);
var G__78932 = c__4609__auto___78930;
var G__78933 = cljs.core.count(c__4609__auto___78930);
var G__78934 = (0);
seq__78880_78919 = G__78931;
chunk__78881_78920 = G__78932;
count__78882_78921 = G__78933;
i__78883_78922 = G__78934;
continue;
} else {
var nt_78935 = cljs.core.first(seq__78880_78929__$1);
if(cljs.core.truth_((valid_nts_78918.cljs$core$IFn$_invoke$arity$1 ? valid_nts_78918.cljs$core$IFn$_invoke$arity$1(nt_78935) : valid_nts_78918.call(null,nt_78935)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_78935),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__78936 = cljs.core.next(seq__78880_78929__$1);
var G__78937 = null;
var G__78938 = (0);
var G__78939 = (0);
seq__78880_78919 = G__78936;
chunk__78881_78920 = G__78937;
count__78882_78921 = G__78938;
i__78883_78922 = G__78939;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__78884_78940 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__78885_78941 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__78886_78942 = true;
var _STAR_print_fn_STAR__temp_val__78887_78943 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__78886_78942);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__78887_78943);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__78885_78941);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__78884_78940);
}
...
var len__4789__auto___78944 = arguments.length;
var i__4790__auto___78945 = (0);
while(true){
if((i__4790__auto___78945 < len__4789__auto___78944)){
args__4795__auto__.push((arguments[i__4790__auto___78945]));

var G__78946 = (i__4790__auto___78945 + (1));
i__4790__auto___78945 = G__78946;
continue;
} else {
}
break;
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__78890){
var map__78891 = p__78890;
var map__78891__$1 = (((((!((map__78891 == null))))?(((((map__78891.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__78891.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__78891):map__78891);
var opts = map__78891__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__78893 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__78894 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__78894);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__78895_78947 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__78896_78948 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__78897_78949 = true;
var _STAR_print_fn_STAR__temp_val__78898_78950 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__78897_78949);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__78898_78950);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__78896_78948);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__78895_78947);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__78893);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq78888){
var G__78889 = cljs.core.first(seq78888);
var seq78888__$1 = cljs.core.next(seq78888);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__78889,seq78888__$1);
}));
