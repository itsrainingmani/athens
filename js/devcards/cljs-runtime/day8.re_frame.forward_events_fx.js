...
return (function (p__83031){
var vec__83032 = p__83031;
var event_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__83032,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__83032,(1),null);
...
var G__83035_83044 = new cljs.core.Keyword(null,"forward-events","forward-events",1216790539);
var G__83036_83045 = (function (){var process_one_entry = (function (p__83037){
var map__83038 = p__83037;
var map__83038__$1 = (((((!((map__83038 == null))))?(((((map__83038.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__83038.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__83038):map__83038);
var m = map__83038__$1;
var unregister = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83038__$1,new cljs.core.Keyword(null,"unregister","unregister",2105339971));
var register = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83038__$1,new cljs.core.Keyword(null,"register","register",1968522516));
var events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83038__$1,new cljs.core.Keyword(null,"events","events",1792552201));
var dispatch_to = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83038__$1,new cljs.core.Keyword(null,"dispatch-to","dispatch-to",-354764401));
...
var G__83040 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(dispatch_to,event_v);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__83040) : re_frame.core.dispatch.call(null,G__83040));
} else {
return null;
}
});
...
var G__83041 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__83042 = ":forward-events expected a map or a list of maps, but got: ";
var G__83043 = val;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__83041,G__83042,G__83043) : re_frame.core.console.call(null,G__83041,G__83042,G__83043));

}
}
});
})();
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__83035_83044,G__83036_83045) : re_frame.core.reg_fx.call(null,G__83035_83044,G__83036_83045));
