...
stylefy.impl.styles.create_style_BANG_ = (function stylefy$impl$styles$create_style_BANG_(p__44296,style_created_handler){
...
var style = map__44299__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44299__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44299__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var style_css = stylefy.impl.conversion.style__GT_css.cljs$core$IFn$_invoke$arity$1(style);
var G__44302_44387 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"css","css",1135045163),style_css,new cljs.core.Keyword(null,"hash","hash",-13781596),hash], null);
(style_created_handler.cljs$core$IFn$_invoke$arity$1 ? style_created_handler.cljs$core$IFn$_invoke$arity$1(G__44302_44387) : style_created_handler.call(null,G__44302_44387));

var seq__44303 = cljs.core.seq(cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(props)));
var chunk__44304 = null;
var count__44305 = (0);
var i__44306 = (0);
while(true){
if((i__44306 < count__44305)){
var sub_style = chunk__44304.cljs$core$IIndexed$_nth$arity$2(null,i__44306);
var G__44317_44391 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__44318_44392 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__44317_44391,G__44318_44392) : stylefy.impl.styles.create_style_BANG_.call(null,G__44317_44391,G__44318_44392));


var G__44393 = seq__44303;
var G__44394 = chunk__44304;
var G__44395 = count__44305;
var G__44396 = (i__44306 + (1));
seq__44303 = G__44393;
chunk__44304 = G__44394;
count__44305 = G__44395;
i__44306 = G__44396;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__44303);
if(temp__5735__auto__){
var seq__44303__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__44303__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__44303__$1);
var G__44397 = cljs.core.chunk_rest(seq__44303__$1);
var G__44398 = c__4556__auto__;
var G__44399 = cljs.core.count(c__4556__auto__);
var G__44400 = (0);
seq__44303 = G__44397;
chunk__44304 = G__44398;
count__44305 = G__44399;
i__44306 = G__44400;
continue;
} else {
var sub_style = cljs.core.first(seq__44303__$1);
var G__44322_44403 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__44323_44404 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__44322_44403,G__44323_44404) : stylefy.impl.styles.create_style_BANG_.call(null,G__44322_44403,G__44323_44404));


var G__44405 = cljs.core.next(seq__44303__$1);
var G__44406 = null;
var G__44407 = (0);
var G__44408 = (0);
seq__44303 = G__44405;
chunk__44304 = G__44406;
count__44305 = G__44407;
i__44306 = G__44408;
continue;
}
} else {
...
if((((class$ == null)) || (typeof class$ === 'string') || ((class$ instanceof cljs.core.Keyword)) || (((cljs.core.vector_QMARK_(class$)) && (cljs.core.every_QMARK_((function (p1__44327_SHARP_){
return ((typeof p1__44327_SHARP_ === 'string') || ((p1__44327_SHARP_ instanceof cljs.core.Keyword)) || ((p1__44327_SHARP_ == null)));
}),class$)))))){
return null;
} else {
throw (new Error(["Assert failed: ",["Unsupported ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(origin)," type. It should be nil, keyword, string or vector of strings/keywords). Got: ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([class$], 0))].join(''),"\n","(or (nil? class) (string? class) (keyword? class) (and (vector? class) (every? (fn* [p1__44327#] (or (string? p1__44327#) (keyword? p1__44327#) (nil? p1__44327#))) class)))"].join('')));
}
});
/**
...
var len__4736__auto___44429 = arguments.length;
var i__4737__auto___44430 = (0);
while(true){
if((i__4737__auto___44430 < len__4736__auto___44429)){
args__4742__auto__.push((arguments[i__4737__auto___44430]));

var G__44431 = (i__4737__auto___44430 + (1));
i__4737__auto___44430 = G__44431;
continue;
} else {
}
break;
...
(stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2 = (function (styles,p__44366){
...
var seq__44369_44439 = cljs.core.seq(styles_44438__$1);
var chunk__44370_44440 = null;
var count__44371_44441 = (0);
var i__44372_44442 = (0);
while(true){
if((i__44372_44442 < count__44371_44441)){
var style_44444 = chunk__44370_44440.cljs$core$IIndexed$_nth$arity$2(null,i__44372_44442);
stylefy.impl.styles.use_style_BANG_(style_44444,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___44445 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_44444));
if(cljs.core.truth_(temp__5735__auto___44445)){
var sub_styles_44447 = temp__5735__auto___44445;
...
var G__44449 = seq__44369_44439;
var G__44450 = chunk__44370_44440;
var G__44451 = count__44371_44441;
var G__44452 = (i__44372_44442 + (1));
seq__44369_44439 = G__44449;
chunk__44370_44440 = G__44450;
count__44371_44441 = G__44451;
i__44372_44442 = G__44452;
continue;
} else {
var temp__5735__auto___44453 = cljs.core.seq(seq__44369_44439);
if(temp__5735__auto___44453){
var seq__44369_44454__$1 = temp__5735__auto___44453;
if(cljs.core.chunked_seq_QMARK_(seq__44369_44454__$1)){
var c__4556__auto___44455 = cljs.core.chunk_first(seq__44369_44454__$1);
var G__44456 = cljs.core.chunk_rest(seq__44369_44454__$1);
var G__44457 = c__4556__auto___44455;
var G__44458 = cljs.core.count(c__4556__auto___44455);
var G__44459 = (0);
seq__44369_44439 = G__44456;
chunk__44370_44440 = G__44457;
count__44371_44441 = G__44458;
i__44372_44442 = G__44459;
continue;
} else {
var style_44460 = cljs.core.first(seq__44369_44454__$1);
...
var G__44464 = cljs.core.next(seq__44369_44454__$1);
var G__44465 = null;
var G__44466 = (0);
var G__44467 = (0);
seq__44369_44439 = G__44464;
chunk__44370_44440 = G__44465;
count__44371_44441 = G__44466;
i__44372_44442 = G__44467;
continue;
}
} else {
}
