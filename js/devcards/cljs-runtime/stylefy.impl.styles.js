...
var G__38997_39071 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"css","css",1135045163),style_css,new cljs.core.Keyword(null,"hash","hash",-13781596),hash], null);
(style_created_handler.cljs$core$IFn$_invoke$arity$1 ? style_created_handler.cljs$core$IFn$_invoke$arity$1(G__38997_39071) : style_created_handler.call(null,G__38997_39071));
...
var G__39013_39074 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__39014_39075 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__39013_39074,G__39014_39075) : stylefy.impl.styles.create_style_BANG_.call(null,G__39013_39074,G__39014_39075));


var G__39077 = seq__38999;
var G__39079 = chunk__39000;
var G__39080 = count__39001;
var G__39081 = (i__39002 + (1));
seq__38999 = G__39077;
chunk__39000 = G__39079;
count__39001 = G__39080;
i__39002 = G__39081;
continue;
} else {
...
var G__39084 = cljs.core.chunk_rest(seq__38999__$1);
var G__39085 = c__4609__auto__;
var G__39086 = cljs.core.count(c__4609__auto__);
var G__39087 = (0);
seq__38999 = G__39084;
chunk__39000 = G__39085;
count__39001 = G__39086;
i__39002 = G__39087;
continue;
} else {
var sub_style = cljs.core.first(seq__38999__$1);
var G__39019_39089 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__39020_39090 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__39019_39089,G__39020_39090) : stylefy.impl.styles.create_style_BANG_.call(null,G__39019_39089,G__39020_39090));


var G__39092 = cljs.core.next(seq__38999__$1);
var G__39093 = null;
var G__39094 = (0);
var G__39095 = (0);
seq__38999 = G__39092;
chunk__39000 = G__39093;
count__39001 = G__39094;
i__39002 = G__39095;
continue;
}
} else {
...
if((((class$ == null)) || (typeof class$ === 'string') || ((class$ instanceof cljs.core.Keyword)) || (((cljs.core.vector_QMARK_(class$)) && (cljs.core.every_QMARK_((function (p1__39025_SHARP_){
return ((typeof p1__39025_SHARP_ === 'string') || ((p1__39025_SHARP_ instanceof cljs.core.Keyword)) || ((p1__39025_SHARP_ == null)));
}),class$)))))){
return null;
} else {
throw (new Error(["Assert failed: ",["Unsupported ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(origin)," type. It should be nil, keyword, string or vector of strings/keywords). Got: ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([class$], 0))].join(''),"\n","(or (nil? class) (string? class) (keyword? class) (and (vector? class) (every? (fn* [p1__39025#] (or (string? p1__39025#) (keyword? p1__39025#) (nil? p1__39025#))) class)))"].join('')));
}
});
/**
...
var styles_39127__$1 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,styles);
var seq__39063_39128 = cljs.core.seq(styles_39127__$1);
var chunk__39064_39129 = null;
var count__39065_39130 = (0);
var i__39066_39131 = (0);
while(true){
if((i__39066_39131 < count__39065_39130)){
var style_39133 = chunk__39064_39129.cljs$core$IIndexed$_nth$arity$2(null,i__39066_39131);
stylefy.impl.styles.use_style_BANG_(style_39133,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___39135 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_39133));
if(cljs.core.truth_(temp__5735__auto___39135)){
var sub_styles_39136 = temp__5735__auto___39135;
...
var G__39138 = seq__39063_39128;
var G__39139 = chunk__39064_39129;
var G__39140 = count__39065_39130;
var G__39141 = (i__39066_39131 + (1));
seq__39063_39128 = G__39138;
chunk__39064_39129 = G__39139;
count__39065_39130 = G__39140;
i__39066_39131 = G__39141;
continue;
} else {
var temp__5735__auto___39142 = cljs.core.seq(seq__39063_39128);
if(temp__5735__auto___39142){
var seq__39063_39143__$1 = temp__5735__auto___39142;
if(cljs.core.chunked_seq_QMARK_(seq__39063_39143__$1)){
var c__4609__auto___39144 = cljs.core.chunk_first(seq__39063_39143__$1);
var G__39145 = cljs.core.chunk_rest(seq__39063_39143__$1);
var G__39146 = c__4609__auto___39144;
var G__39147 = cljs.core.count(c__4609__auto___39144);
var G__39148 = (0);
seq__39063_39128 = G__39145;
chunk__39064_39129 = G__39146;
count__39065_39130 = G__39147;
i__39066_39131 = G__39148;
continue;
} else {
var style_39150 = cljs.core.first(seq__39063_39143__$1);
stylefy.impl.styles.use_style_BANG_(style_39150,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___39151__$1 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_39150));
if(cljs.core.truth_(temp__5735__auto___39151__$1)){
var sub_styles_39152 = temp__5735__auto___39151__$1;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_39152,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__39153 = cljs.core.next(seq__39063_39143__$1);
var G__39154 = null;
var G__39155 = (0);
var G__39156 = (0);
seq__39063_39128 = G__39153;
chunk__39064_39129 = G__39154;
count__39065_39130 = G__39155;
i__39066_39131 = G__39156;
continue;
}
} else {
}
