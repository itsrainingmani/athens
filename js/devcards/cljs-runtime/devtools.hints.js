...
var temp__5733__auto___20797 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20797)){
var seen_errors_20799 = temp__5733__auto___20797;
if(cljs.core.truth_(seen_errors_20799.has(self))){
} else {
seen_errors_20799.add(self);

var temp__5735__auto___20805 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20805)){
var sense_20806 = temp__5735__auto___20805;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20806)].join(''));
} else {
}
}
} else {
