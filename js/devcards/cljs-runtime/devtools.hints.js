...
var temp__5733__auto___20872 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20872)){
var seen_errors_20873 = temp__5733__auto___20872;
if(cljs.core.truth_(seen_errors_20873.has(self))){
} else {
seen_errors_20873.add(self);

var temp__5735__auto___20874 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20874)){
var sense_20875 = temp__5735__auto___20874;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20875)].join(''));
} else {
}
}
} else {
