...
var G__20804 = cljs.core.PersistentArrayMap.EMPTY;
var G__20805 = native_stack_trace;
var G__20806 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__20807 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__20804,G__20805,G__20806,G__20807) : cljs.stacktrace.parse_stacktrace.call(null,G__20804,G__20805,G__20806,G__20807));
});
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20810__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20810__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20810__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e20809){var _e = e20809;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___20825 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20825)){
var seen_errors_20826 = temp__5733__auto___20825;
if(cljs.core.truth_(seen_errors_20826.has(self))){
} else {
seen_errors_20826.add(self);
