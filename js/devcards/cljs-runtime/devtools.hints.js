...
}catch (e20916){var _e = e20916;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___20923 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20923)){
var seen_errors_20924 = temp__5733__auto___20923;
if(cljs.core.truth_(seen_errors_20924.has(self))){
} else {
seen_errors_20924.add(self);

var temp__5735__auto___20925 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20925)){
var sense_20926 = temp__5735__auto___20925;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20926)].join(''));
} else {
}
}
} else {
