...
})(),athens.views.buttons.button_icons_not_last_child_style], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__44667 = (function (){var G__44668 = (garden.selectors.first_child.cljs$core$IFn$_invoke$arity$0 ? garden.selectors.first_child.cljs$core$IFn$_invoke$arity$0() : garden.selectors.first_child.call(null));
...
})(),athens.views.buttons.button_icons_not_first_child_style], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__44670 = (function (){var fexpr__44672 = (function (){var G__44673 = (garden.selectors.last_child.cljs$core$IFn$_invoke$arity$0 ? garden.selectors.last_child.cljs$core$IFn$_invoke$arity$0() : garden.selectors.last_child.call(null));
return (garden.selectors.first_child.cljs$core$IFn$_invoke$arity$1 ? garden.selectors.first_child.cljs$core$IFn$_invoke$arity$1(G__44673) : garden.selectors.first_child.call(null,G__44673));
})();
return (fexpr__44672.cljs$core$IFn$_invoke$arity$0 ? fexpr__44672.cljs$core$IFn$_invoke$arity$0() : fexpr__44672.call(null));
})();
...
(athens.views.buttons.button.cljs$core$IFn$_invoke$arity$2 = (function (p__44680,children){
var map__44681 = p__44680;
var map__44681__$1 = (((((!((map__44681 == null))))?(((((map__44681.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__44681.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__44681):map__44681);
var props = map__44681__$1;
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44681__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var active = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44681__$1,new cljs.core.Keyword(null,"active","active",1895962068));
var primary = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44681__$1,new cljs.core.Keyword(null,"primary","primary",817773892));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44681__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
