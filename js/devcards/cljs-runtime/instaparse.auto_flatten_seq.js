...
var instaparse$auto_flatten_seq$ConjFlat$conj_flat$dyn_54994 = (function (self,obj){
...
return instaparse$auto_flatten_seq$ConjFlat$conj_flat$dyn_54994(self,obj);
}
});

var instaparse$auto_flatten_seq$ConjFlat$cached_QMARK_$dyn_54999 = (function (self){
var x__4428__auto__ = (((self == null))?null:self);
...
return instaparse$auto_flatten_seq$ConjFlat$cached_QMARK_$dyn_54999(self);
}
});
...
var G__55000 = n__$1;
var G__55001 = y;
var G__55002 = cljs.core.imul(z,z);
n = G__55000;
y = G__55001;
z = G__55002;
continue;
...
var G__55003 = n__$1;
var G__55004 = cljs.core.imul(z,y);
var G__55005 = cljs.core.imul(z,z);
n = G__55003;
y = G__55004;
z = G__55005;
continue;
...
var G__55010 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(v__$1,(0));
var G__55011 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(index__$1,(0));
v__$1 = G__55010;
index__$1 = G__55011;
continue;
} else {
...
if((cljs.core.peek(index) < ((function (){var G__54937 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(v,cljs.core.pop(index));
return (instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1 ? instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1(G__54937) : instaparse.auto_flatten_seq.true_count.call(null,G__54937));
})() - (1)))){
...
var G__55012 = v;
var G__55013 = cljs.core.pop(index);
v = G__55012;
index = G__55013;
continue;
...
while(true){
if((!((coll__$1 == null)))){
var G__55059 = ((cljs.core.imul((31),unmixed_hash) + cljs.core.hash(cljs.core.first(coll__$1))) | (0));
var G__55060 = cljs.core.next(coll__$1);
unmixed_hash = G__55059;
coll__$1 = G__55060;
continue;
} else {
return unmixed_hash;
...
var G__55061 = (instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2 ? instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2(acc,fst) : instaparse.auto_flatten_seq.flat_vec_helper.call(null,acc,fst));
var G__55062 = cljs.core.next(v);
acc = G__55061;
v = G__55062;
continue;
} else {
var G__55063 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,fst);
var G__55064 = cljs.core.next(v);
acc = G__55063;
v = G__55064;
continue;
}
...
var instaparse$auto_flatten_seq$GetVec$get_vec$dyn_55065 = (function (self){
var x__4428__auto__ = (((self == null))?null:self);
...
return instaparse$auto_flatten_seq$GetVec$get_vec$dyn_55065(self);
}
});
...
var self__ = this;
var self__ = this;
var G__54990 = (arguments.length - (1));
switch (G__54990) {
case (1):
...
(instaparse.auto_flatten_seq.FlattenOnDemandVector.prototype.apply = (function (self__,args54989){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args54989)));
}));
