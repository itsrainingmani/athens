...
var G__54993 = (instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2 ? instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2(acc,fst) : instaparse.auto_flatten_seq.flat_vec_helper.call(null,acc,fst));
var G__54994 = cljs.core.next(v);
acc = G__54993;
v = G__54994;
continue;
} else {
var G__54995 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,fst);
var G__54996 = cljs.core.next(v);
acc = G__54995;
v = G__54996;
continue;
}
...
var instaparse$auto_flatten_seq$GetVec$get_vec$dyn_54997 = (function (self){
var x__4428__auto__ = (((self == null))?null:self);
...
return instaparse$auto_flatten_seq$GetVec$get_vec$dyn_54997(self);
}
});
...
var self__ = this;
var self__ = this;
var G__54962 = (arguments.length - (1));
switch (G__54962) {
case (1):
