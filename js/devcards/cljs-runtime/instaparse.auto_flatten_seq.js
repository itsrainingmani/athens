...
var G__55001 = v;
var G__55002 = cljs.core.pop(index);
v = G__55001;
index = G__55002;
continue;
...
while(true){
if((!((coll__$1 == null)))){
var G__55016 = ((cljs.core.imul((31),unmixed_hash) + cljs.core.hash(cljs.core.first(coll__$1))) | (0));
var G__55017 = cljs.core.next(coll__$1);
unmixed_hash = G__55016;
coll__$1 = G__55017;
continue;
} else {
return unmixed_hash;
...
var G__55024 = (instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2 ? instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2(acc,fst) : instaparse.auto_flatten_seq.flat_vec_helper.call(null,acc,fst));
var G__55025 = cljs.core.next(v);
acc = G__55024;
v = G__55025;
continue;
} else {
var G__55026 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,fst);
var G__55027 = cljs.core.next(v);
acc = G__55026;
v = G__55027;
continue;
}
...
var self__ = this;
var self__ = this;
var G__54987 = (arguments.length - (1));
switch (G__54987) {
case (1):
