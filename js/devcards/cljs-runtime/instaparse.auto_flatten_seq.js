...
var G__54997 = n__$1;
var G__54998 = y;
var G__54999 = cljs.core.imul(z,z);
n = G__54997;
y = G__54998;
z = G__54999;
continue;
...
var G__55000 = n__$1;
var G__55001 = cljs.core.imul(z,y);
...
var G__55003 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(v__$1,(0));
var G__55004 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(index__$1,(0));
v__$1 = G__55003;
index__$1 = G__55004;
continue;
} else {
...
if((cljs.core.peek(index) < ((function (){var G__54941 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(v,cljs.core.pop(index));
return (instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1 ? instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1(G__54941) : instaparse.auto_flatten_seq.true_count.call(null,G__54941));
})() - (1)))){
...
var G__55005 = v;
var G__55006 = cljs.core.pop(index);
v = G__55005;
index = G__55006;
continue;
...
var G__55014 = (instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2 ? instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2(acc,fst) : instaparse.auto_flatten_seq.flat_vec_helper.call(null,acc,fst));
var G__55015 = cljs.core.next(v);
acc = G__55014;
v = G__55015;
continue;
} else {
var G__55016 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,fst);
...
var instaparse$auto_flatten_seq$GetVec$get_vec$dyn_55018 = (function (self){
var x__4428__auto__ = (((self == null))?null:self);
...
return instaparse$auto_flatten_seq$GetVec$get_vec$dyn_55018(self);
}
});
...
(instaparse.auto_flatten_seq.FlattenOnDemandVector.prototype.apply = (function (self__,args54966){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args54966)));
}));
