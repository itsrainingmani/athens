...
if((cljs.core.peek(index) < ((function (){var G__56226 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(v,cljs.core.pop(index));
return (instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1 ? instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1(G__56226) : instaparse.auto_flatten_seq.true_count.call(null,G__56226));
})() - (1)))){
...
var G__56290 = v;
var G__56291 = cljs.core.pop(index);
v = G__56290;
index = G__56291;
continue;
...
while(true){
if((!((coll__$1 == null)))){
var G__56305 = ((cljs.core.imul((31),unmixed_hash) + cljs.core.hash(cljs.core.first(coll__$1))) | (0));
var G__56306 = cljs.core.next(coll__$1);
unmixed_hash = G__56305;
coll__$1 = G__56306;
continue;
} else {
return unmixed_hash;
...
var G__56317 = (instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2 ? instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2(acc,fst) : instaparse.auto_flatten_seq.flat_vec_helper.call(null,acc,fst));
var G__56318 = cljs.core.next(v);
acc = G__56317;
v = G__56318;
continue;
} else {
var G__56319 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,fst);
var G__56320 = cljs.core.next(v);
acc = G__56319;
v = G__56320;
continue;
}
...
var self__ = this;
var self__ = this;
var G__56281 = (arguments.length - (1));
switch (G__56281) {
case (1):
...
(instaparse.auto_flatten_seq.FlattenOnDemandVector.prototype.apply = (function (self__,args56269){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args56269)));
}));
