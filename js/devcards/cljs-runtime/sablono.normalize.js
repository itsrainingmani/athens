...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__47027){
var vec__47028 = p__47027;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47028,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47028,(1),null);
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__47031_SHARP_){
return (((p1__47031_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__47031_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__47035,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__47035;
}
});
...
var G__47037 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__47037,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__47037;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq47036){
...
var vec__47040 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__47044 = cljs.core.ffirst(matches);
var fexpr__47043 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__47043.cljs$core$IFn$_invoke$arity$1 ? fexpr__47043.cljs$core$IFn$_invoke$arity$1(G__47044) : fexpr__47043.call(null,G__47044));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47040,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47040,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__47038_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__47038_SHARP_))){
return p1__47038_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__47039_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__47039_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__47052){
...
var tag = first__47055;
var content = seq__47054__$1;
...
var vec__47056 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47056,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47056,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47056,(2),null);
