...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__62133){
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__62137_SHARP_){
return (((p1__62137_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__62137_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__62141,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__62141;
}
});
...
var len__4789__auto___62171 = arguments.length;
var i__4790__auto___62172 = (0);
while(true){
if((i__4790__auto___62172 < len__4789__auto___62171)){
args__4795__auto__.push((arguments[i__4790__auto___62172]));

var G__62173 = (i__4790__auto___62172 + (1));
i__4790__auto___62172 = G__62173;
continue;
} else {
}
break;
...
var G__62143 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__62143,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__62143;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq62142){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq62142));
}));
...
var vec__62146 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__62150 = cljs.core.ffirst(matches);
var fexpr__62149 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__62149.cljs$core$IFn$_invoke$arity$1 ? fexpr__62149.cljs$core$IFn$_invoke$arity$1(G__62150) : fexpr__62149.call(null,G__62150));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62146,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62146,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__62144_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__62144_SHARP_))){
return p1__62144_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__62145_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__62145_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__62161){
var vec__62165 = p__62161;
var seq__62166 = cljs.core.seq(vec__62165);
var first__62167 = cljs.core.first(seq__62166);
var seq__62166__$1 = cljs.core.next(seq__62166);
var tag = first__62167;
var content = seq__62166__$1;
...
var vec__62168 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62168,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62168,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62168,(2),null);
