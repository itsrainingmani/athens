...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__46996){
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__47003_SHARP_){
return (((p1__47003_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__47003_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__47007,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__47007;
}
});
...
var G__47009 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__47009,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__47009;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq47008){
...
var vec__47012 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__47016 = cljs.core.ffirst(matches);
var fexpr__47015 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__47015.cljs$core$IFn$_invoke$arity$1 ? fexpr__47015.cljs$core$IFn$_invoke$arity$1(G__47016) : fexpr__47015.call(null,G__47016));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47012,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47012,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__47010_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__47010_SHARP_))){
return p1__47010_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__47011_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__47011_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__47029){
var vec__47031 = p__47029;
var seq__47032 = cljs.core.seq(vec__47031);
var first__47033 = cljs.core.first(seq__47032);
var seq__47032__$1 = cljs.core.next(seq__47032);
var tag = first__47033;
var content = seq__47032__$1;
...
var vec__47043 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47043,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47043,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47043,(2),null);
