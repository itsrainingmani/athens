...
var sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_57928 = (function (this$,ctx,n){
...
return sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_57928(this$,ctx,n);
}
});
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__57925 = (n - (1));
var G__57926 = cljs.core.rest(s);
var G__57927 = err_val;
return (sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3 ? sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3(G__57925,G__57926,G__57927) : sci.impl.max_or_throw.take_STAR_.call(null,G__57925,G__57926,G__57927));
})());
} else {
return null;
}
