...
var sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_57973 = (function (this$,ctx,n){
...
return sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_57973(this$,ctx,n);
}
});
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__57970 = (n - (1));
var G__57971 = cljs.core.rest(s);
var G__57972 = err_val;
return (sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3 ? sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3(G__57970,G__57971,G__57972) : sci.impl.max_or_throw.take_STAR_.call(null,G__57970,G__57971,G__57972));
})());
} else {
return null;
}
