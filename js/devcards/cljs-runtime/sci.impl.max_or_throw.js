...
var sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_57981 = (function (this$,ctx,n){
...
return sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_57981(this$,ctx,n);
}
});
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__57978 = (n - (1));
var G__57979 = cljs.core.rest(s);
var G__57980 = err_val;
return (sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3 ? sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3(G__57978,G__57979,G__57980) : sci.impl.max_or_throw.take_STAR_.call(null,G__57978,G__57979,G__57980));
})());
} else {
return null;
}
