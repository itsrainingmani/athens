...
var sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_57989 = (function (this$,ctx,n){
...
return sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_57989(this$,ctx,n);
}
});
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__57986 = (n - (1));
var G__57987 = cljs.core.rest(s);
var G__57988 = err_val;
return (sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3 ? sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3(G__57986,G__57987,G__57988) : sci.impl.max_or_throw.take_STAR_.call(null,G__57986,G__57987,G__57988));
})());
} else {
return null;
}
