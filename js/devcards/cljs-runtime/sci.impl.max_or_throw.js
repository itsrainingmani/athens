...
var sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_57947 = (function (this$,ctx,n){
...
return sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_57947(this$,ctx,n);
}
});
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__57940 = (n - (1));
var G__57941 = cljs.core.rest(s);
var G__57942 = err_val;
return (sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3 ? sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3(G__57940,G__57941,G__57942) : sci.impl.max_or_throw.take_STAR_.call(null,G__57940,G__57941,G__57942));
})());
} else {
return null;
}
