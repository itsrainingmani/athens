...
var G__33154 = cljs.core.first(new cljs.core.Keyword("block","_children","block/_children",1128070632).cljs$core$IFn$_invoke$arity$1(b));
b = G__33154;
continue;
}
break;
...
var map__33130 = tx_report;
var map__33130__$1 = (((((!((map__33130 == null))))?(((((map__33130.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__33130.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__33130):map__33130);
var db_before = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33130__$1,new cljs.core.Keyword(null,"db-before","db-before",-553691536));
var db_after = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33130__$1,new cljs.core.Keyword(null,"db-after","db-after",-571884666));
...
return athens.db.trim_head(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(athens.db.drop_tail(h,(function (p1__33129_SHARP_){
return (p1__33129_SHARP_ === db_before);
})),db_after),(10));
}));
} else {
return null;
