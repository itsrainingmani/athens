...
var fexpr__37598 = new cljs.core.Keyword(null,"pull*","pull*",413297819).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__37598.cljs$core$IFn$_invoke$arity$3 ? fexpr__37598.cljs$core$IFn$_invoke$arity$3(db,query,id) : fexpr__37598.call(null,db,query,id));
} else {
...
var G__37791 = (n + (1));
var G__37792 = cljs.core.rest(conns__$1);
var G__37793 = (function (){var db_id = cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(["conn",cljs.core.str.cljs$core$IFn$_invoke$arity$1(n)].join(''));
...
var fexpr__37630 = new cljs.core.Keyword(null,"posh-dispenser","posh-dispenser",-482466766).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(new cljs.core.Keyword(null,"listeners","listeners",394544445).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(conn))));
return (fexpr__37630.cljs$core$IFn$_invoke$arity$1 ? fexpr__37630.cljs$core$IFn$_invoke$arity$1(var$) : fexpr__37630.call(null,var$));
});
posh.plugin_base.get_posh_atom = (function posh$plugin_base$get_posh_atom(dcfg,poshdb_or_conn){
if(cljs.core.truth_((function (){var fexpr__37631 = new cljs.core.Keyword(null,"conn?","conn?",167224275).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__37631.cljs$core$IFn$_invoke$arity$1 ? fexpr__37631.cljs$core$IFn$_invoke$arity$1(poshdb_or_conn) : fexpr__37631.call(null,poshdb_or_conn));
})())){
...
if(cljs.core.truth_((function (){var fexpr__37632 = new cljs.core.Keyword(null,"conn?","conn?",167224275).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__37632.cljs$core$IFn$_invoke$arity$1 ? fexpr__37632.cljs$core$IFn$_invoke$arity$1(poshdb_or_conn) : fexpr__37632.call(null,poshdb_or_conn));
})())){
...
var fexpr__37639 = new cljs.core.Keyword(null,"ratom","ratom",-126521267).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__37639.cljs$core$IFn$_invoke$arity$1 ? fexpr__37639.cljs$core$IFn$_invoke$arity$1(query_result) : fexpr__37639.call(null,query_result));
}
})();
var query_reaction = (function (){var G__37641 = (function (){
return cljs.core.deref(query_ratom);
});
var G__37642 = new cljs.core.Keyword(null,"on-dispose","on-dispose",2105306360);
var G__37643 = (function (_,___$1){
...
var fexpr__37640 = new cljs.core.Keyword(null,"make-reaction","make-reaction",295148585).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__37640.cljs$core$IFn$_invoke$arity$3 ? fexpr__37640.cljs$core$IFn$_invoke$arity$3(G__37641,G__37642,G__37643) : fexpr__37640.call(null,G__37641,G__37642,G__37643));
})();
...
return posh.plugin_base.make_query_reaction.cljs$core$IFn$_invoke$arity$5(dcfg,posh_atom,storage_key,(function (p1__37647_SHARP_){
return posh.core.add_pull(p1__37647_SHARP_,true_poshdb,pull_pattern,eid);
}),options);
}));
...
var posh_atom = posh.plugin_base.get_posh_atom(dcfg,poshdb);
return posh.plugin_base.make_query_reaction.cljs$core$IFn$_invoke$arity$5(dcfg,posh_atom,storage_key,(function (p1__37661_SHARP_){
return posh.core.add_pull_many(p1__37661_SHARP_,true_poshdb,pull_pattern,eids);
}),options);
}));
...
return cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__37679,query_item){
var vec__37682 = p__37679;
var parsed_query = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37682,(0),null);
var last_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37682,(1),null);
...
var args__4795__auto__ = [];
var len__4789__auto___37808 = arguments.length;
var i__4790__auto___37809 = (0);
while(true){
if((i__4790__auto___37809 < len__4789__auto___37808)){
args__4795__auto__.push((arguments[i__4790__auto___37809]));

var G__37811 = (i__4790__auto___37809 + (1));
i__4790__auto___37809 = G__37811;
continue;
} else {
}
break;
...
var args__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37702,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37702,(1),null);
var true_poshdb_args = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__37691_SHARP_){
if(cljs.core.truth_((function (){var fexpr__37706 = new cljs.core.Keyword(null,"conn?","conn?",167224275).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__37706.cljs$core$IFn$_invoke$arity$1 ? fexpr__37706.cljs$core$IFn$_invoke$arity$1(p1__37691_SHARP_) : fexpr__37706.call(null,p1__37691_SHARP_));
})())){
return posh.plugin_base.get_db(dcfg,p1__37691_SHARP_);
} else {
return p1__37691_SHARP_;
}
}),args__$1);
var posh_atom = cljs.core.first(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__37692_SHARP_){
return posh.plugin_base.get_posh_atom(dcfg,p1__37692_SHARP_);
}),args__$1)));
...
return posh.plugin_base.make_query_reaction.cljs$core$IFn$_invoke$arity$5(dcfg,posh_atom,storage_key,(function (p1__37693_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$3(posh.core.add_q,p1__37693_SHARP_,query),true_poshdb_args);
}),options);
}));
...
/** @this {Function} */
(posh.plugin_base.q.cljs$lang$applyTo = (function (seq37694){
...
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37695,G__37696,seq37694__$2);
}));

posh.plugin_base.q_info = (function posh$plugin_base$q_info(var_args){
var args__4795__auto__ = [];
var len__4789__auto___37813 = arguments.length;
var i__4790__auto___37814 = (0);
while(true){
if((i__4790__auto___37814 < len__4789__auto___37813)){
args__4795__auto__.push((arguments[i__4790__auto___37814]));

var G__37816 = (i__4790__auto___37814 + (1));
i__4790__auto___37814 = G__37816;
continue;
} else {
}
break;
...
var true_poshdb_args = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__37713_SHARP_){
if(cljs.core.truth_((function (){var fexpr__37723 = new cljs.core.Keyword(null,"conn?","conn?",167224275).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__37723.cljs$core$IFn$_invoke$arity$1 ? fexpr__37723.cljs$core$IFn$_invoke$arity$1(p1__37713_SHARP_) : fexpr__37723.call(null,p1__37713_SHARP_));
})())){
return posh.plugin_base.get_db(dcfg,p1__37713_SHARP_);
} else {
return p1__37713_SHARP_;
}
}),args);
var posh_atom = cljs.core.first(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__37715_SHARP_){
return posh.plugin_base.get_posh_atom(dcfg,p1__37715_SHARP_);
}),args)));
var storage_key = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"q","q",689001697),query,true_poshdb_args], null);
...
/** @this {Function} */
(posh.plugin_base.q_info.cljs$lang$applyTo = (function (seq37716){
...
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37717,G__37718,seq37716__$2);
}));
...
/** @this {Function} */
(posh.plugin_base.q_tx.cljs$lang$applyTo = (function (seq37730){
...
var G__37733 = cljs.core.first(seq37730__$2);
var seq37730__$3 = cljs.core.next(seq37730__$2);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37731,G__37732,G__37733,seq37730__$3);
}));
...
var true_poshdb_args = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__37745_SHARP_){
if(cljs.core.truth_((function (){var fexpr__37755 = new cljs.core.Keyword(null,"conn?","conn?",167224275).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__37755.cljs$core$IFn$_invoke$arity$1 ? fexpr__37755.cljs$core$IFn$_invoke$arity$1(p1__37745_SHARP_) : fexpr__37755.call(null,p1__37745_SHARP_));
})())){
return posh.plugin_base.get_db(dcfg,p1__37745_SHARP_);
} else {
return p1__37745_SHARP_;
}
}),args);
...
/** @this {Function} */
(posh.plugin_base.filter_q.cljs$lang$applyTo = (function (seq37748){
var G__37750 = cljs.core.first(seq37748);
var seq37748__$1 = cljs.core.next(seq37748);
var G__37751 = cljs.core.first(seq37748__$1);
var seq37748__$2 = cljs.core.next(seq37748__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37750,G__37751,seq37748__$2);
}));

posh.plugin_base.transact_BANG_ = (function posh$plugin_base$transact_BANG_(dcfg,poshdb_or_conn,txs){
var G__37759 = (cljs.core.truth_((function (){var fexpr__37761 = new cljs.core.Keyword(null,"conn?","conn?",167224275).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__37761.cljs$core$IFn$_invoke$arity$1 ? fexpr__37761.cljs$core$IFn$_invoke$arity$1(poshdb_or_conn) : fexpr__37761.call(null,poshdb_or_conn));
})())?poshdb_or_conn:posh.stateful.poshdb__GT_conn(poshdb_or_conn));
var G__37760 = txs;
var fexpr__37758 = new cljs.core.Keyword(null,"transact!","transact!",-822725810).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__37758.cljs$core$IFn$_invoke$arity$2 ? fexpr__37758.cljs$core$IFn$_invoke$arity$2(G__37759,G__37760) : fexpr__37758.call(null,G__37759,G__37760));
});
