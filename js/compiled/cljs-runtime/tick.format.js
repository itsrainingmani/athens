...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__80554 = goog.object.get(JSJodaLocale,"Locale");
if((G__80554 == null)){
return null;
} else {
return goog.object.get(G__80554,"US");
}
}catch (e80553){if((e80553 instanceof Error)){
var e = e80553;
return null;
} else {
throw e80553;
