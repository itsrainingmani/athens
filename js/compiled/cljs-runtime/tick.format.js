...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__58744 = goog.object.get(JSJodaLocale,"Locale");
if((G__58744 == null)){
return null;
} else {
return goog.object.get(G__58744,"US");
}
