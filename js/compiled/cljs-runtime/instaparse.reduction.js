...
var G__85492 = new cljs.core.Keyword(null,"reduction-type","reduction-type",-488293450).cljs$core$IFn$_invoke$arity$1(f);
var G__85492__$1 = (((G__85492 instanceof cljs.core.Keyword))?G__85492.fqn:null);
switch (G__85492__$1) {
case "raw":
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$reduction$iter__85495(s__85496){
return (new cljs.core.LazySeq(null,(function (){
var s__85496__$1 = s__85496;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__85496__$1);
if(temp__5735__auto__){
var s__85496__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__85496__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__85496__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__85498 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__85497 = (0);
while(true){
if((i__85497 < size__4581__auto__)){
var vec__85499 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__85497);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__85499,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__85499,(1),null);
cljs.core.chunk_append(b__85498,(cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)));

var G__85507 = (i__85497 + (1));
i__85497 = G__85507;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__85498),instaparse$reduction$iter__85495(cljs.core.chunk_rest(s__85496__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__85498),null);
}
} else {
var vec__85502 = cljs.core.first(s__85496__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__85502,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__85502,(1),null);
return cljs.core.cons((cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)),instaparse$reduction$iter__85495(cljs.core.rest(s__85496__$2)));
}
} else {
return null;
}
