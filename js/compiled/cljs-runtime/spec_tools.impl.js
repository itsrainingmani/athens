...
var vec__76708 = cljs.core.rest(expr);
var seq__76709 = cljs.core.seq(vec__76708);
var first__76710 = cljs.core.first(seq__76709);
var seq__76709__$1 = cljs.core.next(seq__76709);
var vec__76711 = first__76710;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76711,(0),null);
var form = seq__76709__$1;
...
var G__76714 = x;
var G__76714__$1 = (((G__76714 == null))?null:spec_tools.impl.polish(G__76714));
var G__76714__$2 = (((G__76714__$1 == null))?null:cljs.core.name(G__76714__$1));
if((G__76714__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__76714__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__76715 = x;
var G__76715__$1 = (((G__76715 == null))?null:cljs.core.name(G__76715));
if((G__76715__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__76715__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__76716){
var map__76717 = p__76716;
var map__76717__$1 = (((((!((map__76717 == null))))?(((((map__76717.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__76717.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__76717):map__76717);
var data = map__76717__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76717__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76717__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76717__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76717__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__76719){
var map__76720 = p__76719;
var map__76720__$1 = (((((!((map__76720 == null))))?(((((map__76720.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__76720.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__76720):map__76720);
var data = map__76720__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76720__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76720__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__76722 = data;
var G__76722__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__76722,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__76722);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__76722__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__76722__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__76726 = form;
var G__76726__$1 = (((G__76726 == null))?null:cljs.core.rest(G__76726));
if((G__76726__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__76726__$1);
}
})();
var G__76727 = m;
var G__76727__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__76727,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__76723_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__76723_SHARP_)));
})):G__76727);
var G__76727__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__76727__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__76724_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__76724_SHARP_)));
})):G__76727__$1);
var G__76727__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__76727__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__76725_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__76725_SHARP_));
})):G__76727__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__76727__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__76728 = (function (){var G__76729 = form;
var G__76729__$1 = (((G__76729 == null))?null:cljs.core.rest(G__76729));
if((G__76729__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__76729__$1);
}
})();
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76728__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76728__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76728__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76728__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__76736 = (((kw instanceof cljs.core.Symbol))?cljs.core.namespace(kw):false);
switch (G__76736) {
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__76737 = form;
var G__76737__$1 = (((G__76737 == null))?null:cljs.core.seq(G__76737));
var G__76737__$2 = (((G__76737__$1 == null))?null:cljs.core.first(G__76737__$1));
if((G__76737__$2 == null)){
return null;
} else {
var fexpr__76738 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__76738.cljs$core$IFn$_invoke$arity$1 ? fexpr__76738.cljs$core$IFn$_invoke$arity$1(G__76737__$2) : fexpr__76738.call(null,G__76737__$2));
}
})():null));
});
/**
...
var len__4789__auto___76812 = arguments.length;
var i__4790__auto___76813 = (0);
while(true){
if((i__4790__auto___76813 < len__4789__auto___76812)){
args__4795__auto__.push((arguments[i__4790__auto___76813]));

var G__76814 = (i__4790__auto___76813 + (1));
i__4790__auto___76813 = G__76814;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq76740){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq76740));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__76750){
var vec__76751 = p__76750;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76751,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76751,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__76761){
var map__76762 = p__76761;
var map__76762__$1 = (((((!((map__76762 == null))))?(((((map__76762.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__76762.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__76762):map__76762);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76762__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76762__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76762__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76762__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__76759_SHARP_){
return cljs.core.map_QMARK_(p1__76759_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__76760_SHARP_){
return cljs.core.contains_QMARK_(p1__76760_SHARP_,x);
});
}),req_keys));
