...
while(true){
if((level__$1 > (0))){
var G__36490 = (function (){var arr__36235__auto__ = node__$1.pointers;
return (arr__36235__auto__[(arr__36235__auto__.length - (1))]);
})();
...
var G__36592 = (level__$1 - me.tonsky.persistent_sorted_set.level_shift);
var G__36593 = (res * me.tonsky.persistent_sorted_set.avg_len);
level__$1 = G__36592;
res = G__36593;
continue;
}
...
var G__36603 = (node.pointers[idx]);
var G__36604 = me.tonsky.persistent_sorted_set.path_set(path,level,idx);
var G__36605 = (level - me.tonsky.persistent_sorted_set.level_shift);
node = G__36603;
path = G__36604;
level = G__36605;
continue;
...
var pos_36613 = (0);
while(true){
var rest_36614 = (len - pos_36613);
if((rest_36614 <= max_len)){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_36613));
} else {
if((rest_36614 >= (chunk_len + min_len))){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_36613,(pos_36613 + chunk_len)));

var G__36616 = (pos_36613 + chunk_len);
pos_36613 = G__36616;
continue;
} else {
var piece_len_36617 = (rest_36614 >>> (1));
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_36613,(pos_36613 + piece_len_36617)));

var G__36618 = (pos_36613 + piece_len_36617);
pos_36613 = G__36618;
continue;
...
var G__36626 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,e);
var G__36627 = (i + (1));
var G__36628 = e;
acc = G__36626;
i = G__36627;
...
var G__36648 = (i__4737__auto___36647 + (1));
i__4737__auto___36647 = G__36648;
continue;
} else {
}
break;
