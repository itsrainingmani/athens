...
if(garden.util.between_QMARK_(a,(0),(1))){
var G__35323 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(garden.color.hsl.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [h,s,l], null)),new cljs.core.Keyword(null,"alpha","alpha",-1574982441),a);
...
var vec__35376 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__35365_SHARP_){
return (p1__35365_SHARP_ / (255));
...
var d = (mx - mn);
var h = (function (){var pred__35383 = cljs.core._EQ_;
var expr__35384 = mx;
if(cljs.core.truth_((pred__35383.cljs$core$IFn$_invoke$arity$2 ? pred__35383.cljs$core$IFn$_invoke$arity$2(mn,expr__35384) : pred__35383.call(null,mn,expr__35384)))){
return (0);
} else {
if(cljs.core.truth_((pred__35383.cljs$core$IFn$_invoke$arity$2 ? pred__35383.cljs$core$IFn$_invoke$arity$2(r,expr__35384) : pred__35383.call(null,r,expr__35384)))){
return ((60) * ((g - b) / d));
} else {
if(cljs.core.truth_((pred__35383.cljs$core$IFn$_invoke$arity$2 ? pred__35383.cljs$core$IFn$_invoke$arity$2(g,expr__35384) : pred__35383.call(null,g,expr__35384)))){
return (((60) * ((b - r) / d)) + (120));
} else {
if(cljs.core.truth_((pred__35383.cljs$core$IFn$_invoke$arity$2 ? pred__35383.cljs$core$IFn$_invoke$arity$2(b,expr__35384) : pred__35383.call(null,b,expr__35384)))){
return (((60) * ((r - g) / d)) + (240));
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__35384)].join('')));
}
}
}
}
