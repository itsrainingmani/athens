...
return (function (p__74081){
var vec__74082 = p__74081;
var event_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74082,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74082,(1),null);
...
var G__74085_74108 = new cljs.core.Keyword(null,"forward-events","forward-events",1216790539);
var G__74086_74109 = (function (){var process_one_entry = (function (p__74087){
var map__74088 = p__74087;
var map__74088__$1 = (((((!((map__74088 == null))))?(((((map__74088.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__74088.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__74088):map__74088);
var m = map__74088__$1;
var unregister = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74088__$1,new cljs.core.Keyword(null,"unregister","unregister",2105339971));
var register = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74088__$1,new cljs.core.Keyword(null,"register","register",1968522516));
var events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74088__$1,new cljs.core.Keyword(null,"events","events",1792552201));
var dispatch_to = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74088__$1,new cljs.core.Keyword(null,"dispatch-to","dispatch-to",-354764401));
...
var G__74103 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(dispatch_to,event_v);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__74103) : re_frame.core.dispatch.call(null,G__74103));
} else {
return null;
}
});
...
var G__74105 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__74106 = ":forward-events expected a map or a list of maps, but got: ";
var G__74107 = val;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__74105,G__74106,G__74107) : re_frame.core.console.call(null,G__74105,G__74106,G__74107));

}
}
});
})();
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__74085_74108,G__74086_74109) : re_frame.core.reg_fx.call(null,G__74085_74108,G__74086_74109));
