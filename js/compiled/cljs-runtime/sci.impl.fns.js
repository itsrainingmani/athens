...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__62545,fn_name,macro_QMARK_,with_meta_QMARK_){
var map__62546 = p__62545;
...
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62546__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62546__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62546__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__62569 = cljs.core.next(args__$1);
var G__62570 = cljs.core.next(params__$1);
var G__62571 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__62569;
params__$1 = G__62570;
ret = G__62571;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__62550 = ctx__$1;
var G__62551 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__62550,G__62551) : interpret.call(null,G__62550,G__62551));
...
var vec__62552 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62552,(0),null);
var vec__62555 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62552,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62555,(0),null);
var G__62576 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__62576;
continue;
} else {
var G__62577 = recur_val;
args = G__62577;
continue;
}
} else {
...
while (G__62578__i < G__62578__a.length) {G__62578__a[G__62578__i] = arguments[G__62578__i + 0]; ++G__62578__i;}
  args = new cljs.core.IndexedSeq(G__62578__a,0,null);
} 
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__62579){
var args = cljs.core.seq(arglist__62579);
...
var map__62558 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62558__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62558__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__62565){
...
var f = map__62566__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62566__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62566__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var G__62588__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(self_ref),args);
};
var G__62588 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__62589__i = 0, G__62589__a = new Array(arguments.length -  0);
while (G__62589__i < G__62589__a.length) {G__62589__a[G__62589__i] = arguments[G__62589__i + 0]; ++G__62589__i;}
  args = new cljs.core.IndexedSeq(G__62589__a,0,null);
} 
return G__62588__delegate.call(this,args);};
G__62588.cljs$lang$maxFixedArity = 0;
G__62588.cljs$lang$applyTo = (function (arglist__62590){
var args = cljs.core.seq(arglist__62590);
return G__62588__delegate(args);
});
G__62588.cljs$core$IFn$_invoke$arity$variadic = G__62588__delegate;
return G__62588;
})()
;
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__62563_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__62563_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
...
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__62564_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__62564_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
