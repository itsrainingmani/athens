...
var temp__5733__auto___20779 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20779)){
var seen_errors_20780 = temp__5733__auto___20779;
if(cljs.core.truth_(seen_errors_20780.has(self))){
} else {
seen_errors_20780.add(self);

var temp__5735__auto___20781 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20781)){
var sense_20782 = temp__5735__auto___20781;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20782)].join(''));
} else {
}
}
} else {
