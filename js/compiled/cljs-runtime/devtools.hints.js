...
var G__20653 = native_stack_trace;
var G__20654 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__20655 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__20652,G__20653,G__20654,G__20655) : cljs.stacktrace.parse_stacktrace.call(null,G__20652,G__20653,G__20654,G__20655));
});
...
}catch (e20657){var _e = e20657;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___20676 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20676)){
var seen_errors_20678 = temp__5733__auto___20676;
if(cljs.core.truth_(seen_errors_20678.has(self))){
} else {
seen_errors_20678.add(self);

var temp__5735__auto___20679 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20679)){
var sense_20681 = temp__5735__auto___20679;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20681)].join(''));
} else {
}
}
} else {
