...
var seen_errors_20730 = temp__5733__auto___20728;
if(cljs.core.truth_(seen_errors_20730.has(self))){
} else {
seen_errors_20730.add(self);

var temp__5735__auto___20731 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20731)){
var sense_20732 = temp__5735__auto___20731;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20732)].join(''));
} else {
}
}
} else {
