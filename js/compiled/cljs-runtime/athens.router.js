...
var G__32463_32523 = new cljs.core.Keyword(null,"current-route","current-route",2067529448);
var G__32464_32524 = (function (db){
return new cljs.core.Keyword(null,"current-route","current-route",2067529448).cljs$core$IFn$_invoke$arity$1(db);
});
(re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$2(G__32463_32523,G__32464_32524) : re_frame.core.reg_sub.call(null,G__32463_32523,G__32464_32524));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"navigate","navigate",657596805),(function (_,p__32466){
var vec__32467 = p__32466;
var seq__32468 = cljs.core.seq(vec__32467);
var first__32469 = cljs.core.first(seq__32468);
var seq__32468__$1 = cljs.core.next(seq__32468);
var ___$1 = first__32469;
var route = seq__32468__$1;
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"navigate!","navigate!",79998348),route], null);
}));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"navigated","navigated",540897836),(function (p__32473,p__32474){
var map__32475 = p__32473;
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32475__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__32476 = p__32474;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32476,(0),null);
var new_match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32476,(1),null);
...
var node = (function (){var G__32484 = athens.db.dsdb;
var G__32485 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__32486 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"path-params","path-params",-48130597).cljs$core$IFn$_invoke$arity$1(new_match))], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__32484,G__32485,G__32486) : posh.reagent.pull.call(null,G__32484,G__32485,G__32486));
})();
...
var G__32490_32533 = new cljs.core.Keyword(null,"navigate!","navigate!",79998348);
var G__32491_32534 = ((day8.re_frame.tracing.is_trace_enabled_QMARK_())?(function (route){
...
var result__30347__auto__ = cljs.core.apply.cljs$core$IFn$_invoke$arity$2((function (){var opts__30346__auto____$1 = _PLUS_debux_dbg_opts_PLUS_;
var result__30347__auto__ = reitit.frontend.easy.push_state;
...
var result__30347__auto__ = route;
...
return result__30347__auto__;
}catch (e32493){var e = e32493;
throw e;
}}):(function (route){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(reitit.frontend.easy.push_state,route);
}));
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__32490_32533,G__32491_32534) : re_frame.core.reg_fx.call(null,G__32490_32533,G__32491_32534));
...
var G__32497 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigated","navigated",540897836),new_match], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__32497) : re_frame.core.dispatch.call(null,G__32497));
} else {
return null;
}
});
athens.router.navigate = (function athens$router$navigate(page){
var G__32500 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigate","navigate",657596805),page], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__32500) : re_frame.core.dispatch.call(null,G__32500));
});
...
var G__32517 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigate","navigate",657596805),new cljs.core.Keyword(null,"page","page",849072397),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),uid], null)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__32517) : re_frame.core.dispatch.call(null,G__32517));
}));

(athens.router.navigate_uid.cljs$core$IFn$_invoke$arity$2 = (function (uid,e){
var shift = e.shiftKey;
if(cljs.core.truth_(shift)){
var G__32520 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("right-sidebar","open-item","right-sidebar/open-item",-1234515614),uid], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__32520) : re_frame.core.dispatch.call(null,G__32520));
} else {
