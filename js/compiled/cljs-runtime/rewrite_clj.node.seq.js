...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k49601,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k49601,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__49608){
var vec__49609 = p__49608;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49609,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49609,(1),null);
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__49600){
var self__ = this;
var G__49600__$1 = this;
return (new cljs.core.RecordIter((0),G__49600__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var h__4297__auto____$1 = (function (){var fexpr__49622 = (function (coll__4436__auto__){
return (580297420 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__49622(this__4435__auto____$1);
})();
...
var self__ = this;
var this$__$1 = this;
var G__49624 = rewrite_clj.node.protocols.sexprs(self__.children);
return (self__.seq_fn.cljs$core$IFn$_invoke$arity$1 ? self__.seq_fn.cljs$core$IFn$_invoke$arity$1(G__49624) : self__.seq_fn.call(null,G__49624));
}));
...
var self__ = this;
var this$__$1 = this;
var G__49626 = rewrite_clj.node.protocols.concat_strings(self__.children);
return (self__.wrap_fn.cljs$core$IFn$_invoke$arity$1 ? self__.wrap_fn.cljs$core$IFn$_invoke$arity$1(G__49626) : self__.wrap_fn.call(null,G__49626));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__49600){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__49630 = cljs.core.keyword_identical_QMARK_;
var expr__49631 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__49633 = new cljs.core.Keyword(null,"tag","tag",-1290361223);
var G__49634 = expr__49631;
return (pred__49630.cljs$core$IFn$_invoke$arity$2 ? pred__49630.cljs$core$IFn$_invoke$arity$2(G__49633,G__49634) : pred__49630.call(null,G__49633,G__49634));
})())){
return (new rewrite_clj.node.seq.SeqNode(G__49600,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__49635 = new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130);
var G__49636 = expr__49631;
return (pred__49630.cljs$core$IFn$_invoke$arity$2 ? pred__49630.cljs$core$IFn$_invoke$arity$2(G__49635,G__49636) : pred__49630.call(null,G__49635,G__49636));
})())){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__49600,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__49637 = new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519);
var G__49638 = expr__49631;
return (pred__49630.cljs$core$IFn$_invoke$arity$2 ? pred__49630.cljs$core$IFn$_invoke$arity$2(G__49637,G__49638) : pred__49630.call(null,G__49637,G__49638));
})())){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,G__49600,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__49639 = new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231);
var G__49640 = expr__49631;
return (pred__49630.cljs$core$IFn$_invoke$arity$2 ? pred__49630.cljs$core$IFn$_invoke$arity$2(G__49639,G__49640) : pred__49630.call(null,G__49639,G__49640));
})())){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,G__49600,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__49641 = new cljs.core.Keyword(null,"children","children",-940561982);
var G__49642 = expr__49631;
return (pred__49630.cljs$core$IFn$_invoke$arity$2 ? pred__49630.cljs$core$IFn$_invoke$arity$2(G__49641,G__49642) : pred__49630.call(null,G__49641,G__49642));
})())){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,G__49600,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__49600),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__49600){
var self__ = this;
var this__4438__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,G__49600,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__49604){
var extmap__4478__auto__ = (function (){var G__49643 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__49604,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__49604)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__49643);
} else {
return G__49643;
}
})();
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__49604),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130).cljs$core$IFn$_invoke$arity$1(G__49604),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__49604),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__49604),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__49604),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"list","list",765357683),rewrite_clj.node.seq.wrap_list,(2),(function (p1__49644_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,p1__49644_SHARP_);
}),children);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"map","map",1371690461),rewrite_clj.node.seq.wrap_map,(2),(function (p1__49647_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,p1__49647_SHARP_);
}),children);
});
