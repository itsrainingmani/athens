...
if((x instanceof cljs.core.Keyword)){
var G__76888 = spec;
var G__76889 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__76888,G__76889) : f.call(null,G__76888,G__76889));
} else {
if(typeof x === 'string'){
...
if((x instanceof cljs.core.Keyword)){
var G__76890 = spec;
var G__76891 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__76890,G__76891) : f.call(null,G__76890,G__76891));
} else {
return x;
...
}catch (e76894){if((e76894 instanceof Error)){
var ___$1 = e76894;
return x;
} else {
throw e76894;
...
}catch (e76896){if((e76896 instanceof Error)){
var ___$1 = e76896;
return x;
} else {
throw e76896;
...
}catch (e76897){if((e76897 instanceof Error)){
var ___$1 = e76897;
return x;
} else {
throw e76897;
...
}catch (e76898){if((e76898 instanceof Error)){
var ___$1 = e76898;
return x;
} else {
throw e76898;
...
spec_tools.transform.strip_extra_keys = (function spec_tools$transform$strip_extra_keys(p__76899,x){
var map__76900 = p__76899;
var map__76900__$1 = (((((!((map__76900 == null))))?(((((map__76900.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__76900.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__76900):map__76900);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76900__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.fail_on_extra_keys = (function spec_tools$transform$fail_on_extra_keys(p__76910,x){
var map__76911 = p__76910;
var map__76911__$1 = (((((!((map__76911 == null))))?(((((map__76911.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__76911.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__76911):map__76911);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76911__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.strip_extra_values = (function spec_tools$transform$strip_extra_values(p__76913,x){
var map__76914 = p__76913;
var map__76914__$1 = (((((!((map__76914 == null))))?(((((map__76914.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__76914.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__76914):map__76914);
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76914__$1,new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600));
