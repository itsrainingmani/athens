...
var map__78037 = spec_tools.impl.parse_keys(spec_tools.impl.extract_form(spec));
var map__78037__$1 = (((((!((map__78037 == null))))?(((((map__78037.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__78037.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__78037):map__78037);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78037__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78037__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78037__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78037__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var map__78068 = spec_tools.parse.parse_spec(form);
var map__78068__$1 = (((((!((map__78068 == null))))?(((((map__78068.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__78068.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__78068):map__78068);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78068__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var G__78070 = type;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__78070__$1)].join('')));
...
var vec__78092 = spec_tools.impl.strip_fn_if_needed(spec);
var ___$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78092,(0),null);
var minimum = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78092,(1),null);
var maximum = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78092,(2),null);
var ___$4 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78092,(3),null);
...
var vec__78096 = spec_tools.impl.extract_form(spec);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78096,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78096,(1),null);
...
var extra_info = (function (){var G__78099 = cljs.core.select_keys(data,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"description","description",-1428560544)], null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__78099,new cljs.core.Keyword(null,"title","title",636505583),spec_tools.impl.qualified_name(name));
} else {
return G__78099;
}
})();
