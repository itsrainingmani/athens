...
var re_frame$router$IEventQueue$push$dyn_32343 = (function (this$,event){
...
return re_frame$router$IEventQueue$push$dyn_32343(this$,event);
}
});

var re_frame$router$IEventQueue$add_post_event_callback$dyn_32347 = (function (this$,id,callack){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$add_post_event_callback$dyn_32347(this$,id,callack);
}
});
...
var re_frame$router$IEventQueue$_fsm_trigger$dyn_32360 = (function (this$,trigger,arg){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$_fsm_trigger$dyn_32360(this$,trigger,arg);
}
});

var re_frame$router$IEventQueue$_add_event$dyn_32375 = (function (this$,event){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$_add_event$dyn_32375(this$,event);
}
});
...
var re_frame$router$IEventQueue$_run_next_tick$dyn_32383 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$_run_next_tick$dyn_32383(this$);
}
});
...
var re_frame$router$IEventQueue$_pause$dyn_32389 = (function (this$,later_fn){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$_pause$dyn_32389(this$,later_fn);
}
});

var re_frame$router$IEventQueue$_resume$dyn_32391 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$_resume$dyn_32391(this$);
}
});

var re_frame$router$IEventQueue$_call_post_event_callbacks$dyn_32393 = (function (this$,event){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$_call_post_event_callbacks$dyn_32393(this$,event);
}
});
...
return (re_frame.interop.next_tick.cljs$core$IFn$_invoke$arity$1 ? re_frame.interop.next_tick.cljs$core$IFn$_invoke$arity$1(G__32305) : re_frame.interop.next_tick.call(null,G__32305));
}));
...
var _STAR_current_trace_STAR__orig_val__32306 = re_frame.trace._STAR_current_trace_STAR_;
var _STAR_current_trace_STAR__temp_val__32307 = re_frame.trace.start_trace(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"op-type","op-type",-1636141668),new cljs.core.Keyword("re-frame.router","fsm-trigger","re-frame.router/fsm-trigger",1379787274)], null));
(re_frame.trace._STAR_current_trace_STAR_ = _STAR_current_trace_STAR__temp_val__32307);

try{try{var vec__32308 = (function (){var G__32311 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [self__.fsm_state,trigger], null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"idle","idle",-2007156861),new cljs.core.Keyword(null,"add-event","add-event",938429088)], null),G__32311)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"running","running",1554969103),new cljs.core.Keyword(null,"exception","exception",-335277064)], null),G__32311)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"running","running",1554969103),new cljs.core.Keyword(null,"finish-run","finish-run",753148477)], null),G__32311)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"running","running",1554969103),new cljs.core.Keyword(null,"pause","pause",-2095325672)], null),G__32311)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"paused","paused",-1710376127),new cljs.core.Keyword(null,"resume","resume",-118572261)], null),G__32311)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"scheduled","scheduled",553898551),new cljs.core.Keyword(null,"run-queue","run-queue",-1701798027)], null),G__32311)){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"running","running",1554969103),(function (){
return this$__$1.re_frame$router$IEventQueue$_run_queue$arity$1(null);
})], null);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"paused","paused",-1710376127),new cljs.core.Keyword(null,"add-event","add-event",938429088)], null),G__32311)){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"paused","paused",-1710376127),(function (){
return this$__$1.re_frame$router$IEventQueue$_add_event$arity$2(null,arg);
})], null);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"running","running",1554969103),new cljs.core.Keyword(null,"add-event","add-event",938429088)], null),G__32311)){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"running","running",1554969103),(function (){
return this$__$1.re_frame$router$IEventQueue$_add_event$arity$2(null,arg);
})], null);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"scheduled","scheduled",553898551),new cljs.core.Keyword(null,"add-event","add-event",938429088)], null),G__32311)){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"scheduled","scheduled",553898551),(function (){
return this$__$1.re_frame$router$IEventQueue$_add_event$arity$2(null,arg);
})], null);
} else {
...
var new_fsm_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32308,(0),null);
var action_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32308,(1),null);
if(re_frame.trace.is_trace_enabled_QMARK_()){
...
}}finally {(re_frame.trace._STAR_current_trace_STAR_ = _STAR_current_trace_STAR__orig_val__32306);
}} else {
...
return (later_fn.cljs$core$IFn$_invoke$arity$1 ? later_fn.cljs$core$IFn$_invoke$arity$1(G__32323) : later_fn.call(null,G__32323));
}));
...
var self__ = this;
var ___$1 = this;
var seq__32328 = cljs.core.seq(cljs.core.vals(self__.post_event_callback_fns));
var chunk__32329 = null;
var count__32330 = (0);
var i__32331 = (0);
while(true){
if((i__32331 < count__32330)){
var callback = chunk__32329.cljs$core$IIndexed$_nth$arity$2(null,i__32331);
...
var G__32420 = seq__32328;
var G__32421 = chunk__32329;
var G__32422 = count__32330;
var G__32423 = (i__32331 + (1));
seq__32328 = G__32420;
chunk__32329 = G__32421;
count__32330 = G__32422;
i__32331 = G__32423;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__32328);
if(temp__5735__auto__){
var seq__32328__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__32328__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__32328__$1);
var G__32425 = cljs.core.chunk_rest(seq__32328__$1);
var G__32426 = c__4556__auto__;
var G__32427 = cljs.core.count(c__4556__auto__);
var G__32428 = (0);
seq__32328 = G__32425;
chunk__32329 = G__32426;
count__32330 = G__32427;
i__32331 = G__32428;
continue;
} else {
var callback = cljs.core.first(seq__32328__$1);
(callback.cljs$core$IFn$_invoke$arity$2 ? callback.cljs$core$IFn$_invoke$arity$2(event_v,self__.queue) : callback.call(null,event_v,self__.queue));


var G__32429 = cljs.core.next(seq__32328__$1);
var G__32430 = null;
var G__32431 = (0);
var G__32432 = (0);
seq__32328 = G__32429;
chunk__32329 = G__32430;
count__32330 = G__32431;
i__32331 = G__32432;
continue;
}
} else {
