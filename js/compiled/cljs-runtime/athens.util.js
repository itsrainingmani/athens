...
var G__46438 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(nodes,node__$1);
var G__46439 = node__$1.parentNode;
nodes = G__46438;
node__$1 = G__46439;
continue;
}
...
try{var vec__46402 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(uid,"-");
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46402,(0),null);
var d = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46402,(1),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46402,(2),null);
 ...
 */
athens.util.remember_ws_QMARK_ = (function athens$util$remember_ws_QMARK_(){
var rws = localStorage.getItem("ws/remember-ws");
if((rws == null)){
return false;
} else {
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2("off",rws);
}
});
/**
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__46421_SHARP_){
return parseInt(p1__46421_SHARP_);
