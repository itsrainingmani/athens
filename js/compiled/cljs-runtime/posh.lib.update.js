...
posh.lib.update.update_pull = (function posh$lib$update$update_pull(p__69330,storage_key){
var map__69331 = p__69330;
var map__69331__$1 = (((((!((map__69331 == null))))?(((((map__69331.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__69331.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__69331):map__69331);
var posh_tree = map__69331__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69331__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69331__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));
var vec__69333 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69333,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69333,(1),null);
var pull_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69333,(2),null);
var eid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69333,(3),null);
...
posh.lib.update.update_filter_pull = (function posh$lib$update$update_filter_pull(p__69336,storage_key){
...
var posh_tree = map__69337__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69337__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69337__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));
var vec__69339 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69339,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69339,(1),null);
var pull_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69339,(2),null);
var eid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69339,(3),null);
...
posh.lib.update.update_pull_many = (function posh$lib$update$update_pull_many(p__69342,storage_key){
var map__69343 = p__69342;
var map__69343__$1 = (((((!((map__69343 == null))))?(((((map__69343.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__69343.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__69343):map__69343);
var posh_tree = map__69343__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69343__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69343__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));
var vec__69345 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69345,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69345,(1),null);
var pull_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69345,(2),null);
var eids = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69345,(3),null);
...
posh.lib.update.update_q_with_dbvarmap = (function posh$lib$update$update_q_with_dbvarmap(p__69348,storage_key){
...
var posh_tree = map__69349__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69349__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69349__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));

var vec__69351 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69351,(0),null);
var query = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69351,(1),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69351,(2),null);
...
var poshdbmap = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.merge,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__69354){
var vec__69355 = p__69354;
var db_sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69355,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69355,(1),null);
return cljs.core.PersistentArrayMap.createAsIfByAssoc([db_sym,posh.lib.db.poshdb__GT_analyze_db(posh_tree,poshdb)]);
}),dbvarmap));
var fixed_args = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__69358){
var vec__69359 = p__69358;
var sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69359,(0),null);
var arg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69359,(1),null);
...
var G__69362 = cljs.core.first(storage_key);
var G__69362__$1 = (((G__69362 instanceof cljs.core.Keyword))?G__69362.fqn:null);
switch (G__69362__$1) {
case "pull":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__69362__$1)].join('')));
