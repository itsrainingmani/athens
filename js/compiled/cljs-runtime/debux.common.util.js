...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57122_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__57122_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57121_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57121_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57123_SHARP_){
return (((p1__57123_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__57123_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__57126,mapping){
...
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57127__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57127__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57127__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57124_SHARP_){
if((p1__57124_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__57124_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__57256 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__57257 = clojure.zip.next(loc);
loc = G__57257;
continue;
}
}
...
var len__4736__auto___57272 = arguments.length;
var i__4737__auto___57273 = (0);
while(true){
if((i__4737__auto___57273 < len__4736__auto___57272)){
args__4742__auto__.push((arguments[i__4737__auto___57273]));

var G__57274 = (i__4737__auto___57273 + (1));
i__4737__auto___57273 = G__57274;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__57170){
var vec__57171 = p__57170;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57171,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq57168){
var G__57169 = cljs.core.first(seq57168);
var seq57168__$1 = cljs.core.next(seq57168);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57169,seq57168__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__57174_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57174_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__57176_57277 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57177_57278 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57178_57279 = true;
var _STAR_print_fn_STAR__temp_val__57179_57280 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57178_57279);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57179_57280);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57177_57278);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57176_57277);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__57175_SHARP_){
return debux.common.util.prepend_bars(p1__57175_SHARP_,indent_level);
...
var G__57282 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__57281;
acc = G__57282;
continue;
} else {
if(typeof f === 'string'){
var G__57283 = cljs.core.next(opts__$1);
var G__57284 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__57283;
acc = G__57284;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__57285 = cljs.core.nnext(opts__$1);
var G__57286 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__57285;
acc = G__57286;
continue;
} else {
...
var G__57288 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__57287;
acc = G__57288;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__57194 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__57194.cljs$core$IFn$_invoke$arity$1 ? fexpr__57194.cljs$core$IFn$_invoke$arity$1(f) : fexpr__57194.call(null,f));
})())){
...
if(cljs.core.truth_((function (){var fexpr__57198 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__57198.cljs$core$IFn$_invoke$arity$1 ? fexpr__57198.cljs$core$IFn$_invoke$arity$1(f) : fexpr__57198.call(null,f));
})())){
...
var G__57293 = cljs.core.next(opts__$1);
var G__57294 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__57293;
acc = G__57294;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__57208){
var vec__57209 = p__57208;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57209,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57209,(1),null);
...
var G__57218 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__57217 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
...
return (function() { 
var G__57297__delegate = function (arg){
...
var G__57297 = function (var_args){
var arg = null;
if (arguments.length > 0) {
var G__57298__i = 0, G__57298__a = new Array(arguments.length -  0);
while (G__57298__i < G__57298__a.length) {G__57298__a[G__57298__i] = arguments[G__57298__i + 0]; ++G__57298__i;}
  arg = new cljs.core.IndexedSeq(G__57298__a,0,null);
} 
return G__57297__delegate.call(this,arg);};
G__57297.cljs$lang$maxFixedArity = 0;
G__57297.cljs$lang$applyTo = (function (arglist__57299){
var arg = cljs.core.seq(arglist__57299);
return G__57297__delegate(arg);
});
G__57297.cljs$core$IFn$_invoke$arity$variadic = G__57297__delegate;
return G__57297;
})()
;
});
