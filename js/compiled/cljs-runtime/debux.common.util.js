...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57100_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__57100_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57099_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57099_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57101_SHARP_){
return (((p1__57101_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__57101_SHARP_) == null)));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57102_SHARP_){
if((p1__57102_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__57102_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__57196 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__57197 = clojure.zip.next(loc);
loc = G__57197;
continue;
}
}
...
var len__4736__auto___57212 = arguments.length;
var i__4737__auto___57216 = (0);
while(true){
if((i__4737__auto___57216 < len__4736__auto___57212)){
args__4742__auto__.push((arguments[i__4737__auto___57216]));

var G__57220 = (i__4737__auto___57216 + (1));
i__4737__auto___57216 = G__57220;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__57116){
var vec__57117 = p__57116;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57117,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq57113){
var G__57114 = cljs.core.first(seq57113);
var seq57113__$1 = cljs.core.next(seq57113);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57114,seq57113__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__57120_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57120_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__57122_57232 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57123_57233 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57124_57234 = true;
var _STAR_print_fn_STAR__temp_val__57125_57235 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57124_57234);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57125_57235);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57123_57233);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57122_57232);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__57121_SHARP_){
return debux.common.util.prepend_bars(p1__57121_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__57236 = cljs.core.next(opts__$1);
var G__57237 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__57236;
acc = G__57237;
continue;
} else {
if(typeof f === 'string'){
var G__57238 = cljs.core.next(opts__$1);
var G__57239 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__57238;
acc = G__57239;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__57240 = cljs.core.nnext(opts__$1);
var G__57241 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__57240;
acc = G__57241;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__57242 = cljs.core.next(opts__$1);
var G__57243 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__57242;
acc = G__57243;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__57142 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__57142.cljs$core$IFn$_invoke$arity$1 ? fexpr__57142.cljs$core$IFn$_invoke$arity$1(f) : fexpr__57142.call(null,f));
})())){
var G__57246 = cljs.core.next(opts__$1);
var G__57247 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__57246;
acc = G__57247;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__57143 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__57143.cljs$core$IFn$_invoke$arity$1 ? fexpr__57143.cljs$core$IFn$_invoke$arity$1(f) : fexpr__57143.call(null,f));
})())){
var G__57248 = cljs.core.nnext(opts__$1);
var G__57249 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__57248;
acc = G__57249;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__57250 = cljs.core.next(opts__$1);
var G__57251 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__57250;
acc = G__57251;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__57144){
var vec__57145 = p__57144;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57145,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57145,(1),null);
...
var G__57149 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__57148 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__57148.cljs$core$IFn$_invoke$arity$1 ? fexpr__57148.cljs$core$IFn$_invoke$arity$1(G__57149) : fexpr__57148.call(null,G__57149));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__57151 = quoted_form;
var G__57152 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__57151,G__57152) : debux.common.util.remove_d.call(null,G__57151,G__57152));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__57157 = quoted_form;
var G__57158 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__57157,G__57158) : debux.common.util.remove_d.call(null,G__57157,G__57158));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__57256__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__57168 = quoted_form;
var G__57169 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__57168,G__57169) : debux.common.util.remove_d.call(null,G__57168,G__57169));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
var G__57265__i = 0, G__57265__a = new Array(arguments.length -  0);
while (G__57265__i < G__57265__a.length) {G__57265__a[G__57265__i] = arguments[G__57265__i + 0]; ++G__57265__i;}
  arg = new cljs.core.IndexedSeq(G__57265__a,0,null);
} 
return G__57256__delegate.call(this,arg);};
G__57256.cljs$lang$maxFixedArity = 0;
G__57256.cljs$lang$applyTo = (function (arglist__57267){
var arg = cljs.core.seq(arglist__57267);
return G__57256__delegate(arg);
});
...
var G__57280 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__57280;
continue;
} else {
...
var G__57281 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__57281;
continue;
} else {
var G__57282 = clojure.zip.next(loc);
loc = G__57282;
continue;
