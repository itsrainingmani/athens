...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__75484_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__75484_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__75483_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__75483_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__75485_SHARP_){
return (((p1__75485_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__75485_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__75488,mapping){
var map__75489 = p__75488;
var map__75489__$1 = (((((!((map__75489 == null))))?(((((map__75489.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__75489.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__75489):map__75489);
var state = map__75489__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75489__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75489__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75489__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__75486_SHARP_){
if((p1__75486_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__75486_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__75582 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__75583 = clojure.zip.next(loc);
loc = G__75583;
continue;
}
}
...
var len__4789__auto___75586 = arguments.length;
var i__4790__auto___75587 = (0);
while(true){
if((i__4790__auto___75587 < len__4789__auto___75586)){
args__4795__auto__.push((arguments[i__4790__auto___75587]));

var G__75588 = (i__4790__auto___75587 + (1));
i__4790__auto___75587 = G__75588;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__75518){
var vec__75519 = p__75518;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75519,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq75499){
var G__75500 = cljs.core.first(seq75499);
var seq75499__$1 = cljs.core.next(seq75499);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__75500,seq75499__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__75526_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__75526_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__75542_75597 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__75543_75598 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__75544_75599 = true;
var _STAR_print_fn_STAR__temp_val__75545_75600 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__75544_75599);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__75545_75600);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__75543_75598);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__75542_75597);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__75534_SHARP_){
return debux.common.util.prepend_bars(p1__75534_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__75604 = cljs.core.next(opts__$1);
var G__75605 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__75604;
acc = G__75605;
continue;
} else {
if(typeof f === 'string'){
var G__75607 = cljs.core.next(opts__$1);
var G__75608 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__75607;
acc = G__75608;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__75609 = cljs.core.nnext(opts__$1);
var G__75610 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__75609;
acc = G__75610;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__75611 = cljs.core.next(opts__$1);
var G__75612 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__75611;
acc = G__75612;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__75558 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__75558.cljs$core$IFn$_invoke$arity$1 ? fexpr__75558.cljs$core$IFn$_invoke$arity$1(f) : fexpr__75558.call(null,f));
})())){
var G__75614 = cljs.core.next(opts__$1);
var G__75615 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__75614;
acc = G__75615;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__75559 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__75559.cljs$core$IFn$_invoke$arity$1 ? fexpr__75559.cljs$core$IFn$_invoke$arity$1(f) : fexpr__75559.call(null,f));
})())){
var G__75617 = cljs.core.nnext(opts__$1);
var G__75618 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__75617;
acc = G__75618;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__75619 = cljs.core.next(opts__$1);
var G__75620 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__75619;
acc = G__75620;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__75560){
var vec__75561 = p__75560;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75561,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75561,(1),null);
...
var G__75566 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__75565 = (function (){var fexpr__75567 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten);
return (fexpr__75567.cljs$core$IFn$_invoke$arity$1 ? fexpr__75567.cljs$core$IFn$_invoke$arity$1(form) : fexpr__75567.call(null,form));
})();
return (fexpr__75565.cljs$core$IFn$_invoke$arity$1 ? fexpr__75565.cljs$core$IFn$_invoke$arity$1(G__75566) : fexpr__75565.call(null,G__75566));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__75569 = quoted_form;
var G__75570 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__75569,G__75570) : debux.common.util.remove_d.call(null,G__75569,G__75570));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__75571 = quoted_form;
var G__75572 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__75571,G__75572) : debux.common.util.remove_d.call(null,G__75571,G__75572));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__75632__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__75573 = quoted_form;
var G__75574 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__75573,G__75574) : debux.common.util.remove_d.call(null,G__75573,G__75574));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));

return result;
};
var G__75632 = function (var_args){
var arg = null;
...
while (G__75636__i < G__75636__a.length) {G__75636__a[G__75636__i] = arguments[G__75636__i + 0]; ++G__75636__i;}
  arg = new cljs.core.IndexedSeq(G__75636__a,0,null);
} 
return G__75632__delegate.call(this,arg);};
G__75632.cljs$lang$maxFixedArity = 0;
G__75632.cljs$lang$applyTo = (function (arglist__75637){
var arg = cljs.core.seq(arglist__75637);
return G__75632__delegate(arg);
});
G__75632.cljs$core$IFn$_invoke$arity$variadic = G__75632__delegate;
return G__75632;
})()
;
});
...
var G__75638 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__75638;
continue;
} else {
...
var G__75639 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__75639;
continue;
} else {
var G__75640 = clojure.zip.next(loc);
loc = G__75640;
continue;
