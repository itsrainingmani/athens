...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57107_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__57107_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57106_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57106_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57108_SHARP_){
return (((p1__57108_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__57108_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__57124,mapping){
...
var state = map__57125__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57125__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57125__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57125__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57122_SHARP_){
if((p1__57122_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__57122_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__57254 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__57255 = clojure.zip.next(loc);
loc = G__57255;
continue;
}
}
...
var len__4736__auto___57266 = arguments.length;
var i__4737__auto___57267 = (0);
while(true){
if((i__4737__auto___57267 < len__4736__auto___57266)){
args__4742__auto__.push((arguments[i__4737__auto___57267]));

var G__57272 = (i__4737__auto___57267 + (1));
i__4737__auto___57267 = G__57272;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__57168){
var vec__57169 = p__57168;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57169,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq57166){
var G__57167 = cljs.core.first(seq57166);
var seq57166__$1 = cljs.core.next(seq57166);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57167,seq57166__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__57172_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57172_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__57174_57274 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57175_57275 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57176_57276 = true;
var _STAR_print_fn_STAR__temp_val__57177_57277 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57176_57276);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57177_57277);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57175_57275);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57174_57274);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__57173_SHARP_){
return debux.common.util.prepend_bars(p1__57173_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__57279 = cljs.core.next(opts__$1);
var G__57280 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__57279;
acc = G__57280;
continue;
} else {
if(typeof f === 'string'){
var G__57281 = cljs.core.next(opts__$1);
var G__57282 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__57281;
acc = G__57282;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__57283 = cljs.core.nnext(opts__$1);
var G__57284 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__57283;
acc = G__57284;
continue;
} else {
...
var G__57286 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__57285;
acc = G__57286;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__57192 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__57192.cljs$core$IFn$_invoke$arity$1 ? fexpr__57192.cljs$core$IFn$_invoke$arity$1(f) : fexpr__57192.call(null,f));
})())){
var G__57287 = cljs.core.next(opts__$1);
var G__57288 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__57287;
acc = G__57288;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__57193 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__57193.cljs$core$IFn$_invoke$arity$1 ? fexpr__57193.cljs$core$IFn$_invoke$arity$1(f) : fexpr__57193.call(null,f));
})())){
var G__57289 = cljs.core.nnext(opts__$1);
var G__57290 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__57289;
acc = G__57290;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__57291 = cljs.core.next(opts__$1);
var G__57292 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__57291;
acc = G__57292;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__57194){
var vec__57195 = p__57194;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57195,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57195,(1),null);
...
var G__57208 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__57207 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__57207.cljs$core$IFn$_invoke$arity$1 ? fexpr__57207.cljs$core$IFn$_invoke$arity$1(G__57208) : fexpr__57207.call(null,G__57208));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__57218 = quoted_form;
var G__57219 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__57218,G__57219) : debux.common.util.remove_d.call(null,G__57218,G__57219));
...
while (G__57296__i < G__57296__a.length) {G__57296__a[G__57296__i] = arguments[G__57296__i + 0]; ++G__57296__i;}
  arg = new cljs.core.IndexedSeq(G__57296__a,0,null);
} 
return G__57294__delegate.call(this,arg);};
G__57294.cljs$lang$maxFixedArity = 0;
G__57294.cljs$lang$applyTo = (function (arglist__57297){
var arg = cljs.core.seq(arglist__57297);
...
var G__57298 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__57298;
continue;
} else {
...
var G__57299 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__57299;
continue;
} else {
