...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57257_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__57257_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57256_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57256_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57258_SHARP_){
return (((p1__57258_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__57258_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__57261,mapping){
...
var state = map__57262__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57262__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57262__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57262__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57259_SHARP_){
if((p1__57259_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__57259_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__57311 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__57312 = clojure.zip.next(loc);
loc = G__57312;
continue;
}
}
...
var len__4736__auto___57315 = arguments.length;
var i__4737__auto___57316 = (0);
while(true){
if((i__4737__auto___57316 < len__4736__auto___57315)){
args__4742__auto__.push((arguments[i__4737__auto___57316]));

var G__57317 = (i__4737__auto___57316 + (1));
i__4737__auto___57316 = G__57317;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__57272){
var vec__57273 = p__57272;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57273,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq57270){
var G__57271 = cljs.core.first(seq57270);
var seq57270__$1 = cljs.core.next(seq57270);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57271,seq57270__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__57276_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57276_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__57278_57318 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57279_57319 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57280_57320 = true;
var _STAR_print_fn_STAR__temp_val__57281_57321 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57280_57320);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57281_57321);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57279_57319);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57278_57318);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__57277_SHARP_){
return debux.common.util.prepend_bars(p1__57277_SHARP_,indent_level);
...
var G__57324 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__57323;
acc = G__57324;
continue;
} else {
...
var G__57326 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__57325;
acc = G__57326;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__57327 = cljs.core.nnext(opts__$1);
var G__57328 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__57327;
acc = G__57328;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__57329 = cljs.core.next(opts__$1);
var G__57330 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__57329;
acc = G__57330;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__57284 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__57284.cljs$core$IFn$_invoke$arity$1 ? fexpr__57284.cljs$core$IFn$_invoke$arity$1(f) : fexpr__57284.call(null,f));
})())){
var G__57331 = cljs.core.next(opts__$1);
var G__57332 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__57331;
acc = G__57332;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__57285 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__57285.cljs$core$IFn$_invoke$arity$1 ? fexpr__57285.cljs$core$IFn$_invoke$arity$1(f) : fexpr__57285.call(null,f));
})())){
var G__57333 = cljs.core.nnext(opts__$1);
var G__57334 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__57333;
acc = G__57334;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__57335 = cljs.core.next(opts__$1);
var G__57336 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__57335;
acc = G__57336;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__57286){
var vec__57287 = p__57286;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57287,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57287,(1),null);
...
var G__57291 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__57290 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__57290.cljs$core$IFn$_invoke$arity$1 ? fexpr__57290.cljs$core$IFn$_invoke$arity$1(G__57291) : fexpr__57290.call(null,G__57291));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__57303 = quoted_form;
var G__57304 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__57303,G__57304) : debux.common.util.remove_d.call(null,G__57303,G__57304));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__57337__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__57305 = quoted_form;
var G__57306 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__57305,G__57306) : debux.common.util.remove_d.call(null,G__57305,G__57306));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));

return result;
};
var G__57337 = function (var_args){
var arg = null;
if (arguments.length > 0) {
var G__57338__i = 0, G__57338__a = new Array(arguments.length -  0);
while (G__57338__i < G__57338__a.length) {G__57338__a[G__57338__i] = arguments[G__57338__i + 0]; ++G__57338__i;}
  arg = new cljs.core.IndexedSeq(G__57338__a,0,null);
} 
return G__57337__delegate.call(this,arg);};
G__57337.cljs$lang$maxFixedArity = 0;
G__57337.cljs$lang$applyTo = (function (arglist__57339){
var arg = cljs.core.seq(arglist__57339);
return G__57337__delegate(arg);
});
...
var G__57340 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__57340;
continue;
} else {
...
var G__57341 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__57341;
continue;
} else {
var G__57342 = clojure.zip.next(loc);
loc = G__57342;
continue;
