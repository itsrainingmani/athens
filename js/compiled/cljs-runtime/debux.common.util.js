 ...
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__57222,mapping){
...
var state = map__57223__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57223__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57223__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57223__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57220_SHARP_){
if((p1__57220_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__57220_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57245,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq57242){
var G__57243 = cljs.core.first(seq57242);
var seq57242__$1 = cljs.core.next(seq57242);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57243,seq57242__$1);
}));
...
var _STAR_print_newline_STAR__orig_val__57250_57308 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57251_57309 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57252_57310 = true;
var _STAR_print_fn_STAR__temp_val__57253_57311 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57252_57310);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57253_57311);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57251_57309);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57250_57308);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__57249_SHARP_){
return debux.common.util.prepend_bars(p1__57249_SHARP_,indent_level);
...
var G__57313 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__57312;
acc = G__57313;
continue;
} else {
...
var G__57315 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__57314;
acc = G__57315;
continue;
} else {
...
var G__57317 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__57316;
acc = G__57317;
continue;
} else {
...
var G__57319 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__57318;
acc = G__57319;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__57271 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__57271.cljs$core$IFn$_invoke$arity$1 ? fexpr__57271.cljs$core$IFn$_invoke$arity$1(f) : fexpr__57271.call(null,f));
})())){
var G__57320 = cljs.core.next(opts__$1);
var G__57321 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__57320;
acc = G__57321;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__57272 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__57272.cljs$core$IFn$_invoke$arity$1 ? fexpr__57272.cljs$core$IFn$_invoke$arity$1(f) : fexpr__57272.call(null,f));
})())){
var G__57322 = cljs.core.nnext(opts__$1);
var G__57323 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__57322;
acc = G__57323;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__57324 = cljs.core.next(opts__$1);
var G__57325 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__57324;
acc = G__57325;
continue;
} else {
...
while (G__57327__i < G__57327__a.length) {G__57327__a[G__57327__i] = arguments[G__57327__i + 0]; ++G__57327__i;}
  arg = new cljs.core.IndexedSeq(G__57327__a,0,null);
} 
...
var arg = cljs.core.seq(arglist__57328);
...
var G__57329 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__57329;
continue;
} else {
...
var G__57330 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__57330;
continue;
} else {
var G__57331 = clojure.zip.next(loc);
loc = G__57331;
continue;
