...
var o__20643__auto__ = devtools.formatters.budgeting.over_budget_values;
return (o__20643__auto__["add"]).call(o__20643__auto__,value);
}
});
...
var o__20643__auto__ = devtools.formatters.budgeting.over_budget_values;
return (o__20643__auto__["delete"]).call(o__20643__auto__,value);
}
});
...
var o__20643__auto__ = devtools.formatters.budgeting.over_budget_values;
return (o__20643__auto__["has"]).call(o__20643__auto__,value);
}
});
...
var G__23797 = data;
var target__20653__auto__ = G__23797;
if(cljs.core.truth_(target__20653__auto__)){
} else {
...
(target__20653__auto__["config"] = devtools.formatters.state.set_depth_budget(config,depth_budget));
