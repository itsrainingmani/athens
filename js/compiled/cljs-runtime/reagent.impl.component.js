...
if((i < len)){
var k = (ks[i]);
var G__52052 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__52053 = (i + (1));
m = G__52052;
i = G__52053;
continue;
...
var temp__5737__auto__ = p.argv;
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__51998 = p.children;
return module$node_modules$react$index.Children.toArray(G__51998);
})());
} else {
var v = temp__5737__auto__;
...
return G__52000__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__52002 = c;
var G__52002__$1 = (((G__52002 == null))?null:G__52002.prototype);
if((G__52002__$1 == null)){
return null;
} else {
return G__52002__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__52109__delegate = function (args){
var G__52009 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__52009) : reagent.impl.component.as_element.call(null,G__52009));
};
var G__52109 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__52110__i = 0, G__52110__a = new Array(arguments.length -  0);
while (G__52110__i < G__52110__a.length) {G__52110__a[G__52110__i] = arguments[G__52110__i + 0]; ++G__52110__i;}
  args = new cljs.core.IndexedSeq(G__52110__a,0,null);
} 
return G__52109__delegate.call(this,args);};
G__52109.cljs$lang$maxFixedArity = 0;
G__52109.cljs$lang$applyTo = (function (arglist__52111){
var args = cljs.core.seq(arglist__52111);
return G__52109__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__52010 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__52011 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__52011);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__52010);
}});
...
var c = this;
var G__52020_52128 = goog.object.get(c,"cljsRatom");
if((G__52020_52128 == null)){
} else {
reagent.ratom.dispose_BANG_(G__52020_52128);
}
...
var renders_52142 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_52143 = cljs.core.first(cljs.core.vals(renders_52142));
...
if((cljs.core.count(renders_52142) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_52142))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_52143)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_52143], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__52026 = o;
var G__52027_52144 = G__52026;
var G__52028_52145 = cljs.core.name(k);
var G__52029_52146 = v;
goog.object.set(G__52027_52144,G__52028_52145,G__52029_52146);
...
var G__52030_52147 = cmp.prototype;
var G__52031_52148 = module$node_modules$react$index.Component.prototype;
var G__52032_52149 = methods$;
goog.object.extend(G__52030_52147,G__52031_52148,G__52032_52149);
...
var name = (function (){var G__52033 = fiber;
var G__52033__$1 = (((G__52033 == null))?null:G__52033.type);
if((G__52033__$1 == null)){
return null;
} else {
return G__52033__$1.displayName;
}
})();
var parent = (function (){var G__52034 = fiber;
if((G__52034 == null)){
return null;
} else {
return G__52034.return;
}
})();
var path = (function (){var G__52035 = parent;
var G__52035__$1 = (((G__52035 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__52035) : reagent.impl.component.fiber_component_path.call(null,G__52035)));
if((G__52035__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__52035__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4185__auto__ = (function (){var G__52037 = c;
if((G__52037 == null)){
return null;
} else {
return goog.object.get(G__52037,"_reactInternalFiber");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__52038._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4185__auto__ = (function (){var G__52040 = c;
if((G__52040 == null)){
return null;
} else {
return goog.object.get(G__52040,"_reactInternalInstance");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var or__4185__auto____$1 = (function (){var G__52042 = c;
if((G__52042 == null)){
return null;
} else {
return G__52042._reactInternalInstance;
}
})();
if(cljs.core.truth_(or__4185__auto____$1)){
return or__4185__auto____$1;
...
var elem = (function (){var or__4185__auto__ = (function (){var G__52044 = instance;
if((G__52044 == null)){
return null;
} else {
return goog.object.get(G__52044,"_currentElement");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var G__52045 = instance;
if((G__52045 == null)){
return null;
} else {
return G__52045._currentElement;
}
}
})();
var name = (function (){var G__52046 = elem;
var G__52046__$1 = (((G__52046 == null))?null:G__52046.type);
if((G__52046__$1 == null)){
return null;
} else {
return G__52046__$1.displayName;
}
})();
var owner = (function (){var or__4185__auto__ = (function (){var G__52048 = elem;
if((G__52048 == null)){
return null;
} else {
return goog.object.get(G__52048,"_owner");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__52049._owner;
}
}
})();
var path = (function (){var G__52050 = owner;
var G__52050__$1 = (((G__52050 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__52050) : reagent.impl.component.component_path.call(null,G__52050)));
if((G__52050__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__52050__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__52051 = c;
var G__52051__$1 = (((G__52051 == null))?null:G__52051.constructor);
if((G__52051__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__52051__$1);
}
}
})();
