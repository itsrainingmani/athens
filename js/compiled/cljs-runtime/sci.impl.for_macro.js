...
sci.impl.for_macro.expand_for = (function sci$impl$for_macro$expand_for(_,p__62272){
var vec__62273 = p__62272;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62273,(0),null);
var seq_exprs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62273,(1),null);
var body_expr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62273,(2),null);
sci.impl.for_macro.assert_args(seq_exprs,body_expr);

var to_groups = (function (seq_exprs__$1){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (groups,p__62276){
var vec__62277 = p__62276;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62277,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62277,(1),null);
...
var err = (function() { 
var G__62307__delegate = function (msg){
throw (new Error(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,msg)));
};
var G__62307 = function (var_args){
var msg = null;
if (arguments.length > 0) {
var G__62308__i = 0, G__62308__a = new Array(arguments.length -  0);
while (G__62308__i < G__62308__a.length) {G__62308__a[G__62308__i] = arguments[G__62308__i + 0]; ++G__62308__i;}
  msg = new cljs.core.IndexedSeq(G__62308__a,0,null);
} 
return G__62307__delegate.call(this,msg);};
G__62307.cljs$lang$maxFixedArity = 0;
G__62307.cljs$lang$applyTo = (function (arglist__62309){
var msg = cljs.core.seq(arglist__62309);
return G__62307__delegate(msg);
});
G__62307.cljs$core$IFn$_invoke$arity$variadic = G__62307__delegate;
return G__62307;
})()
;
var emit_bind = (function sci$impl$for_macro$expand_for_$_emit_bind(p__62280){
var vec__62281 = p__62280;
var seq__62282 = cljs.core.seq(vec__62281);
var first__62283 = cljs.core.first(seq__62282);
var seq__62282__$1 = cljs.core.next(seq__62282);
var vec__62284 = first__62283;
var seq__62285 = cljs.core.seq(vec__62284);
var first__62286 = cljs.core.first(seq__62285);
var seq__62285__$1 = cljs.core.next(seq__62285);
var bind = first__62286;
var first__62286__$1 = cljs.core.first(seq__62285__$1);
var seq__62285__$2 = cljs.core.next(seq__62285__$1);
var expr = first__62286__$1;
var mod_pairs = seq__62285__$2;
var vec__62287 = seq__62282__$1;
var vec__62290 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62287,(0),null);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62290,(0),null);
var next_expr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62290,(1),null);
var next_groups = vec__62287;
...
var do_mod = (function sci$impl$for_macro$expand_for_$_emit_bind_$_do_mod(p__62293){
var vec__62294 = p__62293;
var seq__62295 = cljs.core.seq(vec__62294);
var first__62296 = cljs.core.first(seq__62295);
var seq__62295__$1 = cljs.core.next(seq__62295);
var vec__62297 = first__62296;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62297,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62297,(1),null);
var pair = vec__62297;
var etc = seq__62295__$1;
...
if(next_groups){
return cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","let","cljs.core/let",-308701135,null),null,(1),null)),(new cljs.core.List(null,cljs.core.vec(cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol(null,"iterys__62267__auto__","iterys__62267__auto__",1701514223,null),null,(1),null)),(new cljs.core.List(null,sci$impl$for_macro$expand_for_$_emit_bind(next_groups),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,new cljs.core.Symbol(null,"fs__62268__auto__","fs__62268__auto__",731066953,null),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","seq","cljs.core/seq",-1649497689,null),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol(null,"iterys__62267__auto__","iterys__62267__auto__",1701514223,null),null,(1),null)),(new cljs.core.List(null,next_expr,null,(1),null))))),null,(1),null))))),null,(1),null))], 0))))),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol(null,"if","if",1181717262,null),null,(1),null)),(new cljs.core.List(null,new cljs.core.Symbol(null,"fs__62268__auto__","fs__62268__auto__",731066953,null),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","concat","cljs.core/concat",-1133584918,null),null,(1),null)),(new cljs.core.List(null,new cljs.core.Symbol(null,"fs__62268__auto__","fs__62268__auto__",731066953,null),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,giter,null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","rest","cljs.core/rest",-285075455,null),null,(1),null)),(new cljs.core.List(null,gxs,null,(1),null))))),null,(1),null))))),null,(1),null))], 0)))),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,sci.impl.utils.allowed_recur,null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","rest","cljs.core/rest",-285075455,null),null,(1),null)),(new cljs.core.List(null,gxs,null,(1),null))))),null,(1),null))))),null,(1),null))], 0)))),null,(1),null))], 0))));
} else {
...
var do_cmod = (function sci$impl$for_macro$expand_for_$_emit_bind_$_do_cmod(p__62300){
var vec__62301 = p__62300;
var seq__62302 = cljs.core.seq(vec__62301);
var first__62303 = cljs.core.first(seq__62302);
var seq__62302__$1 = cljs.core.next(seq__62302);
var vec__62304 = first__62303;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62304,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62304,(1),null);
var pair = vec__62304;
var etc = seq__62302__$1;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(k,new cljs.core.Keyword(null,"let","let",-1282412701))){
