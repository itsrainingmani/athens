...
var instaparse$auto_flatten_seq$ConjFlat$conj_flat$dyn_46555 = (function (self,obj){
...
return instaparse$auto_flatten_seq$ConjFlat$conj_flat$dyn_46555(self,obj);
}
});

var instaparse$auto_flatten_seq$ConjFlat$cached_QMARK_$dyn_46559 = (function (self){
var x__4428__auto__ = (((self == null))?null:self);
...
return instaparse$auto_flatten_seq$ConjFlat$cached_QMARK_$dyn_46559(self);
}
});
...
var G__46560 = n__$1;
var G__46561 = y;
var G__46562 = cljs.core.imul(z,z);
n = G__46560;
y = G__46561;
z = G__46562;
continue;
...
var G__46563 = n__$1;
var G__46564 = cljs.core.imul(z,y);
var G__46565 = cljs.core.imul(z,z);
n = G__46563;
y = G__46564;
z = G__46565;
continue;
...
var G__46566 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(v__$1,(0));
var G__46567 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(index__$1,(0));
v__$1 = G__46566;
index__$1 = G__46567;
continue;
} else {
...
if((cljs.core.peek(index) < ((function (){var G__46486 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(v,cljs.core.pop(index));
return (instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1 ? instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1(G__46486) : instaparse.auto_flatten_seq.true_count.call(null,G__46486));
})() - (1)))){
...
var G__46568 = v;
var G__46569 = cljs.core.pop(index);
v = G__46568;
index = G__46569;
continue;
...
var self__ = this;
var self__ = this;
var G__46548 = (arguments.length - (1));
switch (G__46548) {
case (1):
...
(instaparse.auto_flatten_seq.FlattenOnDemandVector.prototype.apply = (function (self__,args46536){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args46536)));
}));
