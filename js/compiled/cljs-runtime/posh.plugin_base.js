...
var fexpr__36165 = new cljs.core.Keyword(null,"ratom","ratom",-126521267).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__36165.cljs$core$IFn$_invoke$arity$1 ? fexpr__36165.cljs$core$IFn$_invoke$arity$1(query_result) : fexpr__36165.call(null,query_result));
}
})();
var query_reaction = (function (){var G__36169 = (function (){
return cljs.core.deref(query_ratom);
});
var G__36170 = new cljs.core.Keyword(null,"on-dispose","on-dispose",2105306360);
var G__36171 = (function (_,___$1){
...
var fexpr__36168 = new cljs.core.Keyword(null,"make-reaction","make-reaction",295148585).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__36168.cljs$core$IFn$_invoke$arity$3 ? fexpr__36168.cljs$core$IFn$_invoke$arity$3(G__36169,G__36170,G__36171) : fexpr__36168.call(null,G__36169,G__36170,G__36171));
})();
...
return posh.core.add_pull(p1__36175_SHARP_,true_poshdb,pull_pattern,eid);
}),options);
}));
...
return posh.core.add_pull_many(p1__36189_SHARP_,true_poshdb,pull_pattern,eids);
}),options);
}));
...
return cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__36209,query_item){
var vec__36210 = p__36209;
var parsed_query = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36210,(0),null);
var last_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36210,(1),null);
...
var vec__36226 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(n_query_args,cljs.core.count(args)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [args,cljs.core.PersistentArrayMap.EMPTY], null):((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((n_query_args + (1)),cljs.core.count(args)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.butlast(args),cljs.core.last(args)], null):(function(){throw "Incorrect number of args passed to posh query"})()
));
var args__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36226,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36226,(1),null);
var true_poshdb_args = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__36218_SHARP_){
if(cljs.core.truth_((function (){var fexpr__36231 = new cljs.core.Keyword(null,"conn?","conn?",167224275).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__36231.cljs$core$IFn$_invoke$arity$1 ? fexpr__36231.cljs$core$IFn$_invoke$arity$1(p1__36218_SHARP_) : fexpr__36231.call(null,p1__36218_SHARP_));
})())){
return posh.plugin_base.get_db(dcfg,p1__36218_SHARP_);
} else {
return p1__36218_SHARP_;
}
}),args__$1);
var posh_atom = cljs.core.first(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__36219_SHARP_){
return posh.plugin_base.get_posh_atom(dcfg,p1__36219_SHARP_);
}),args__$1)));
...
/** @this {Function} */
(posh.plugin_base.q.cljs$lang$applyTo = (function (seq36222){
...
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36223,G__36224,seq36222__$2);
}));
...
var true_poshdb_args = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__36236_SHARP_){
...
return (fexpr__36247.cljs$core$IFn$_invoke$arity$1 ? fexpr__36247.cljs$core$IFn$_invoke$arity$1(p1__36236_SHARP_) : fexpr__36247.call(null,p1__36236_SHARP_));
})())){
return posh.plugin_base.get_db(dcfg,p1__36236_SHARP_);
} else {
return p1__36236_SHARP_;
}
}),args);
var posh_atom = cljs.core.first(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__36237_SHARP_){
return posh.plugin_base.get_posh_atom(dcfg,p1__36237_SHARP_);
}),args)));
var storage_key = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"q","q",689001697),query,true_poshdb_args], null);
...
/** @this {Function} */
(posh.plugin_base.q_info.cljs$lang$applyTo = (function (seq36239){
