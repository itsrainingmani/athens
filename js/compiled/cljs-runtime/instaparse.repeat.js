...
var vec__86928 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86928,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86928,(1),null);
...
var vec__86931 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86931,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86931,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__86934 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86934,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86934,(1),null);
...
var G__87017 = cljs.core.next(parses__$1);
parses__$1 = G__87017;
continue;
}
...
var G__86948 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__86949 = G__86948;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86949,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86949,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86949,(2),null);
var selection = vec__86949;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__86948__$1 = G__86948;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__86959 = G__86948__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86959,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86959,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86959,(2),null);
var selection__$1 = vec__86959;
...
var G__87025 = cljs.core.long$(end__$1);
var G__87026 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__87027 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__87025;
parses__$1 = G__87026;
G__86948__$1 = G__87027;
continue;
...
var G__86968 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__86969 = G__86968;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86969,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86969,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86969,(2),null);
var selection = vec__86969;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__86968__$1 = G__86968;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__86980 = G__86968__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86980,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86980,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86980,(2),null);
var selection__$1 = vec__86980;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__87029 = cljs.core.long$(end__$1);
var G__87030 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__87031 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__87029;
parses__$1 = G__87030;
G__86968__$1 = G__87031;
continue;
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__86992 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__86993 = G__86992;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86993,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86993,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86993,(2),null);
var selection = vec__86993;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__86992__$1 = G__86992;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__87000 = G__86992__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__87000,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__87000,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__87000,(2),null);
var selection__$1 = vec__87000;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__87033 = cljs.core.long$(end__$1);
var G__87034 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__87035 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__87033;
parses__$1 = G__87034;
G__86992__$1 = G__87035;
continue;
...
if(cljs.core.truth_((function (){var fexpr__87005 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__87005.cljs$core$IFn$_invoke$arity$1 ? fexpr__87005.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__87005.call(null,output_format));
})())){
} else {
...
var G__87006 = output_format;
var G__87006__$1 = (((G__87006 instanceof cljs.core.Keyword))?G__87006.fqn:null);
switch (G__87006__$1) {
case "enlive":
...
if(cljs.core.not(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207)))?(function (){var and__4174__auto__ = (function (){var G__87015 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__87014 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__87014.cljs$core$IFn$_invoke$arity$1 ? fexpr__87014.cljs$core$IFn$_invoke$arity$1(G__87015) : fexpr__87014.call(null,G__87015));
})();
