...
var seq__55645 = cljs.core.seq(imgs);
var chunk__55646 = null;
var count__55647 = (0);
var i__55648 = (0);
while(true){
if((i__55648 < count__55647)){
var vec__55655 = chunk__55646.cljs$core$IIndexed$_nth$arity$2(null,i__55648);
var curr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55655,(0),null);
var new$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55655,(1),null);
athens.electron.fs.copyFileSync(curr,new$);


var G__55736 = seq__55645;
var G__55737 = chunk__55646;
var G__55738 = count__55647;
var G__55739 = (i__55648 + (1));
seq__55645 = G__55736;
chunk__55646 = G__55737;
count__55647 = G__55738;
i__55648 = G__55739;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__55645);
if(temp__5735__auto__){
var seq__55645__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__55645__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__55645__$1);
var G__55740 = cljs.core.chunk_rest(seq__55645__$1);
var G__55741 = c__4556__auto__;
var G__55742 = cljs.core.count(c__4556__auto__);
var G__55743 = (0);
seq__55645 = G__55740;
chunk__55646 = G__55741;
count__55647 = G__55742;
i__55648 = G__55743;
continue;
} else {
var vec__55658 = cljs.core.first(seq__55645__$1);
var curr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55658,(0),null);
var new$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55658,(1),null);
athens.electron.fs.copyFileSync(curr,new$);


var G__55744 = cljs.core.next(seq__55645__$1);
var G__55745 = null;
var G__55746 = (0);
var G__55747 = (0);
seq__55645 = G__55744;
chunk__55646 = G__55745;
count__55647 = G__55746;
i__55648 = G__55747;
continue;
}
} else {
...
var map__55663 = athens.db.get_block(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),target_uid], null));
...
var order = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55663__$1,new cljs.core.Keyword("block","order","block/order",-1429282437));
...
})():(function (){var index = (function (){var G__55665 = drag_target;
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fs","open-dialog","fs/open-dialog",-1381619732),(function (p__55666,_){
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55667__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("local-storage","get-db-filepath","local-storage/get-db-filepath",-2015649354),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frame.core.inject_cofx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"local-storage","local-storage",-1301104068),"db/filepath")], null),(function (p__55669,_){
...
var local_storage = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55670__$1,new cljs.core.Keyword(null,"local-storage","local-storage",-1301104068));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("local-storage","navigate","local-storage/navigate",-707087458),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frame.core.inject_cofx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"local-storage","local-storage",-1301104068),"current-route/uid")], null),(function (p__55672,_){
...
var local_storage = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55673__$1,new cljs.core.Keyword(null,"local-storage","local-storage",-1301104068));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fs","watch","fs/watch",380976938),(function (_,p__55691){
var vec__55692 = p__55691;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55692,(0),null);
var filepath = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55692,(1),null);
var dirpath_55750 = athens.electron.path.dirname(filepath);
athens.electron.fs.watch(dirpath_55750,(function (_event,filename){
...
var filepath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55703__$1,new cljs.core.Keyword("db","filepath","db/filepath",1097485287));
...
}),blocks_with_plain_links_55752);
var blocks_temp_55754 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__55727){
...
re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"transact","transact",-267998670),blocks_temp_55754], null));

re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"transact","transact",-267998670),blocks_orig_55753], null));
...
var schema_version_55755 = cljs.core.second(cljs.core.first(schemas));
var G__55731_55756 = schema_version_55755;
switch (G__55731_55756) {
case (1):
cljs.core.prn.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([["Schema version ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(schema_version_55755)].join('')], 0));

break;
default:
alert(Error(["No matching case clause for schema version: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(schema_version_55755)].join('')));
...
re_frame.core.reg_fx(new cljs.core.Keyword("fs","write!","fs/write!",-1029545496),(function (p__55732){
var vec__55733 = p__55732;
var filepath = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55733,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55733,(1),null);
