...
var sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_62606 = (function (this$,ctx,n){
...
return sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_62606(this$,ctx,n);
}
});
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__62592 = (n - (1));
var G__62593 = cljs.core.rest(s);
var G__62594 = err_val;
return (sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3 ? sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3(G__62592,G__62593,G__62594) : sci.impl.max_or_throw.take_STAR_.call(null,G__62592,G__62593,G__62594));
})());
} else {
return null;
}
