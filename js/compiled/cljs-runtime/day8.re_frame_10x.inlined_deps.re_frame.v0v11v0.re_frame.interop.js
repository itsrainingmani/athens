...
return [(function (){var pred__47166 = cljs.core.instance_QMARK_;
var expr__47167 = reactive_val;
if(cljs.core.truth_((pred__47166.cljs$core$IFn$_invoke$arity$2 ? pred__47166.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.RAtom,expr__47167) : pred__47166.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.RAtom,expr__47167)))){
return "ra";
} else {
if(cljs.core.truth_((pred__47166.cljs$core$IFn$_invoke$arity$2 ? pred__47166.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.RCursor,expr__47167) : pred__47166.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.RCursor,expr__47167)))){
return "rc";
} else {
if(cljs.core.truth_((pred__47166.cljs$core$IFn$_invoke$arity$2 ? pred__47166.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.Reaction,expr__47167) : pred__47166.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.Reaction,expr__47167)))){
return "rx";
} else {
if(cljs.core.truth_((pred__47166.cljs$core$IFn$_invoke$arity$2 ? pred__47166.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.Track,expr__47167) : pred__47166.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.Track,expr__47167)))){
return "tr";
} else {
return "other";
}
