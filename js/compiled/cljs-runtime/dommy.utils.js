...
return [(function (){var G__54409 = cljs.core.namespace(s);
if((G__54409 == null)){
return null;
} else {
return [G__54409,"/"].join('');
}
...
var G__54421 = (function (){var end = (i + class$.length);
