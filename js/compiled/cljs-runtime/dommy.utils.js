 ...
 */
dommy.utils.dissoc_in = (function dommy$utils$dissoc_in(m,p__54410){
...
return [(function (){var G__54421 = cljs.core.namespace(s);
if((G__54421 == null)){
return null;
} else {
return [G__54421,"/"].join('');
}
