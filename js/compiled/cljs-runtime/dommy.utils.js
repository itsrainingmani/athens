 ...
 */
dommy.utils.dissoc_in = (function dommy$utils$dissoc_in(m,p__54404){
...
return [(function (){var G__54417 = cljs.core.namespace(s);
if((G__54417 == null)){
return null;
} else {
return [G__54417,"/"].join('');
}
...
var G__54424 = (function (){var end = (i + class$.length);
