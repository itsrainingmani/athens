...
var G__42813 = devtools.prefs.pref(v);
v = G__42813;
continue;
} else {
return v;
...
}catch (e42782){var _e__40273__auto__ = e42782;
return false;
}})();
...
}catch (e42786){var _e__40273__auto__ = e42786;
return false;
}})();
...
}catch (e42788){var _e__40273__auto__ = e42788;
return false;
}}
}
});
...
var vec__42795 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42795,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42795,(1),null);
...
return cljs.core.some((function (p1__42801_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__42801_SHARP_);
}),template);
});
