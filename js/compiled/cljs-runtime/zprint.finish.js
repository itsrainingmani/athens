...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__48397_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__48397_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__48397_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__48399){
var vec__48400 = p__48399;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48400,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48400,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__48403,s,color,element,idx){
...
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48404__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48404__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48404__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__48408 = (function (){var or__4185__auto__ = color;
...
var fexpr__48407 = (function (){var G__48409 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__48409) : style_map.call(null,G__48409));
})();
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__48410){
var vec__48411 = p__48410;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48411,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48411,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48411,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__48414){
var vec__48415 = p__48414;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48415,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48415,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48415,(2),null);
...
var G__48487 = cljs.core.next(ssv);
var G__48488 = (this_ssv == null);
var G__48489 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__48490 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__48487;
doing_nil_QMARK_ = G__48488;
last_elide = G__48489;
out = G__48490;
continue;
}
...
var vec__48427 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48427,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48427,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48427,(2),null);
...
var G__48491 = cljs.core.next(remaining_cvec);
var G__48492 = new_idx;
var G__48493 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__48491;
idx = G__48492;
out = G__48493;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__48437,cursor_vec){
var vec__48438 = p__48437;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48438,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48438,(1),null);
var focus_vec = vec__48438;
...
var vec__48441 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48441,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48441,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__48444){
var vec__48445 = p__48444;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48445,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48445,(1),null);
if((color == null)){
return s;
} else {
...
return cljs.core.filterv((function (p1__48449_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__48449_SHARP_))));
...
var vec__48461 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48461,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48461,(1),null);
var cvec_element = vec__48461;
if((cvec_element == null)){
var G__48506 = cljs.core.next(cvec_nl);
var G__48507 = (idx + (1));
var G__48508 = start;
var G__48509 = out;
cvec_nl = G__48506;
...
var G__48510 = cljs.core.next(cvec_nl);
var G__48511 = (idx + (1));
var G__48512 = idx;
var G__48513 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__48510;
idx = G__48511;
start = G__48512;
out = G__48513;
...
var G__48514 = cljs.core.next(cvec_nl);
var G__48515 = (idx + (1));
var G__48516 = (idx + (1));
var G__48517 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__48514;
idx = G__48515;
start = G__48516;
out = G__48517;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__48466_SHARP_,p2__48465_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__48465_SHARP_)){
return cljs.core.reduced(p1__48466_SHARP_);
} else {
return (p1__48466_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__48468,p__48469){
var vec__48470 = p__48468;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48470,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48470,(1),null);
var vec__48473 = p__48469;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48473,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48473,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__48478,cvec,focus_vec){
...
var options = map__48479__$1;
var map__48480 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48479__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48480__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48480__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48480__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__48477_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__48477_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
