...
var G__28242 = cljs.core.next(ssv);
var G__28243 = (this_ssv == null);
var G__28244 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__28245 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__28242;
doing_nil_QMARK_ = G__28243;
last_elide = G__28244;
out = G__28245;
continue;
}
...
var G__28246 = cljs.core.next(remaining_cvec);
var G__28247 = new_idx;
var G__28248 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__28246;
idx = G__28247;
out = G__28248;
continue;
}
...
var vec__28214 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28214,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28214,(1),null);
var cvec_element = vec__28214;
...
var G__28266 = (idx + (1));
var G__28267 = idx;
var G__28268 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__28265;
idx = G__28266;
start = G__28267;
out = G__28268;
...
var G__28278 = cljs.core.next(cvec_nl);
var G__28279 = (idx + (1));
var G__28280 = start;
var G__28281 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__28278;
idx = G__28279;
start = G__28280;
out = G__28281;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__28219_SHARP_,p2__28218_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__28218_SHARP_)){
return cljs.core.reduced(p1__28219_SHARP_);
} else {
return (p1__28219_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__28221,p__28222){
var vec__28223 = p__28221;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28223,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28223,(1),null);
var vec__28226 = p__28222;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28226,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28226,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__28232,cvec,focus_vec){
...
var options = map__28233__$1;
var map__28234 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28233__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28234__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28234__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28234__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28231_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__28231_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
