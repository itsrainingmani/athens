...
var depth = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65851__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65851__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
var G__65862 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__65862__$1 = (((G__65862 == null))?null:cljs.core.persistent_BANG_(G__65862));
if((G__65862__$1 == null)){
return null;
} else {
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__65862__$1,key);
}
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__65867){
...
var frame = first__65870;
var frames = seq__65869__$1;
...
var results = (function (){var G__65872 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq(kvps)){
return cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(G__65872,kvps);
} else {
return G__65872;
}
})();
...
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65875__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65875__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_65974 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_65974,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__65887){
...
var parent = first__65890;
var frames = seq__65889__$1;
...
var found = cljs.core.not_empty((function (){var G__65891 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.take.cljs$core$IFn$_invoke$arity$1(limit),G__65891);
} else {
return G__65891;
}
})());
...
var as_value = (function (){var G__65899 = datom_val;
if(ref_QMARK_){
return cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__65881_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__65881_SHARP_]);
}),G__65899);
} else {
return G__65899;
}
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,cljs.core.update.cljs$core$IFn$_invoke$arity$5(parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,(function (){var G__65900 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(as_value),found);
if(single_QMARK_){
return cljs.core.first(G__65900);
} else {
return G__65900;
}
})()));
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,(function (){var G__65901 = parent;
if(cljs.core.contains_QMARK_(opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__65901,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__65901;
}
})());
...
var vec__65903 = spec;
var attr_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65903,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65903,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p__65907){
var vec__65908 = p__65907;
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__65915){
...
var frame = first__65919;
var frames = seq__65918__$1;
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__65920){
...
var frame = first__65923;
var frames = seq__65922__$1;
...
var vec__65924 = cljs.core.first(datoms_by_attr);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65924,(0),null);
var datoms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65924,(1),null);
...
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65930__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65930__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__65932 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__65932,attr,eid);
} else {
return G__65932;
}
})();
...
var eid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65933__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65933__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__65939){
while(true){
var vec__65944 = p__65939;
...
var frame = first__65946;
var frames = seq__65945__$1;
var temp__5733__auto__ = cljs.core.seq(new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5733__auto__){
var eids = temp__5733__auto__;
...
var G__65987 = db;
var G__65988 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__65987;
p__65939 = G__65988;
continue;
}
...
while(true){
var G__65949 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first(frames));
var G__65949__$1 = (((G__65949 instanceof cljs.core.Keyword))?G__65949.fqn:null);
switch (G__65949__$1) {
case "expand":
var G__65991 = db;
var G__65992 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__65991;
frames = G__65992;
continue;
...
case "expand-rev":
var G__65996 = db;
var G__65997 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__65996;
frames = G__65997;
continue;
...
case "pattern":
var G__66002 = db;
var G__66003 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__66002;
frames = G__66003;
continue;
...
case "recursion":
var G__66004 = db;
var G__66005 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__66004;
frames = G__66005;
continue;
...
var f = first__65956;
var remaining = seq__65955__$1;
var result = (function (){var G__65957 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__65957);
} else {
return G__65957;
}
})();
...
var G__66007 = db;
var G__66008 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__65958 = cljs.core.first(remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__65958,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__65958;
}
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__65949__$1)].join('')));
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__65959_SHARP_){
return datascript.db.entid_strict(db,p1__65959_SHARP_);
})),eids);
